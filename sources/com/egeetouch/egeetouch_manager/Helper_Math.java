...
public class Helper_Math {
    ...
    public static String FormatStringAddressStart(String str, NFCDataDevice nFCDataDevice) {
    ...
    public static String FormatStringNbBlock(String str, String str2, NFCDataDevice nFCDataDevice) {
        String StringForceDigit = StringForceDigit(str, 4);
        if (StringForceDigit.length() > 4) {
            StringForceDigit = "11";
        }
    ...
    public static String FormatStringNbBlockInteger(String str, String str2, NFCDataDevice nFCDataDevice) {
        String StringForceDigit = StringForceDigit(str, 4);
        if (StringForceDigit.length() > 4) {
            StringForceDigit = "11";
        }
