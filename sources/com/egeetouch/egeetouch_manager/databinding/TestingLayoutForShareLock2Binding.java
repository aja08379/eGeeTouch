...
public final class TestingLayoutForShareLock2Binding implements ViewBinding {
    ...
    private TestingLayoutForShareLock2Binding(ScrollView scrollView, LinearLayout linearLayout, LinearLayout linearLayout2, Button button, Button button2, Button button3, Button button4, Button button5, Button button6, LinearLayout linearLayout3, Switch r13, EditText editText, ImageView imageView, Switch r16, Spinner spinner, Spinner spinner2, Spinner spinner3, EditText editText2, TextView textView, TextView textView2, TextView textView3, TextView textView4) {
        this.rootView = scrollView;
        this.LinearLayoutLock = linearLayout;
        ...
        this.chooseDurationRelativeView = linearLayout3;
    ...
    public static TestingLayoutForShareLock2Binding inflate(LayoutInflater layoutInflater) {
        return inflate(layoutInflater, null, false);
    }

    public static TestingLayoutForShareLock2Binding inflate(LayoutInflater layoutInflater, ViewGroup viewGroup, boolean z) {
        View inflate = layoutInflater.inflate(R.layout.testing_layout_for_share_lock2, viewGroup, false);
        if (z) {
    ...
    public static TestingLayoutForShareLock2Binding bind(View view) {
                                                                            ...
                                                                            if (textView != null) {
                                                                                ...
                                                                                if (textView2 != null) {
                                                                                    ...
                                                                                    if (textView3 != null) {
                                                                                        ...
                                                                                        if (textView4 != null) {
                                                                                            return new TestingLayoutForShareLock2Binding((ScrollView) view, linearLayout, linearLayout2, button, button2, button3, button4, button5, button6, linearLayout3, r14, editText, imageView, r17, spinner, spinner2, spinner3, editText2, textView, textView2, textView3, textView4);
                                                                                        }
                                                                                    }
                                                                                }
                                                                            }
