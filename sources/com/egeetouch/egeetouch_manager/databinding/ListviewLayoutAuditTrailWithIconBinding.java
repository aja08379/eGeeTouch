...
public final class ListviewLayoutAuditTrailWithIconBinding implements ViewBinding {
    ...
    private ListviewLayoutAuditTrailWithIconBinding(LinearLayout linearLayout, LinearLayout linearLayout2, TextView textView, TextView textView2, TextView textView3, TextView textView4, ImageView imageView, ImageView imageView2, ImageView imageView3, ImageView imageView4, ImageView imageView5, LinearLayout linearLayout3, LinearLayout linearLayout4, TextView textView5, TextView textView6, TextView textView7, TextView textView8, TextView textView9, TextView textView10, TextView textView11) {
    ...
    public static ListviewLayoutAuditTrailWithIconBinding inflate(LayoutInflater layoutInflater) {
        return inflate(layoutInflater, null, false);
    }

    public static ListviewLayoutAuditTrailWithIconBinding inflate(LayoutInflater layoutInflater, ViewGroup viewGroup, boolean z) {
        View inflate = layoutInflater.inflate(R.layout.listview_layout_audit_trail_with_icon, viewGroup, false);
        if (z) {
    ...
    public static ListviewLayoutAuditTrailWithIconBinding bind(View view) {
                                                                ...
                                                                if (textView8 != null) {
                                                                    ...
                                                                    if (textView9 != null) {
                                                                        ...
                                                                        if (textView10 != null) {
                                                                            ...
                                                                            if (textView11 != null) {
                                                                                return new ListviewLayoutAuditTrailWithIconBinding(linearLayout3, linearLayout, textView, textView2, textView3, textView4, imageView, imageView2, imageView3, imageView4, imageView5, linearLayout2, linearLayout3, textView5, textView6, textView7, textView8, textView9, textView10, textView11);
                                                                            }
                                                                        }
                                                                    }
                                                                }
