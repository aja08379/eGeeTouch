...
public final class FragmentAddUserBinding implements ViewBinding {
    ...
    private FragmentAddUserBinding(LinearLayout linearLayout, Button button, EditText editText, EditText editText2, EditText editText3, TextView textView, TextView textView2) {
                ...
                if (editText2 != null) {
                    ...
                    if (editText3 != null) {
                        ...
                        if (textView != null) {
                            ...
                            if (textView2 != null) {
                                return new FragmentAddUserBinding((LinearLayout) view, button, editText, editText2, editText3, textView, textView2);
                            }
                        }
                    }
                }
