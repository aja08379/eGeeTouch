...
public final class FragmentWatchAuditBinding implements ViewBinding {
    ...
    private FragmentWatchAuditBinding(RelativeLayout relativeLayout, Button button, LinearLayout linearLayout, LinearLayout linearLayout2, Button button2, RelativeLayout relativeLayout2, ImageView imageView, ImageView imageView2, ImageView imageView3, ImageView imageView4, ImageView imageView5, LinearLayout linearLayout3, ListView listView, TextView textView, TextView textView2, TextView textView3, TextView textView4, TextView textView5, TextView textView6, TextView textView7) {
    ...
    public static FragmentWatchAuditBinding inflate(LayoutInflater layoutInflater) {
        return inflate(layoutInflater, null, false);
    }

    public static FragmentWatchAuditBinding inflate(LayoutInflater layoutInflater, ViewGroup viewGroup, boolean z) {
        View inflate = layoutInflater.inflate(R.layout.fragment_watch_audit, viewGroup, false);
        if (z) {
    ...
    public static FragmentWatchAuditBinding bind(View view) {
                                                                ...
                                                                if (textView4 != null) {
                                                                    ...
                                                                    if (textView5 != null) {
                                                                        ...
                                                                        if (textView6 != null) {
                                                                            ...
                                                                            if (textView7 != null) {
                                                                                return new FragmentWatchAuditBinding(relativeLayout, button, linearLayout, linearLayout2, button2, relativeLayout, imageView, imageView2, imageView3, imageView4, imageView5, linearLayout3, listView, textView, textView2, textView3, textView4, textView5, textView6, textView7);
                                                                            }
                                                                        }
                                                                    }
                                                                }
