...
public class SwipeDismissTouchListener implements View.OnTouchListener {
    ...
    public boolean onTouch(View view, MotionEvent motionEvent) {
        ...
        if (actionMasked != 1) {
            ...
            if (r5) {
                this.mView.animate().translationX(z ? this.mViewWidth : -this.mViewWidth).alpha(0.0f).setDuration(this.mAnimationTime).setListener(new AnimatorListenerAdapter() { // from class: com.egeetouch.egeetouch_manager.SwipeDismissTouchListener.1
    ...
    public void performDismiss() {
        ...
        duration.addListener(new AnimatorListenerAdapter() { // from class: com.egeetouch.egeetouch_manager.SwipeDismissTouchListener.2
            @Override // android.animation.AnimatorListenerAdapter, android.animation.Animator.AnimatorListener
            public void onAnimationEnd(Animator animator) {
        ...
        duration.addUpdateListener(new ValueAnimator.AnimatorUpdateListener() { // from class: com.egeetouch.egeetouch_manager.SwipeDismissTouchListener.3
