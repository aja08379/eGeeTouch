...
public class LikeActionController {
    ...
    */
    private static com.facebook.share.internal.LikeActionController deserializeFromDiskSynchronously(java.lang.String r5) {
        ...
        com.facebook.share.internal.LikeActionController r0 = null;
        try {
            try {
                r5 = com.facebook.share.internal.LikeActionController.controllerDiskCache.get(getCacheKeyForObjectId(r5));
                if (r5 != null) {
                    try {
                        java.lang.String r1 = com.facebook.internal.Utility.readStreamToString(r5);
                        if (!com.facebook.internal.Utility.isNullOrEmpty(r1)) {
                            r0 = deserializeFromJson(r1);
                        }
                    } catch (java.io.IOException e) {
                        r1 = e;
                        android.util.Log.e(com.facebook.share.internal.LikeActionController.TAG, "Unable to deserialize controller from disk", r1);
                    }
                }
