    ...
    */
    public void startActivityForResult(android.content.Intent r3, int r4) {
        ...
        if (r0 != null) {
            ...
            if (r0 != null) {
                if (r0.getNativeFragment() != null) {
                    r2.fragmentWrapper.getNativeFragment().startActivityForResult(r3, r4);
                } else if (r2.fragmentWrapper.getSupportFragment() != null) {
                    r2.fragmentWrapper.getSupportFragment().startActivityForResult(r3, r4);
                }
            }
            if (r1 == null) {
                com.facebook.internal.Logger.log(com.facebook.LoggingBehavior.DEVELOPER_ERRORS, 6, getClass().getName(), r1);
                return;
            }
            return;
        }
