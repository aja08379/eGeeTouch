...
public final class Validate {
    ...
    */
    public static void hasFacebookActivity(android.content.Context r3, boolean r4) {
        ...
        if (r0 != null) {
            try {
                r3 = r0.getActivityInfo(new android.content.ComponentName(r3, "com.facebook.FacebookActivity"), 1);
            } catch (android.content.pm.PackageManager.NameNotFoundException unused) {
            }
            if (r3 != null) {
                if (r4) {
                    throw new java.lang.IllegalStateException(com.facebook.internal.Validate.FACEBOOK_ACTIVITY_NOT_FOUND_REASON);
                }
                android.util.Log.w(com.facebook.internal.Validate.TAG, com.facebook.internal.Validate.FACEBOOK_ACTIVITY_NOT_FOUND_REASON);
                return;
            }
            return;
        }
