    ...
    */
    protected void onMeasure(int r8, int r9) {
        ...
        if (r7.maxWidth > 0) {
            ...
            int r1 = r7.maxWidth;
            if (r0 > r1) {
                r8 = android.view.View.MeasureSpec.makeMeasureSpec(r1, androidx.constraintlayout.core.widgets.analyzer.BasicMeasure.EXACTLY);
                super.onMeasure(r8, r9);
            }
        }
        int r0 = getResources().getDimensionPixelSize(com.google.android.material.R.dimen.design_snackbar_padding_vertical_2lines);
        int r1 = getResources().getDimensionPixelSize(com.google.android.material.R.dimen.design_snackbar_padding_vertical);
        boolean r3 = false;
        boolean r2 = r7.messageView.getLayout().getLineCount() > 1;
        if (!r2 || r7.maxInlineActionWidth <= 0 || r7.actionView.getMeasuredWidth() <= r7.maxInlineActionWidth) {
            if (!r2) {
                r0 = r1;
            }
        }
