...
public class Chip extends AppCompatCheckBox implements ChipDrawable.Delegate, Shapeable {
    ...
    */
    public Chip(android.content.Context r8, android.util.AttributeSet r9, int r10) {
        ...
        r7.rect = new android.graphics.Rect();
        r7.rectF = new android.graphics.RectF();
        r7.fontCallback = new com.google.android.material.resources.TextAppearanceFontCallback() { // from class: com.google.android.material.chip.Chip.1
            ...
            public void onFontRetrieved(android.graphics.Typeface r1, boolean r2) {
                com.google.android.material.chip.Chip r1 = com.google.android.material.chip.Chip.this;
                r1.setText(r1.chipDrawable.shouldDrawText() ? com.google.android.material.chip.Chip.this.chipDrawable.getText() : com.google.android.material.chip.Chip.this.getText());
        ...
        initMinTouchTarget(r8, r9, r10);
        setChipDrawable(r6);
        r6.setElevation(androidx.core.view.ViewCompat.getElevation(r7));
        android.content.res.TypedArray r9 = com.google.android.material.internal.ThemeEnforcement.obtainStyledAttributes(r8, r9, com.google.android.material.R.styleable.Chip, r10, r4, new int[0]);
        if (android.os.Build.VERSION.SDK_INT < 23) {
            setTextColor(com.google.android.material.resources.MaterialResources.getColorStateList(r8, r9, com.google.android.material.R.styleable.Chip_android_textColor));
        }
        boolean r8 = r9.hasValue(com.google.android.material.R.styleable.Chip_shapeAppearance);
        r9.recycle();
        r7.touchHelper = new com.google.android.material.chip.Chip.ChipTouchHelper(r7);
        updateAccessibilityDelegate();
        if (!r8) {
            initOutlineProvider();
        }
        setChecked(r7.deferredCheckedValue);
        setText(r6.getText());
        setEllipsize(r6.getEllipsize());
        updateTextPaintDrawState();
        if (!r7.chipDrawable.shouldDrawText()) {
            setLines(1);
        ...
        if (shouldEnsureMinTouchTargetSize()) {
            setMinHeight(r7.minTouchTargetSize);
        }
        r7.lastLayoutDirection = androidx.core.view.ViewCompat.getLayoutDirection(r7);
    }
    ...
    */
    public boolean onTouchEvent(android.view.MotionEvent r6) {
        ...
        return r0 || super.onTouchEvent(r6);
    }
