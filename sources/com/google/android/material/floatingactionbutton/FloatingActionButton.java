...
public class FloatingActionButton extends VisibilityAwareImageButton implements TintableBackgroundView, TintableImageSourceView, ExpandableTransformationWidget, Shapeable, CoordinatorLayout.AttachedBehavior {
    ...
    */
    public FloatingActionButton(android.content.Context r11, android.util.AttributeSet r12, int r13) {
        ...
        r10.shadowPadding = new android.graphics.Rect();
        r10.touchArea = new android.graphics.Rect();
        android.content.Context r11 = getContext();
        android.content.res.TypedArray r0 = com.google.android.material.internal.ThemeEnforcement.obtainStyledAttributes(r11, r12, com.google.android.material.R.styleable.FloatingActionButton, r13, r6, new int[0]);
        r10.backgroundTint = com.google.android.material.resources.MaterialResources.getColorStateList(r11, r0, com.google.android.material.R.styleable.FloatingActionButton_backgroundTint);
        r10.backgroundTintMode = com.google.android.material.internal.ViewUtils.parseTintMode(r0.getInt(com.google.android.material.R.styleable.FloatingActionButton_backgroundTintMode, -1), null);
        r10.rippleColor = com.google.android.material.resources.MaterialResources.getColorStateList(r11, r0, com.google.android.material.R.styleable.FloatingActionButton_rippleColor);
        r10.size = r0.getInt(com.google.android.material.R.styleable.FloatingActionButton_fabSize, -1);
        r10.customSize = r0.getDimensionPixelSize(com.google.android.material.R.styleable.FloatingActionButton_fabCustomSize, 0);
        r10.borderWidth = r0.getDimensionPixelSize(com.google.android.material.R.styleable.FloatingActionButton_borderWidth, 0);
        float r1 = r0.getDimension(com.google.android.material.R.styleable.FloatingActionButton_elevation, 0.0f);
        float r3 = r0.getDimension(com.google.android.material.R.styleable.FloatingActionButton_hoveredFocusedTranslationZ, 0.0f);
        float r2 = r0.getDimension(com.google.android.material.R.styleable.FloatingActionButton_pressedTranslationZ, 0.0f);
        r10.compatPadding = r0.getBoolean(com.google.android.material.R.styleable.FloatingActionButton_useCompatPadding, false);
        int r4 = getResources().getDimensionPixelSize(com.google.android.material.R.dimen.mtrl_fab_min_touch_target);
        r10.maxImageSize = r0.getDimensionPixelSize(com.google.android.material.R.styleable.FloatingActionButton_maxImageSize, 0);
        com.google.android.material.animation.MotionSpec r5 = com.google.android.material.animation.MotionSpec.createFromAttribute(r11, r0, com.google.android.material.R.styleable.FloatingActionButton_showMotionSpec);
        com.google.android.material.animation.MotionSpec r8 = com.google.android.material.animation.MotionSpec.createFromAttribute(r11, r0, com.google.android.material.R.styleable.FloatingActionButton_hideMotionSpec);
        com.google.android.material.shape.ShapeAppearanceModel r11 = com.google.android.material.shape.ShapeAppearanceModel.builder(r11, r12, r13, r6, com.google.android.material.shape.ShapeAppearanceModel.PILL).build();
        boolean r6 = r0.getBoolean(com.google.android.material.R.styleable.FloatingActionButton_ensureMinTouchTargetSize, false);
        setEnabled(r0.getBoolean(com.google.android.material.R.styleable.FloatingActionButton_android_enabled, true));
        r0.recycle();
        androidx.appcompat.widget.AppCompatImageHelper r0 = new androidx.appcompat.widget.AppCompatImageHelper(r10);
        r10.imageHelper = r0;
        r0.loadFromAttributes(r12, r13);
        r10.expandableWidgetHelper = new com.google.android.material.expandable.ExpandableWidgetHelper(r10);
        getImpl().setShapeAppearance(r11);
        getImpl().initializeBackgroundDrawable(r10.backgroundTint, r10.backgroundTintMode, r10.rippleColor, r10.borderWidth);
        getImpl().setMinTouchTargetSize(r4);
        getImpl().setElevation(r1);
        getImpl().setHoveredFocusedTranslationZ(r3);
        getImpl().setPressedTranslationZ(r2);
        getImpl().setMaxImageSize(r10.maxImageSize);
        getImpl().setShowMotionSpec(r5);
        getImpl().setHideMotionSpec(r8);
        getImpl().setEnsureMinTouchTargetSize(r6);
