...
public class MaterialButtonToggleGroup extends LinearLayout {
    ...
    */
    public MaterialButtonToggleGroup(android.content.Context r7, android.util.AttributeSet r8, int r9) {
        super(com.google.android.material.theme.overlay.MaterialThemeOverlay.wrap(r7, r8, r9, r4), r8, r9);
        int r4 = com.google.android.material.button.MaterialButtonToggleGroup.DEF_STYLE_RES;
        r6.originalCornerData = new java.util.ArrayList();
        r6.checkedStateTracker = new com.google.android.material.button.MaterialButtonToggleGroup.CheckedStateTracker();
        r6.pressedStateTracker = new com.google.android.material.button.MaterialButtonToggleGroup.PressedStateTracker();
        r6.onButtonCheckedListeners = new java.util.LinkedHashSet<>();
        r6.childOrderComparator = new java.util.Comparator<com.google.android.material.button.MaterialButton>() { // from class: com.google.android.material.button.MaterialButtonToggleGroup.1
            {
            }

            @Override // java.util.Comparator
            public /* bridge */ /* synthetic */ int compare(com.google.android.material.button.MaterialButton r1, com.google.android.material.button.MaterialButton r2) {
            ...
            public int compare(com.google.android.material.button.MaterialButton r3, com.google.android.material.button.MaterialButton r4) {
                int r0 = java.lang.Boolean.valueOf(r3.isChecked()).compareTo(java.lang.Boolean.valueOf(r4.isChecked()));
                if (r0 != 0) {
                    return r0;
                }
                int r0 = java.lang.Boolean.valueOf(r3.isPressed()).compareTo(java.lang.Boolean.valueOf(r4.isPressed()));
                return r0 != 0 ? r0 : java.lang.Integer.valueOf(com.google.android.material.button.MaterialButtonToggleGroup.this.indexOfChild(r3)).compareTo(java.lang.Integer.valueOf(com.google.android.material.button.MaterialButtonToggleGroup.this.indexOfChild(r4)));
            }
        };
        r6.skipCheckedStateTracker = false;
        android.content.res.TypedArray r8 = com.google.android.material.internal.ThemeEnforcement.obtainStyledAttributes(getContext(), r8, com.google.android.material.R.styleable.MaterialButtonToggleGroup, r9, r4, new int[0]);
        setSingleSelection(r8.getBoolean(com.google.android.material.R.styleable.MaterialButtonToggleGroup_singleSelection, false));
        r6.checkedId = r8.getResourceId(com.google.android.material.R.styleable.MaterialButtonToggleGroup_checkedButton, -1);
        r6.selectionRequired = r8.getBoolean(com.google.android.material.R.styleable.MaterialButtonToggleGroup_selectionRequired, false);
