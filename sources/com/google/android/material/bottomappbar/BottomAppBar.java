...
public class BottomAppBar extends Toolbar implements CoordinatorLayout.AttachedBehavior {
    ...
    */
    public BottomAppBar(android.content.Context r11, android.util.AttributeSet r12, int r13) {
        ...
        r10.animatingModeChangeCounter = 0;
        r10.pendingMenuResId = 0;
        r10.menuAnimatingWithFabAlignmentMode = false;
        r10.fabAttached = true;
        r10.fabAnimationListener = new android.animation.AnimatorListenerAdapter() { // from class: com.google.android.material.bottomappbar.BottomAppBar.1
            {
            }
            ...
            public void onAnimationStart(android.animation.Animator r3) {
                ...
                r3.maybeAnimateMenuView(r3.fabAlignmentMode, com.google.android.material.bottomappbar.BottomAppBar.this.fabAttached);
            }
        };
        r10.fabTransformationCallback = new com.google.android.material.animation.TransformationCallback<com.google.android.material.floatingactionbutton.FloatingActionButton>() { // from class: com.google.android.material.bottomappbar.BottomAppBar.2
            {
            }

            @Override // com.google.android.material.animation.TransformationCallback
            public /* bridge */ /* synthetic */ void onScaleChanged(com.google.android.material.floatingactionbutton.FloatingActionButton r1) {
                onScaleChanged(r1);
            }

            @Override // com.google.android.material.animation.TransformationCallback
            public /* bridge */ /* synthetic */ void onTranslationChanged(com.google.android.material.floatingactionbutton.FloatingActionButton r1) {
                onTranslationChanged(r1);
            }

            @Override // com.google.android.material.animation.TransformationCallback
            public void onScaleChanged(com.google.android.material.floatingactionbutton.FloatingActionButton r3) {
                com.google.android.material.bottomappbar.BottomAppBar.this.materialShapeDrawable.setInterpolation(r3.getVisibility() == 0 ? r3.getScaleY() : 0.0f);
            }

            @Override // com.google.android.material.animation.TransformationCallback
            public void onTranslationChanged(com.google.android.material.floatingactionbutton.FloatingActionButton r4) {
                float r0 = r4.getTranslationX();
                if (com.google.android.material.bottomappbar.BottomAppBar.this.getTopEdgeTreatment().getHorizontalOffset() != r0) {
                    com.google.android.material.bottomappbar.BottomAppBar.this.getTopEdgeTreatment().setHorizontalOffset(r0);
                    com.google.android.material.bottomappbar.BottomAppBar.this.materialShapeDrawable.invalidateSelf();
                }
                float r0 = java.lang.Math.max(0.0f, -r4.getTranslationY());
                if (com.google.android.material.bottomappbar.BottomAppBar.this.getTopEdgeTreatment().getCradleVerticalOffset() != r0) {
                    com.google.android.material.bottomappbar.BottomAppBar.this.getTopEdgeTreatment().setCradleVerticalOffset(r0);
                    com.google.android.material.bottomappbar.BottomAppBar.this.materialShapeDrawable.invalidateSelf();
                }
                com.google.android.material.bottomappbar.BottomAppBar.this.materialShapeDrawable.setInterpolation(r4.getVisibility() == 0 ? r4.getScaleY() : 0.0f);
            }
        };
        android.content.Context r8 = getContext();
        android.content.res.TypedArray r0 = com.google.android.material.internal.ThemeEnforcement.obtainStyledAttributes(r8, r12, com.google.android.material.R.styleable.BottomAppBar, r13, r6, new int[0]);
        android.content.res.ColorStateList r1 = com.google.android.material.resources.MaterialResources.getColorStateList(r8, r0, com.google.android.material.R.styleable.BottomAppBar_backgroundTint);
        int r2 = r0.getDimensionPixelSize(com.google.android.material.R.styleable.BottomAppBar_elevation, 0);
        r10.fabAlignmentMode = r0.getInt(com.google.android.material.R.styleable.BottomAppBar_fabAlignmentMode, 0);
        r10.fabAnimationMode = r0.getInt(com.google.android.material.R.styleable.BottomAppBar_fabAnimationMode, 0);
        r10.hideOnScroll = r0.getBoolean(com.google.android.material.R.styleable.BottomAppBar_hideOnScroll, false);
        r10.paddingBottomSystemWindowInsets = r0.getBoolean(com.google.android.material.R.styleable.BottomAppBar_paddingBottomSystemWindowInsets, false);
        r10.paddingLeftSystemWindowInsets = r0.getBoolean(com.google.android.material.R.styleable.BottomAppBar_paddingLeftSystemWindowInsets, false);
        r10.paddingRightSystemWindowInsets = r0.getBoolean(com.google.android.material.R.styleable.BottomAppBar_paddingRightSystemWindowInsets, false);
        r0.recycle();
        r10.fabOffsetEndMode = getResources().getDimensionPixelOffset(com.google.android.material.R.dimen.mtrl_bottomappbar_fabOffsetEndMode);
        r11.setShapeAppearanceModel(com.google.android.material.shape.ShapeAppearanceModel.builder().setTopEdge(new com.google.android.material.bottomappbar.BottomAppBarTopEdgeTreatment(r0.getDimensionPixelOffset(com.google.android.material.R.styleable.BottomAppBar_fabCradleMargin, 0), r0.getDimensionPixelOffset(com.google.android.material.R.styleable.BottomAppBar_fabCradleRoundedCornerRadius, 0), r0.getDimensionPixelOffset(com.google.android.material.R.styleable.BottomAppBar_fabCradleVerticalOffset, 0))).build());
        r11.setShadowCompatibilityMode(2);
        r11.setPaintStyle(android.graphics.Paint.Style.FILL);
        ...
        com.google.android.material.internal.ViewUtils.doOnApplyWindowInsets(r10, r12, r13, r6, new com.google.android.material.internal.ViewUtils.OnApplyWindowInsetsListener() { // from class: com.google.android.material.bottomappbar.BottomAppBar.3
            {
            }

            @Override // com.google.android.material.internal.ViewUtils.OnApplyWindowInsetsListener
            public androidx.core.view.WindowInsetsCompat onApplyWindowInsets(android.view.View r4, androidx.core.view.WindowInsetsCompat r5, com.google.android.material.internal.ViewUtils.RelativePadding r6) {
                boolean r4;
                if (com.google.android.material.bottomappbar.BottomAppBar.this.paddingBottomSystemWindowInsets) {
                    com.google.android.material.bottomappbar.BottomAppBar.this.bottomInset = r5.getSystemWindowInsetBottom();
                }
                boolean r0 = false;
                if (com.google.android.material.bottomappbar.BottomAppBar.this.paddingLeftSystemWindowInsets) {
                    r4 = com.google.android.material.bottomappbar.BottomAppBar.this.leftInset != r5.getSystemWindowInsetLeft();
                    com.google.android.material.bottomappbar.BottomAppBar.this.leftInset = r5.getSystemWindowInsetLeft();
                } else {
                    r4 = false;
                }
                if (com.google.android.material.bottomappbar.BottomAppBar.this.paddingRightSystemWindowInsets) {
                    boolean r6 = com.google.android.material.bottomappbar.BottomAppBar.this.rightInset != r5.getSystemWindowInsetRight();
                    com.google.android.material.bottomappbar.BottomAppBar.this.rightInset = r5.getSystemWindowInsetRight();
                    r0 = r6;
                }
                if (r4 || r0) {
    ...
    */
    public android.view.View findDependentView() {
        if (getParent() instanceof androidx.coordinatorlayout.widget.CoordinatorLayout) {
            for (android.view.View r2 : ((androidx.coordinatorlayout.widget.CoordinatorLayout) getParent()).getDependents(r4)) {
                if ((r2 instanceof com.google.android.material.floatingactionbutton.FloatingActionButton) || (r2 instanceof com.google.android.material.floatingactionbutton.ExtendedFloatingActionButton)) {
                    return r2;
                }
                while (r0.hasNext()) {
                }
