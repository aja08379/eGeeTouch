...
public class CollapsingToolbarLayout extends FrameLayout {
    ...
    */
    public CollapsingToolbarLayout(android.content.Context r10, android.util.AttributeSet r11, int r12) {
        super(com.google.android.material.theme.overlay.MaterialThemeOverlay.wrap(r10, r11, r12, r4), r11, r12);
        int r4 = com.google.android.material.appbar.CollapsingToolbarLayout.DEF_STYLE_RES;
        r9.refreshToolbar = true;
        r9.tmpRect = new android.graphics.Rect();
        r9.scrimVisibleHeightTrigger = -1;
        r9.topInsetApplied = 0;
        r9.extraMultilineHeight = 0;
        android.content.Context r0 = getContext();
        com.google.android.material.internal.CollapsingTextHelper r8 = new com.google.android.material.internal.CollapsingTextHelper(r9);
        r9.collapsingTextHelper = r8;
        r8.setTextSizeInterpolator(com.google.android.material.animation.AnimationUtils.DECELERATE_INTERPOLATOR);
        r8.setRtlTextDirectionHeuristicsEnabled(false);
        r9.elevationOverlayProvider = new com.google.android.material.elevation.ElevationOverlayProvider(r0);
        android.content.res.TypedArray r11 = com.google.android.material.internal.ThemeEnforcement.obtainStyledAttributes(r0, r11, com.google.android.material.R.styleable.CollapsingToolbarLayout, r12, r4, new int[0]);
        r8.setExpandedTextGravity(r11.getInt(com.google.android.material.R.styleable.CollapsingToolbarLayout_expandedTitleGravity, com.google.android.material.badge.BadgeDrawable.BOTTOM_START));
        r8.setCollapsedTextGravity(r11.getInt(com.google.android.material.R.styleable.CollapsingToolbarLayout_collapsedTitleGravity, 8388627));
        int r12 = r11.getDimensionPixelSize(com.google.android.material.R.styleable.CollapsingToolbarLayout_expandedTitleMargin, 0);
        r9.expandedMarginBottom = r12;
        r9.expandedMarginEnd = r12;
        r9.expandedMarginTop = r12;
        r9.expandedMarginStart = r12;
        if (r11.hasValue(com.google.android.material.R.styleable.CollapsingToolbarLayout_expandedTitleMarginStart)) {
            r9.expandedMarginStart = r11.getDimensionPixelSize(com.google.android.material.R.styleable.CollapsingToolbarLayout_expandedTitleMarginStart, 0);
        }
        if (r11.hasValue(com.google.android.material.R.styleable.CollapsingToolbarLayout_expandedTitleMarginEnd)) {
            r9.expandedMarginEnd = r11.getDimensionPixelSize(com.google.android.material.R.styleable.CollapsingToolbarLayout_expandedTitleMarginEnd, 0);
        }
        if (r11.hasValue(com.google.android.material.R.styleable.CollapsingToolbarLayout_expandedTitleMarginTop)) {
            r9.expandedMarginTop = r11.getDimensionPixelSize(com.google.android.material.R.styleable.CollapsingToolbarLayout_expandedTitleMarginTop, 0);
        }
        if (r11.hasValue(com.google.android.material.R.styleable.CollapsingToolbarLayout_expandedTitleMarginBottom)) {
            r9.expandedMarginBottom = r11.getDimensionPixelSize(com.google.android.material.R.styleable.CollapsingToolbarLayout_expandedTitleMarginBottom, 0);
        }
        r9.collapsingTitleEnabled = r11.getBoolean(com.google.android.material.R.styleable.CollapsingToolbarLayout_titleEnabled, true);
        setTitle(r11.getText(com.google.android.material.R.styleable.CollapsingToolbarLayout_title));
        r8.setExpandedTextAppearance(com.google.android.material.R.style.TextAppearance_Design_CollapsingToolbar_Expanded);
        r8.setCollapsedTextAppearance(androidx.appcompat.R.style.TextAppearance_AppCompat_Widget_ActionBar_Title);
        if (r11.hasValue(com.google.android.material.R.styleable.CollapsingToolbarLayout_expandedTitleTextAppearance)) {
            r8.setExpandedTextAppearance(r11.getResourceId(com.google.android.material.R.styleable.CollapsingToolbarLayout_expandedTitleTextAppearance, 0));
        }
        if (r11.hasValue(com.google.android.material.R.styleable.CollapsingToolbarLayout_collapsedTitleTextAppearance)) {
            r8.setCollapsedTextAppearance(r11.getResourceId(com.google.android.material.R.styleable.CollapsingToolbarLayout_collapsedTitleTextAppearance, 0));
        }
        r9.scrimVisibleHeightTrigger = r11.getDimensionPixelSize(com.google.android.material.R.styleable.CollapsingToolbarLayout_scrimVisibleHeightTrigger, -1);
        if (r11.hasValue(com.google.android.material.R.styleable.CollapsingToolbarLayout_maxLines)) {
            r8.setMaxLines(r11.getInt(com.google.android.material.R.styleable.CollapsingToolbarLayout_maxLines, 1));
        }
        r9.scrimAnimationDuration = r11.getInt(com.google.android.material.R.styleable.CollapsingToolbarLayout_scrimAnimationDuration, 600);
        setContentScrim(r11.getDrawable(com.google.android.material.R.styleable.CollapsingToolbarLayout_contentScrim));
        setStatusBarScrim(r11.getDrawable(com.google.android.material.R.styleable.CollapsingToolbarLayout_statusBarScrim));
        setTitleCollapseMode(r11.getInt(com.google.android.material.R.styleable.CollapsingToolbarLayout_titleCollapseMode, 0));
        r9.toolbarId = r11.getResourceId(com.google.android.material.R.styleable.CollapsingToolbarLayout_toolbarId, -1);
        r9.forceApplySystemWindowInsetTop = r11.getBoolean(com.google.android.material.R.styleable.CollapsingToolbarLayout_forceApplySystemWindowInsetTop, false);
        r9.extraMultilineHeightEnabled = r11.getBoolean(com.google.android.material.R.styleable.CollapsingToolbarLayout_extraMultilineHeightEnabled, false);
        r11.recycle();
        setWillNotDraw(false);
        androidx.core.view.ViewCompat.setOnApplyWindowInsetsListener(r9, new androidx.core.view.OnApplyWindowInsetsListener() { // from class: com.google.android.material.appbar.CollapsingToolbarLayout.1
            {
            }

            @Override // androidx.core.view.OnApplyWindowInsetsListener
            public androidx.core.view.WindowInsetsCompat onApplyWindowInsets(android.view.View r1, androidx.core.view.WindowInsetsCompat r2) {
                return com.google.android.material.appbar.CollapsingToolbarLayout.this.onWindowInsetChanged(r2);
            }
        });
    }
