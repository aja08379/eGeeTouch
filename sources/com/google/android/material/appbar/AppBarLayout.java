...
public class AppBarLayout extends LinearLayout implements CoordinatorLayout.AttachedBehavior {
    ...
    */
    public AppBarLayout(android.content.Context r10, android.util.AttributeSet r11, int r12) {
        ...
        r9.totalScrollRange = -1;
        r9.downPreScrollRange = -1;
        r9.downScrollRange = -1;
        r9.pendingAction = 0;
        ...
        android.content.res.TypedArray r11 = com.google.android.material.internal.ThemeEnforcement.obtainStyledAttributes(r7, r11, com.google.android.material.R.styleable.AppBarLayout, r12, r4, new int[0]);
        androidx.core.view.ViewCompat.setBackground(r9, r11.getDrawable(com.google.android.material.R.styleable.AppBarLayout_android_background));
        ...
        if (r11.hasValue(com.google.android.material.R.styleable.AppBarLayout_expanded)) {
            setExpanded(r11.getBoolean(com.google.android.material.R.styleable.AppBarLayout_expanded, false), false, false);
        }
        if (android.os.Build.VERSION.SDK_INT >= 21 && r11.hasValue(com.google.android.material.R.styleable.AppBarLayout_elevation)) {
            com.google.android.material.appbar.ViewUtilsLollipop.setDefaultAppBarLayoutStateListAnimator(r9, r11.getDimensionPixelSize(com.google.android.material.R.styleable.AppBarLayout_elevation, 0));
        }
        if (android.os.Build.VERSION.SDK_INT >= 26) {
            if (r11.hasValue(com.google.android.material.R.styleable.AppBarLayout_android_keyboardNavigationCluster)) {
                setKeyboardNavigationCluster(r11.getBoolean(com.google.android.material.R.styleable.AppBarLayout_android_keyboardNavigationCluster, false));
            }
            if (r11.hasValue(com.google.android.material.R.styleable.AppBarLayout_android_touchscreenBlocksFocus)) {
                setTouchscreenBlocksFocus(r11.getBoolean(com.google.android.material.R.styleable.AppBarLayout_android_touchscreenBlocksFocus, false));
            }
        }
        r9.liftOnScroll = r11.getBoolean(com.google.android.material.R.styleable.AppBarLayout_liftOnScroll, false);
        r9.liftOnScrollTargetViewId = r11.getResourceId(com.google.android.material.R.styleable.AppBarLayout_liftOnScrollTargetViewId, -1);
        setStatusBarForeground(r11.getDrawable(com.google.android.material.R.styleable.AppBarLayout_statusBarForeground));
        r11.recycle();
        androidx.core.view.ViewCompat.setOnApplyWindowInsetsListener(r9, new androidx.core.view.OnApplyWindowInsetsListener() { // from class: com.google.android.material.appbar.AppBarLayout.1
            {
            }
            ...
            public androidx.core.view.WindowInsetsCompat onApplyWindowInsets(android.view.View r1, androidx.core.view.WindowInsetsCompat r2) {
                return com.google.android.material.appbar.AppBarLayout.this.onWindowInsetChanged(r2);
            }
        });
    }
