    ...
    */
    public boolean equals(java.lang.Object r4) {
        ...
        try {
            ...
            if (r3.zao.size() <= 0 && r4.zao.size() <= 0 && r3.zah.size() == r4.getScopes().size() && r3.zah.containsAll(r4.getScopes())) {
                android.accounts.Account r1 = r3.zai;
                if (r1 == null) {
                    if (r4.getAccount() == null) {
                    }
                }
                if (android.text.TextUtils.isEmpty(r3.zam)) {
                    if (android.text.TextUtils.isEmpty(r4.getServerClientId())) {
                    }
                } else if (!r3.zam.equals(r4.getServerClientId())) {
                }
                if (r3.zal == r4.isForceCodeForRefreshToken() && r3.zaj == r4.isIdTokenRequested() && r3.zak == r4.isServerAuthCodeRequested()) {
                    if (android.text.TextUtils.equals(r3.zap, r4.getLogSessionId())) {
                        return true;
                    }
                }
            }
