...
public final class zzxc {
    ...
    */
    public static com.google.firebase.FirebaseException zza(com.google.android.gms.common.api.Status r3) {
        ...
        java.lang.String r1 = zze(zzf(r0), r3);
        if (r0 == 17020) {
            return new com.google.firebase.FirebaseNetworkException(zze("A network error (such as timeout, interrupted connection or unreachable host) has occurred.", r3));
        }
        if (r0 != 17021) {
            if (r0 != 17051) {
                if (r0 != 17052) {
                    if (r0 != 17057 && r0 != 17058) {
                        switch (r0) {
                            case com.google.firebase.FirebaseError.ERROR_INVALID_CUSTOM_TOKEN /* 17000 */:
                            case com.google.firebase.FirebaseError.ERROR_CUSTOM_TOKEN_MISMATCH /* 17002 */:
                            case com.google.firebase.FirebaseError.ERROR_INVALID_CREDENTIAL /* 17004 */:
                            case com.google.firebase.FirebaseError.ERROR_INVALID_EMAIL /* 17008 */:
                            case com.google.firebase.FirebaseError.ERROR_WRONG_PASSWORD /* 17009 */:
                            case 17049:
                            case 17077:
                            case 17081:
                            case 17082:
                            ...
                            case 17094:
                                break;
                            case com.google.firebase.FirebaseError.ERROR_USER_DISABLED /* 17005 */:
                            case com.google.firebase.FirebaseError.ERROR_USER_NOT_FOUND /* 17011 */:
                                break;
                            case com.google.firebase.FirebaseError.ERROR_OPERATION_NOT_ALLOWED /* 17006 */:
                            case 17068:
                            case 17079:
                            case 17085:
                            case 17086:
                            ...
                            case com.google.firebase.FirebaseError.ERROR_EMAIL_ALREADY_IN_USE /* 17007 */:
                            case com.google.firebase.FirebaseError.ERROR_ACCOUNT_EXISTS_WITH_DIFFERENT_CREDENTIAL /* 17012 */:
                                return new com.google.firebase.auth.FirebaseAuthUserCollisionException(zzd(r0), r1);
                            case com.google.firebase.FirebaseError.ERROR_TOO_MANY_REQUESTS /* 17010 */:
                                return new com.google.firebase.FirebaseTooManyRequestsException(zze("We have blocked all requests from this device due to unusual activity. Try again later.", r3));
                            case 17080:
                                return new com.google.firebase.FirebaseApiNotAvailableException(r1);
                            case com.google.firebase.FirebaseError.ERROR_NO_SIGNED_IN_USER /* 17495 */:
                                return new com.google.firebase.internal.api.FirebaseNoSignedInUserException(zze("Please sign in before trying to get a token.", r3));
                            case com.google.firebase.FirebaseError.ERROR_INTERNAL_ERROR /* 17499 */:
                                return new com.google.firebase.FirebaseException(zze("An internal error has occurred.", r3));
                            case 18006:
                                return new com.google.firebase.auth.zzw(zzd(r0), r1);
                            case 18011:
                                return new com.google.firebase.auth.zzv(zzd(r0), r1);
                            default:
                                switch (r0) {
                                    case com.google.firebase.FirebaseError.ERROR_REQUIRES_RECENT_LOGIN /* 17014 */:
                                        return new com.google.firebase.auth.FirebaseAuthRecentLoginRequiredException(zzd(r0), r1);
                                    case com.google.firebase.FirebaseError.ERROR_PROVIDER_ALREADY_LINKED /* 17015 */:
                                        return new com.google.firebase.FirebaseException(zze("User has already been linked to the given provider.", r3));
                                    case com.google.firebase.FirebaseError.ERROR_NO_SUCH_PROVIDER /* 17016 */:
                                        return new com.google.firebase.FirebaseException(zze("User was not linked to an account with the given provider.", r3));
                                    case com.google.firebase.FirebaseError.ERROR_INVALID_USER_TOKEN /* 17017 */:
                                        break;
                                    default:
                                        switch (r0) {
                                            case com.google.firebase.FirebaseError.ERROR_USER_MISMATCH /* 17024 */:
                                                break;
                                            case com.google.firebase.FirebaseError.ERROR_CREDENTIAL_ALREADY_IN_USE /* 17025 */:
                                                break;
                                            case com.google.firebase.FirebaseError.ERROR_WEAK_PASSWORD /* 17026 */:
                                                return new com.google.firebase.auth.FirebaseAuthWeakPasswordException(zzd(r0), r1, r3.getStatusMessage());
                                            default:
                                                switch (r0) {
                                                    case com.google.firebase.FirebaseError.ERROR_APP_NOT_AUTHORIZED /* 17028 */:
                                                        break;
                                                    case 17029:
                                                    case 17030:
                                                        return new com.google.firebase.auth.FirebaseAuthActionCodeException(zzd(r0), r1);
                                                    case 17031:
                                                    case 17032:
                                                    case 17033:
                                                        return new com.google.firebase.auth.FirebaseAuthEmailException(zzd(r0), r1);
                                                    case 17034:
                                                    case 17035:
                                                        break;
                                                    default:
                                                        switch (r0) {
                                                            ...
                                                            default:
                                                                switch (r0) {
                                                                    case 17061:
                                                                        return new com.google.firebase.FirebaseNetworkException(zze("There was a failure in the connection between the web widget and the Firebase Auth backend.", r3));
                                                                    case 17062:
                                                                    case 17065:
                                                                        break;
                                                                    case 17063:
                                                                    ...
                                                                    default:
                                                                        switch (r0) {
                                                                            ...
                                                                            case 17075:
                                                                                break;
                                                                            default:
                                                                                return new com.google.firebase.FirebaseException("An internal error has occurred.");
                                                                        }
                                                                }
                                                        }
                                                }
                    ...
                    return new com.google.firebase.auth.FirebaseAuthWebException(zzd(r0), r1);
                }
                return new com.google.firebase.FirebaseTooManyRequestsException(r1);
            }
