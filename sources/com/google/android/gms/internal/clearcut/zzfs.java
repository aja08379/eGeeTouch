                    ...
                    if (charAt2 < 2048) {
                        ...
                        if (i5 != charSequence.length()) {
                            ...
                            if (Character.isSurrogatePair(charAt2, charAt3)) {
                                ...
                                byteBuffer.put((byte) ((codePoint >>> 18) | BLEService.ReadResponse_ShackleBypass));
                ...
                while (i4 < length2) {
                    ...
                    if (charAt4 >= 128 || i >= i6) {
                        if (charAt4 < 2048 && i <= i6 - 2) {
                            ...
                            if (i > i6 - 4) {
                                throw new ArrayIndexOutOfBoundsException(new StringBuilder(37).append("Failed writing ").append(charAt4).append(" at index ").append(i).toString());
                            }
                            int i9 = i4 + 1;
                            if (i9 != charSequence.length()) {
                                ...
                                if (Character.isSurrogatePair(charAt4, charAt5)) {
                                    ...
                                    int i10 = i + 1;
                                    array[i] = (byte) ((codePoint2 >>> 18) | BLEService.ReadResponse_ShackleBypass);
                                    int i11 = i10 + 1;
