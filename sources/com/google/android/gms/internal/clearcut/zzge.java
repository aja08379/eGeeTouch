...
public final class zzge {
    ...
    public static final class zza extends zzcg<zza, C0068zza> implements zzdq {
        ...
        public static final class C0068zza extends zzcg.zza<zza, C0068zza> implements zzdq {
            ...
            /* synthetic */ C0068zza(zzgf zzgfVar) {
                this();
            }
        }
    ...
    public static final class zzq extends zzcg.zzd<zzq, zza> implements zzdq {
        ...
        public enum zzb implements zzcj {
            ...
            STORE(0),
            WEB_STORE(65),
            WORK_STORE(TaskManagement.log_extract20),
            WORK_STORE_APP(261),
            EDU_STORE(15),
            MUSIC(1),
            BOOKS(2),
            ...
            LB_C(24),
            LB_IA(52),
            LB_CB(BLEService.ReadResponse_AutoLocking_Settings),
            LB_DM(268),
            ...
            ANDROID_CAMERA(26),
            CW(27),
            CW_COUNTERS(BLEService.Request_lotoBatteryRecords),
            CW_GCORE(784),
            GEL(28),
            DNA_PROBER(29),
            UDR(30),
            ...
            GOOGLE_EXPRESS_COURIER_ANDROID_PRIMES(BLEService.Read_response_timestamp),
            GOOGLE_EXPRESS_ANDROID_PRIMES(BLEService.Read_response_tag_AuditTrail_number),
            GOOGLE_EXPRESS_IOS_PRIMES(374),
            GOOGLE_EXPRESS_STOREOMS_ANDROID_PRIMES(BLEService.ReadResponse_ShackleBypass),
            SENSE(83),
            ANDROID_BACKUP(84),
            VR(85),
            IME_COUNTERS(86),
            ...
            GRAPHICS_STATS(107),
            PROC_STATS(93),
            DROP_BOX(TaskManagement.log_extract10),
            ...
            IOS_GSA(118),
            TAP_AND_PAY_APP(119),
            TAP_AND_PAY_APP_COUNTERS(BLEService.Request_lotoEnable_auditTrail),
            FLYDROID(120),
            CPANEL_APP(121),
            ...
            TAILORMADE(127),
            KEEP(128),
            GMM_BRIIM_COUNTERS(TaskManagement.restore_tag2),
            CHROMECAST_APP_LOG(TaskManagement.restore_admin),
            ADWORDS_MOBILE(TaskManagement.restore_user1),
            ADWORDS_MOBILE_ANDROID_PRIMES(224),
            ADWORDS_MOBILE_IOS_PRIMES(546),
            ADWORDS_MOBILE_ACX(764),
            LEANBACK_EVENT(TaskManagement.restore_user2),
            ANDROID_GMAIL(TaskManagement.restore_user3),
            SAMPLE_SHM(TaskManagement.restore_user4),
            ...
            YT_LITE_ANDROID_PRIMES(BLEService.Request_tag_AuditTrail_number),
            YT_CREATOR_ANDROID_PRIMES(BLEService.Read_response_Lock_Setting_Param),
            YT_UNPLUGGED_ANDROID_PRIMES(589),
            JAM_ANDROID_PRIMES(BLEService.Send_timeStamp),
            JAM_IOS_PRIMES(769),
            JAM_KIOSK_ANDROID_PRIMES(BLEService.check_version),
            JELLY_ANDROID_PRIMES(767),
            JELLY_IOS_PRIMES(ValidationPath.MAX_PATH_LENGTH_BYTES),
            PHOTOS_ANDROID_PRIMES(BLEService.Read_response_update_reconnecting_period),
            DRIVE_ANDROID_PRIMES(BLEService.Read_Response_enter_low_power_mode),
            SHEETS_ANDROID_PRIMES(BLEService.Read_Response_quit_low_power_mode),
            SLIDES_ANDROID_PRIMES(BLEService.Read_Response_read_serial),
            SNAPSEED_ANDROID_PRIMES(BLEService.Read_response_Admin_Password_new_lock),
            ...
            AWX_ANDROID_PRIMES(BLEService.Request_tag_number_version2),
            GHS_ANDROID_PRIMES(BLEService.Request_tag_list_version2),
            TAP_AND_PAY_ANDROID_PRIMES(BLEService.Read_Response_Request_Tag_number_Version2),
            WALLET_APP_ANDROID_PRIMES(BLEService.Request_clear_tag_AuditTrail),
            WALLET_APP_IOS_PRIMES(BLEService.Read_response_clear_tag_AuditTrail),
            ANALYTICS_ANDROID_PRIMES(BLEService.ScanTagId_FromLock),
            ANALYTICS_IOS_PRIMES(538),
            SPACES_ANDROID_PRIMES(BLEService.ReadResponse_scanTagId),
            SPACES_IOS_PRIMES(276),
            SOCIETY_ANDROID_PRIMES(BLEService.ShackleBypass_settings),
            GMM_BRIIM_PRIMES(239),
            CW_PRIMES(BLEService.ReadResponse_Master_Tag),
            CW_IOS_PRIMES(699),
            FAMILYLINK_ANDROID_PRIMES(BLEService.Read_response_lotoBatteryRecords),
            FAMILYLINK_IOS_PRIMES(291),
            WH_PRIMES(248),
            NOVA_ANDROID_PRIMES(BLEService.Request_passcodeValue),
            PHOTOS_DRAPER_ANDROID_PRIMES(BLEService.Request_clear_passcodeAuditTrail),
            GMM_PRIMES(BLEService.ReadResponse_clear_passcodeAuditTrail),
            TRANSLATE_ANDROID_PRIMES(255),
            TRANSLATE_IOS_PRIMES(256),
            FREIGHTER_ANDROID_PRIMES(BLEService.Request_changePasscode_Count),
            CONSUMERIQ_PRIMES(BLEService.ReadResponse_changePasscode_Count),
            ...
            CROSSDEVICENOTIFICATION_DEV(BuildConfig.VERSION_CODE),
            MAPS_API_COUNTERS(143),
            GPU(BLEService.Request_old_passcode),
            ON_THE_GO(com.egeetouch.egeetouch_manager.BuildConfig.VERSION_CODE),
            ...
            CRONET_FIREBALL(303),
            FIREBALL_PRIMES(BLEService.Read_Response_lotoEnable_auditTrail),
            FIREBALL_IOS_PRIMES(313),
            GOOGLE_HANDWRITING_INPUT_ANDROID_PRIMES(314),
            PYROCLASM(BLEService.AutoLocking_Settings),
            ANDROID_GSA_COUNTERS(BLEService.check_model),
            JAM_IMPRESSIONS(162),
            JAM_KIOSK_IMPRESSIONS(163),
            PAYMENTS_OCR(164),
            UNICORN_FAMILY_MANAGEMENT(172),
            AUDITOR(BLEService.Request_ChangePasscode),
            NQLOOKUP(174),
            ANDROID_GSA_HIGH_PRIORITY_EVENTS(175),
            ANDROID_DIALER(BLEService.Verify_Admin_Password_new_lock),
            CLEARCUT_DEMO(177),
            APPMANAGER(183),
            SMARTLOCK_COUNTERS(184),
            EXPEDITIONS_GUIDE(185),
            FUSE(186),
            PIXEL_PERFECT_CLIENT_STATE_LOGGER(BLEService.disconnect),
            ...
            GOOGLE_KEYBOARD_COUNTERS(BLEService.Add_tag_version2),
            CLEARCUT_PROBER(BLEService.Add_Tag_fail),
            PLAY_CONSOLE_APP(226),
            PLAY_CONSOLE_APP_PRIMES(264),
            PLAY_CONSOLE_APP_FEATURE_ANALYTICS(507),
            SPECTRUM(BLEService.Request_tag_AuditTrial),
            SPECTRUM_COUNTERS(BLEService.Read_response_tag_AuditTrail),
            SPECTRUM_ANDROID_PRIMES(267),
            IOS_SPOTLIGHT_SEARCH_LIBRARY(234),
            BOQ_WEB(BLEService.Request_Master_Tag),
            ORCHESTRATION_CLIENT(BLEService.ReadResponse_ChangePasscode),
            ORCHESTRATION_CLIENT_DEV(246),
            GOOGLE_NOW_LAUNCHER(247),
            SCOOBY_SPAM_REPORT_LOG(250),
            IOS_GROWTH(BLEService.Request_passcodeAudit),
            APPS_NOTIFY(BLEService.ReadResponse_passcodeAudit),
            SMARTKEY_APP(269),
            ...
            MEETINGS_IOS_PRIMES(SingleDateAndTimeConstants.DAYS_PADDING),
            WEB_CONTACTS(365),
            ...
            BG_IN_OGB(407),
            BLOGGER(408),
            CORP_IOS_FOOD(BLEService.Read_masterTag_only),
            ...
            GMM_WEARABLE_COUNTERS(SASocket.CONNECTION_LOST_DEVICE_DETACHED),
            VR_STREAMING_ANDROID_PRIMES(SASocket.CONNECTION_LOST_RETRANSMISSION_FAILED),
            REACHABILITY_GCORE(SASocket.CONNECTION_LOST_RECEIVE_LIMIT_VIOLATED),
            DMAGENT_IOS(524),
            ...
            GRPC_INTEROP_ANDROID_PRIMES(BLEService.coresponse_MasterTag),
            KLOPFKLOPF(666),
            ...
            public static zzb zzax(int i) {
                switch (i) {
                    ...
                    case 128:
                        return KEEP;
                    case TaskManagement.restore_tag2 /* 129 */:
                        return GMM_BRIIM_COUNTERS;
                    case TaskManagement.restore_admin /* 130 */:
                        return CHROMECAST_APP_LOG;
                    case TaskManagement.log_extract10 /* 131 */:
                        return DROP_BOX;
                    case TaskManagement.log_extract20 /* 132 */:
                        return WORK_STORE;
                    case TaskManagement.restore_user1 /* 133 */:
                        return ADWORDS_MOBILE;
                    case TaskManagement.restore_user2 /* 134 */:
                        return LEANBACK_EVENT;
                    case TaskManagement.restore_user3 /* 135 */:
                        return ANDROID_GMAIL;
                    case TaskManagement.restore_user4 /* 136 */:
                        return SAMPLE_SHM;
                    case 137:
                        return ICORE;
                    case 138:
                    ...
                    case BLEService.Request_old_passcode /* 144 */:
                        return GPU;
                    case com.egeetouch.egeetouch_manager.BuildConfig.VERSION_CODE /* 145 */:
                        return ON_THE_GO;
                    case 146:
                    ...
                    case BLEService.AutoLocking_Settings /* 153 */:
                        return PYROCLASM;
                    case 154:
                    ...
                    case BLEService.Request_tag_AuditTrail_number /* 158 */:
                        return YT_LITE_ANDROID_PRIMES;
                    case BLEService.Send_timeStamp /* 159 */:
                    ...
                    case BLEService.Request_ChangePasscode /* 173 */:
                        return AUDITOR;
                    case 174:
                        return NQLOOKUP;
                    case 175:
                    ...
                    case BLEService.Add_tag_version2 /* 221 */:
                        return GOOGLE_KEYBOARD_COUNTERS;
                    case BLEService.Request_tag_number_version2 /* 222 */:
                        return AWX_ANDROID_PRIMES;
                    case BLEService.Request_tag_list_version2 /* 223 */:
                        return GHS_ANDROID_PRIMES;
                    case 224:
                        return ADWORDS_MOBILE_ANDROID_PRIMES;
                    case BLEService.Add_Tag_fail /* 225 */:
                        return CLEARCUT_PROBER;
                    case 226:
                        return PLAY_CONSOLE_APP;
                    case BLEService.Read_Response_Request_Tag_number_Version2 /* 227 */:
                        return TAP_AND_PAY_ANDROID_PRIMES;
                    case BLEService.Read_response_timestamp /* 228 */:
                        return GOOGLE_EXPRESS_COURIER_ANDROID_PRIMES;
                    case BLEService.Read_response_tag_AuditTrail_number /* 229 */:
                        return GOOGLE_EXPRESS_ANDROID_PRIMES;
                    case BLEService.Request_tag_AuditTrial /* 230 */:
                        return SPECTRUM;
                    case BLEService.Read_response_tag_AuditTrail /* 231 */:
                        return SPECTRUM_COUNTERS;
                    case BLEService.Request_clear_tag_AuditTrail /* 232 */:
                        return WALLET_APP_ANDROID_PRIMES;
                    case BLEService.Read_response_clear_tag_AuditTrail /* 233 */:
                        return WALLET_APP_IOS_PRIMES;
                    case 234:
                        return IOS_SPOTLIGHT_SEARCH_LIBRARY;
                    case BLEService.ScanTagId_FromLock /* 235 */:
                        return ANALYTICS_ANDROID_PRIMES;
                    case BLEService.ReadResponse_scanTagId /* 236 */:
                        return SPACES_ANDROID_PRIMES;
                    case BLEService.ReadResponse_AutoLocking_Settings /* 237 */:
                        return LB_CB;
                    case BLEService.ShackleBypass_settings /* 238 */:
                        return SOCIETY_ANDROID_PRIMES;
                    case 239:
                        return GMM_BRIIM_PRIMES;
                    case BLEService.ReadResponse_ShackleBypass /* 240 */:
                        return GOOGLE_EXPRESS_STOREOMS_ANDROID_PRIMES;
                    case BLEService.Request_Master_Tag /* 241 */:
                        return BOQ_WEB;
                    case BLEService.ReadResponse_Master_Tag /* 242 */:
                        return CW_PRIMES;
                    case BLEService.Request_lotoBatteryRecords /* 243 */:
                        return CW_COUNTERS;
                    case BLEService.Read_response_lotoBatteryRecords /* 244 */:
                        return FAMILYLINK_ANDROID_PRIMES;
                    case BLEService.ReadResponse_ChangePasscode /* 245 */:
                    ...
                    case 248:
                        return WH_PRIMES;
                    case BLEService.Request_passcodeValue /* 249 */:
                        return NOVA_ANDROID_PRIMES;
                    case 250:
                        return SCOOBY_SPAM_REPORT_LOG;
                    case BLEService.Request_passcodeAudit /* 251 */:
                        return IOS_GROWTH;
                    case BLEService.ReadResponse_passcodeAudit /* 252 */:
                        return APPS_NOTIFY;
                    case BLEService.Request_clear_passcodeAuditTrail /* 253 */:
                        return PHOTOS_DRAPER_ANDROID_PRIMES;
                    case BLEService.ReadResponse_clear_passcodeAuditTrail /* 254 */:
                        return GMM_PRIMES;
                    case 255:
                    ...
                    case BLEService.Request_lotoEnable_auditTrail /* 265 */:
                        return TAP_AND_PAY_APP_COUNTERS;
                    case BLEService.Read_Response_lotoEnable_auditTrail /* 266 */:
                    ...
                    case 408:
                        return BLOGGER;
                    case BLEService.Read_masterTag_only /* 409 */:
                    ...
                    case BLEService.coresponse_MasterTag /* 665 */:
