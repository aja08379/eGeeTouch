...
final class zzdu<T> implements zzef<T> {
    ...
    */
    public final void zza(T r8, byte[] r9, int r10, int r11, com.google.android.gms.internal.clearcut.zzay r12) throws java.io.IOException {
        ...
        if (r0 == com.google.android.gms.internal.clearcut.zzey.zzea()) {
            r0 = com.google.android.gms.internal.clearcut.zzey.zzeb();
            r8.zzjp = r0;
        }
        com.google.android.gms.internal.clearcut.zzey r8 = r0;
        while (r10 < r11) {
            int r2 = com.google.android.gms.internal.clearcut.zzax.zza(r9, r10, r12);
            int r0 = r12.zzfd;
            if (r0 != 11) {
                r10 = (r0 & 7) == 2 ? com.google.android.gms.internal.clearcut.zzax.zza(r0, r9, r2, r11, r8, r12) : com.google.android.gms.internal.clearcut.zzax.zza(r0, r9, r2, r11, r12);
            } else {
                int r10 = 0;
                com.google.android.gms.internal.clearcut.zzbb r0 = null;
                while (r2 < r11) {
                    r2 = com.google.android.gms.internal.clearcut.zzax.zza(r9, r2, r12);
                    int r3 = r12.zzfd;
                    int r4 = r3 >>> 3;
                    int r5 = r3 & 7;
                    if (r4 != 2) {
                        if (r4 == 3 && r5 == 2) {
                            r2 = com.google.android.gms.internal.clearcut.zzax.zze(r9, r2, r12);
                            r0 = (com.google.android.gms.internal.clearcut.zzbb) r12.zzff;
                        }
                        if (r3 != 12) {
                            break;
                        }
                        r2 = com.google.android.gms.internal.clearcut.zzax.zza(r3, r9, r2, r11, r12);
                    } else if (r5 == 0) {
                        r2 = com.google.android.gms.internal.clearcut.zzax.zza(r9, r2, r12);
                        r10 = r12.zzfd;
                    } else if (r3 != 12) {
