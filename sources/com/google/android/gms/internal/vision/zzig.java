...
public final class zzig implements zzld {
    ...
    */
    public final <K, V> void zza(java.util.Map<K, V> r8, com.google.android.gms.internal.vision.zzkf<K, V> r9, com.google.android.gms.internal.vision.zzio r10) throws java.io.IOException {
        zza(2);
        int r1 = r7.zza.zzc(r7.zza.zzm());
        java.lang.Object r2 = r9.zzb;
        java.lang.Object r3 = r9.zzd;
        while (true) {
            try {
                int r4 = zza();
                if (r4 == Integer.MAX_VALUE || r7.zza.zzt()) {
                    break;
                } else if (r4 == 1) {
                    r2 = zza(r9.zza, (java.lang.Class<?>) null, (com.google.android.gms.internal.vision.zzio) null);
                } else if (r4 == 2) {
                    r3 = zza(r9.zzc, r9.zzd.getClass(), r10);
                } else {
                    try {
                        if (!zzc()) {
                    ...
                    } catch (com.google.android.gms.internal.vision.zzjn unused) {
                        if (!zzc()) {
                            throw new com.google.android.gms.internal.vision.zzjk("Unable to parse map entry.");
                        }
                    }
