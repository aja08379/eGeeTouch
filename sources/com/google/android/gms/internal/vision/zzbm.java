...
public final class zzbm<T> extends zzbi<T> {
    ...
    final T zza(Object obj) {
        ...
        Log.e("PhenotypeFlag", new StringBuilder(String.valueOf(zzb).length() + 27 + String.valueOf(valueOf).length()).append("Invalid byte[] value for ").append(zzb).append(": ").append(valueOf).toString());
        return null;
    }
}
