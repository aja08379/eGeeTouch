...
public final class zzkv extends zzkh {
    ...
    public final String zzo(com.google.android.gms.internal.measurement.zzek zzekVar) {
        ...
        zzI(sb, 0, MeasurementEvent.MEASUREMENT_EVENT_NAME_KEY, this.zzt.zzj().zzd(zzekVar.zzg()));
    ...
    */
    public final java.util.Map zzs(android.os.Bundle r11, boolean r12) {
        ...
        java.util.Iterator<java.lang.String> r1 = r11.keySet().iterator();
        while (r1.hasNext()) {
            java.lang.String r2 = r1.next();
            java.lang.Object r3 = r11.get(r2);
            boolean r4 = r3 instanceof android.os.Parcelable[];
            if (!r4 && !(r3 instanceof java.util.ArrayList) && !(r3 instanceof android.os.Bundle)) {
                if (r3 != null) {
                    r0.put(r2, r3);
                }
            }
