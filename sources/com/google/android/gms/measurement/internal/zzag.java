...
public final class zzag extends zzgk {
    ...
    */
    public final java.util.List zzp(java.lang.String r4) {
        ...
        android.os.Bundle r0 = zzj();
        if (r0 == null) {
            r3.zzt.zzay().zzd().zza("Failed to load metadata: Metadata bundle is null");
        } else if (r0.containsKey("analytics.safelisted_events")) {
            r4 = java.lang.Integer.valueOf(r0.getInt("analytics.safelisted_events"));
            if (r4 != null) {
                try {
                    java.lang.String[] r4 = r3.zzt.zzau().getResources().getStringArray(r4.intValue());
                    if (r4 == null) {
                        return null;
                    }
                    return java.util.Arrays.asList(r4);
                } catch (android.content.res.Resources.NotFoundException r4) {
                    r3.zzt.zzay().zzd().zzb("Failed to load string array from metadata: resource not found", r4);
                }
            }
            return null;
        }
    ...
    public final boolean zzs(String str, zzdt zzdtVar) {
        ...
        return ((Boolean) zzdtVar.zza(Boolean.valueOf(AppEventsConstants.EVENT_PARAM_VALUE_YES.equals(zza)))).booleanValue();
    }
