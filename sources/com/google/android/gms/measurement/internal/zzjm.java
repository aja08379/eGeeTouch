    ...
    */
    public final boolean zzN() {
        ...
        if (r7.zzc == null) {
            zzg();
            zza();
            com.google.android.gms.measurement.internal.zzew r0 = r7.zzt.zzm();
            r0.zzg();
            boolean r3 = false;
            java.lang.Boolean r0 = !r0.zza().contains("use_service") ? null : java.lang.Boolean.valueOf(r0.zza().getBoolean("use_service", false));
            if (r0 == null || !r0.booleanValue()) {
                r7.zzt.zzaw();
                if (r7.zzt.zzh().zzh() != 1) {
                    r7.zzt.zzay().zzj().zza("Checking service availability");
                    int r4 = r7.zzt.zzv().zzo(com.google.android.gms.common.GooglePlayServicesUtilLight.GOOGLE_PLAY_SERVICES_VERSION_CODE);
                    if (r4 == 0) {
                        r7.zzt.zzay().zzj().zza("Service available");
                    } else {
                        if (r4 == 1) {
                            r7.zzt.zzay().zzj().zza("Service missing");
                        } else if (r4 != 2) {
                            if (r4 == 3) {
                                r7.zzt.zzay().zzk().zza("Service disabled");
                            } else if (r4 == 9) {
                                r7.zzt.zzay().zzk().zza("Service invalid");
                            } else if (r4 != 18) {
                                r7.zzt.zzay().zzk().zzb("Unexpected service status", java.lang.Integer.valueOf(r4));
                            } else {
                                r7.zzt.zzay().zzk().zza("Service updating");
                            }
                            r1 = false;
                        } else {
                            r7.zzt.zzay().zzc().zza("Service container out of date");
                            if (r7.zzt.zzv().zzm() >= 17443) {
                                r3 = r0 == null;
                                r1 = false;
                            }
                        }
                        if (r3 && r7.zzt.zzf().zzx()) {
                            r7.zzt.zzay().zzd().zza("No way to upload. Consider using the full version of Analytics");
                        } else if (r1) {
                            com.google.android.gms.measurement.internal.zzew r0 = r7.zzt.zzm();
                            r0.zzg();
                            android.content.SharedPreferences.Editor r0 = r0.zza().edit();
                            r0.putBoolean("use_service", r3);
                            r0.apply();
                        }
                        r1 = r3;
                    }
            ...
            r7.zzc = java.lang.Boolean.valueOf(r1);
        }
        return r7.zzc.booleanValue();
    }
