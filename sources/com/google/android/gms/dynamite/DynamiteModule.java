    ...
    */
    private static int zzb(android.content.Context r10, java.lang.String r11, boolean r12, boolean r13) throws com.google.android.gms.dynamite.DynamiteModule.LoadingException {
        ...
        try {
            try {
                boolean r9 = true;
                android.database.Cursor r10 = r10.getContentResolver().query(new android.net.Uri.Builder().scheme(com.google.firebase.analytics.FirebaseAnalytics.Param.CONTENT).authority("com.google.android.gms.chimera").path(true != r12 ? "api" : "api_force_staging").appendPath(r11).appendQueryParameter("requestStartTime", java.lang.String.valueOf(((java.lang.Long) com.google.android.gms.dynamite.DynamiteModule.zzh.get()).longValue())).build(), null, null, null, null);
                if (r10 != null) {
                    try {
                        if (r10.moveToFirst()) {
                            boolean r11 = false;
                            int r12 = r10.getInt(0);
                            if (r12 > 0) {
                                synchronized (com.google.android.gms.dynamite.DynamiteModule.class) {
                                    com.google.android.gms.dynamite.DynamiteModule.zzc = r10.getString(2);
                                    int r2 = r10.getColumnIndex("loaderVersion");
                                    if (r2 >= 0) {
                                        com.google.android.gms.dynamite.DynamiteModule.zze = r10.getInt(r2);
                                    }
                                    int r2 = r10.getColumnIndex("disableStandaloneDynamiteLoader2");
                                    if (r2 >= 0) {
                                        if (r10.getInt(r2) == 0) {
                                            r9 = false;
                                        }
                                        com.google.android.gms.dynamite.DynamiteModule.zzd = r9;
                                        r11 = r9;
                                    }
                                }
                                if (zze(r10)) {
                        ...
                        r11 = e;
                        if (r11 instanceof com.google.android.gms.dynamite.DynamiteModule.LoadingException) {
                            throw r11;
                        }
                        throw new com.google.android.gms.dynamite.DynamiteModule.LoadingException("V2 version check failed", r11, null);
                    }
                }
        ...
        } catch (java.lang.Exception r10) {
            r11 = r10;
        } catch (java.lang.Throwable r10) {
            r11 = r10;
            if (r0 != 0) {
            }
            throw r11;
    ...
    private static boolean zzf(Context context) {
        ...
        if (zzf == null) {
            ...
            if (z && resolveContentProvider != null && resolveContentProvider.applicationInfo != null && (resolveContentProvider.applicationInfo.flags & TaskManagement.restore_tag2) == 0) {
