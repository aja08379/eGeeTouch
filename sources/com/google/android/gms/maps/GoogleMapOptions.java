...
public final class GoogleMapOptions extends AbstractSafeParcelable implements ReflectedParcelable {
    ...
    private static final Integer zza = Integer.valueOf(Color.argb(255, (int) BLEService.ReadResponse_scanTagId, (int) BLEService.Read_response_clear_tag_AuditTrail, (int) BLEService.Add_Tag_fail));
    private Boolean zzb;
    private Boolean zzc;
    private int zzd;
