...
public abstract class ImmutableSortedMap<K, V> implements Iterable<Map.Entry<K, V>> {
    ...
    public static class Builder {
        ...
        private static final KeyTranslator IDENTITY_TRANSLATOR = new KeyTranslator() { // from class: com.google.firebase.database.collection.-$$Lambda$ImmutableSortedMap$Builder$6y7xYObLuge9FUW97sc5MLHleDs
