...
public class ConfigFetchHandler {
    ...
    public Task<FetchResponse> fetch(final long j) {
        return this.fetchedConfigsCache.get().continueWithTask(this.executor, new Continuation() { // from class: com.google.firebase.remoteconfig.internal.-$$Lambda$ConfigFetchHandler$_tjGB9jaJonLcF1rIbfQkwMA1XU
            @Override // com.google.android.gms.tasks.Continuation
            public final Object then(Task task) {
                return ConfigFetchHandler.this.lambda$fetch$0$ConfigFetchHandler(j, task);
            }
        });
    }
    ...
    public Task<FetchResponse> lambda$fetch$0$ConfigFetchHandler(Task<ConfigContainer> task, long j) {
        ...
        if (backoffEndTimeInMillis != null) {
            ...
            continueWithTask = Tasks.whenAllComplete(id, token).continueWithTask(this.executor, new Continuation() { // from class: com.google.firebase.remoteconfig.internal.-$$Lambda$ConfigFetchHandler$PAoFtfQiOtbXSTeK4H2aFJ-JNJI
                @Override // com.google.android.gms.tasks.Continuation
                public final Object then(Task task2) {
                    return ConfigFetchHandler.this.lambda$fetchIfCacheExpiredAndNotThrottled$1$ConfigFetchHandler(id, token, date, task2);
                }
            });
        }
        return continueWithTask.continueWithTask(this.executor, new Continuation() { // from class: com.google.firebase.remoteconfig.internal.-$$Lambda$ConfigFetchHandler$lrgMCPtdxGC9uIVdIVFO4IwVIow
            @Override // com.google.android.gms.tasks.Continuation
            public final Object then(Task task2) {
                return ConfigFetchHandler.this.lambda$fetchIfCacheExpiredAndNotThrottled$2$ConfigFetchHandler(date, task2);
            }
        });
    }
    ...
    private Task<FetchResponse> fetchFromBackendAndCacheResponse(String str, String str2, Date date) {
        try {
            ...
            return this.fetchedConfigsCache.put(fetchFromBackend.getFetchedConfigs()).onSuccessTask(this.executor, new SuccessContinuation() { // from class: com.google.firebase.remoteconfig.internal.-$$Lambda$ConfigFetchHandler$pGD5duYKt2TdXKoVVRbV6-CDVRg
