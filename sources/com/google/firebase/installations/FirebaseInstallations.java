...
public class FirebaseInstallations implements FirebaseInstallationsApi {
    ...
    */
    public void lambda$doRegistrationOrRefresh$3$FirebaseInstallations(boolean r3) {
        ...
        com.google.firebase.installations.local.PersistedInstallationEntry r0 = getMultiProcessSafePrefs();
        try {
            if (!r0.isErrored() && !r0.isUnregistered()) {
                if (!r3 && !r2.utils.isAuthTokenExpired(r0)) {
                    return;
                }
                r3 = fetchAuthTokenFromServer(r0);
                insertOrUpdatePrefs(r3);
                updateFidListener(r0, r3);
                if (r3.isRegistered()) {
                    updateCacheFid(r3.getFirebaseInstallationId());
                }
                if (!r3.isErrored()) {
                    ...
                    return;
                } else if (r3.isNotGenerated()) {
                    triggerOnException(new java.io.IOException(com.google.firebase.installations.FirebaseInstallations.AUTH_ERROR_MSG));
                    return;
                } else {
                    triggerOnStateReached(r3);
                    return;
                }
            }
            r3 = registerFidWithServer(r0);
            insertOrUpdatePrefs(r3);
            updateFidListener(r0, r3);
            if (r3.isRegistered()) {
            }
        ...
        } catch (com.google.firebase.installations.FirebaseInstallationsException r3) {
            triggerOnException(r3);
        }
    }
