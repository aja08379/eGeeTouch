...
public final class ReportQueue {
    ...
    public void flushScheduledReportsIfAble() {
        ...
        new Thread(new Runnable() { // from class: com.google.firebase.crashlytics.internal.send.-$$Lambda$ReportQueue$sGV6aXF5ijJp8gd8P34G6CFd3nk
            @Override // java.lang.Runnable
            public final void run() {
                ReportQueue.this.lambda$flushScheduledReportsIfAble$0$ReportQueue(countDownLatch);
            }
        }).start();
    ...
    public void sendReport(final CrashlyticsReportWithSessionId crashlyticsReportWithSessionId, final TaskCompletionSource<CrashlyticsReportWithSessionId> taskCompletionSource) {
        ...
        this.transport.schedule(Event.ofUrgent(crashlyticsReportWithSessionId.getReport()), new TransportScheduleCallback() { // from class: com.google.firebase.crashlytics.internal.send.-$$Lambda$ReportQueue$kNZql7evhRorVHoM-PbXdxywtvQ
            @Override // com.google.android.datatransport.TransportScheduleCallback
            public final void onSchedule(Exception exc) {
                ReportQueue.this.lambda$sendReport$1$ReportQueue(taskCompletionSource, crashlyticsReportWithSessionId, exc);
            }
        });
    }
