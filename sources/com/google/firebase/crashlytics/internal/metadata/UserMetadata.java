...
public class UserMetadata {
    ...
    public void setUserId(String str) {
        ...
        synchronized (this.userId) {
            ...
            this.backgroundWorker.submit(new Callable() { // from class: com.google.firebase.crashlytics.internal.metadata.-$$Lambda$UserMetadata$1AUSzq459t6xeFPyvFcsgdzmB0Y
    ...
    public class SerializeableKeysMap {
        ...
        private void scheduleSerializationTaskIfNeeded() {
            Callable<Void> callable = new Callable() { // from class: com.google.firebase.crashlytics.internal.metadata.-$$Lambda$UserMetadata$SerializeableKeysMap$LH_5nmLNx7JWSKpBG7431_guENk
                @Override // java.util.concurrent.Callable
                public final Object call() {
