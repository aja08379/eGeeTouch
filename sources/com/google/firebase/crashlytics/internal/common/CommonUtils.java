...
public class CommonUtils {
    ...
    */
    public static java.lang.String extractFieldFromSystemFile(java.io.File r6, java.lang.String r7) {
        ...
        r2 = null;
        r2 = null;
        java.io.BufferedReader r2 = null;
        if (r6.exists()) {
            try {
                r1 = new java.io.BufferedReader(new java.io.FileReader(r6), 1024);
                while (true) {
                    try {
                        try {
                            ...
                            java.lang.String[] r3 = java.util.regex.Pattern.compile("\\s*:\\s*").split(r3, 2);
                            if (r3.length > 1 && r3[0].equals(r7)) {
                                break;
                            }
                        } catch (java.lang.Exception e) {
                            r7 = e;
                            com.google.firebase.crashlytics.internal.Logger.getLogger().e("Error parsing " + r6, r7);
                            closeOrLog(r1, "Failed to close system file reader.");
                            return r2;
                        }
