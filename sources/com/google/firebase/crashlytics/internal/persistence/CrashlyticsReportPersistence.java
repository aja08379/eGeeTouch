...
public class CrashlyticsReportPersistence {
    ...
    private int trimEvents(String str, int i) {
        List<File> sessionFiles = this.fileStore.getSessionFiles(str, new FilenameFilter() { // from class: com.google.firebase.crashlytics.internal.persistence.-$$Lambda$CrashlyticsReportPersistence$JFU0vij0Pn952vNT34mb4Hr_UXo
            @Override // java.io.FilenameFilter
        ...
        Collections.sort(sessionFiles, new Comparator() { // from class: com.google.firebase.crashlytics.internal.persistence.-$$Lambda$CrashlyticsReportPersistence$n3pLmsPsV-a9XZY5T7lAH7PN0HQ
            @Override // java.util.Comparator
            public final int compare(Object obj, Object obj2) {
