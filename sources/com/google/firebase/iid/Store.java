        ...
        static Token parse(String str) {
            ...
            if (str.startsWith("{")) {
                try {
                    ...
                    return new Token(jSONObject.getString("token"), jSONObject.getString(RemoteConfigConstants.RequestFieldKey.APP_VERSION), jSONObject.getLong(ServerValues.NAME_OP_TIMESTAMP));
                } catch (JSONException e) {
                    String valueOf = String.valueOf(e);
