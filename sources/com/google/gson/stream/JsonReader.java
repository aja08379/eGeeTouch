...
public class JsonReader implements Closeable {
            ...
            if (r14 != '+') {
                if (r14 == 'E' || r14 == 'e') {
                    ...
                    if (r9 == 1 || r9 == 0) {
                        ...
                        int r7 = (r11 > com.google.gson.stream.JsonReader.MIN_INCOMPLETE_INTEGER ? 1 : (r11 == com.google.gson.stream.JsonReader.MIN_INCOMPLETE_INTEGER ? 0 : -1));
                        r10 &= r7 > 0 || (r7 == 0 && r4 < r11);
                        r11 = r4;
                    } else if (r9 == 3) {
                        r7 = 0;
                        r9 = 4;
    ...
    */
    private java.lang.String nextQuotedValue(char r10) throws java.io.IOException {
        char[] r0 = r9.buffer;
        java.lang.StringBuilder r1 = null;
        do {
            int r2 = r9.pos;
            int r3 = r9.limit;
            while (true) {
                ...
                while (r2 < r4) {
                    ...
                    if (r2 == r10) {
                        ...
                        int r7 = (r7 - r3) - 1;
                        if (r1 == null) {
                            return new java.lang.String(r0, r3, r7);
                        }
                        r1.append(r0, r3, r7);
                        return r1.toString();
                    } else if (r2 == '\\') {
                        ...
                        int r7 = (r7 - r3) - 1;
                        if (r1 == null) {
                            r1 = new java.lang.StringBuilder(java.lang.Math.max((r7 + 1) * 2, 16));
                        }
                        r1.append(r0, r3, r7);
    ...
    private java.lang.String nextUnquotedValue() throws java.io.IOException {
        ...
        do {
            ...
            while (true) {
                ...
                } else if (r2 < r6.buffer.length) {
                    if (fillBuffer(r2 + 1)) {
                    }
                } else {
                    if (r1 == null) {
                        r1 = new java.lang.StringBuilder(java.lang.Math.max(r2, 16));
                    }
                    r1.append(r6.buffer, r6.pos, r2);
                    r6.pos += r2;
                }
            }
            r0 = r2;
            java.lang.String r1 = r1 != null ? new java.lang.String(r6.buffer, r6.pos, r0) : r1.append(r6.buffer, r6.pos, r0).toString();
            r6.pos += r0;
            return r1;
        } while (fillBuffer(1));
        if (r1 != null) {
