...
public final class C$Gson$Types {
    ...
    */
    private static java.lang.reflect.Type resolve(java.lang.reflect.Type r9, java.lang.Class<?> r10, java.lang.reflect.Type r11, java.util.Map<java.lang.reflect.TypeVariable<?>, java.lang.reflect.Type> r12) {
        ...
        java.lang.reflect.Type r9;
        java.lang.reflect.TypeVariable r0 = null;
        ?? r11 = r11;
        while (true) {
            if (r11 instanceof java.lang.reflect.TypeVariable) {
                java.lang.reflect.TypeVariable r1 = r11;
                java.lang.reflect.Type r2 = (java.lang.reflect.Type) r12.get(r1);
                if (r2 != null) {
                    return r2 == java.lang.Void.TYPE ? r11 : r2;
                }
                r12.put(r1, java.lang.Void.TYPE);
                if (r0 == null) {
                    r0 = r1;
                }
                ...
                if (r11 instanceof java.lang.Class) {
                ...
                if (r11 instanceof java.lang.reflect.GenericArrayType) {
                    r11 = (java.lang.reflect.GenericArrayType) r11;
                    ...
                    if (r11 instanceof java.lang.reflect.ParameterizedType) {
                        ...
                        for (int r2 = 0; r2 < r6; r2++) {
                            java.lang.reflect.Type r7 = resolve(r9, r10, r5[r2], r12);
                            if (!equal(r7, r5[r2])) {
                                if (!r1) {
                                    r5 = (java.lang.reflect.Type[]) r5.clone();
                                    r1 = true;
                                }
                                r5[r2] = r7;
                            }
                        ...
                        if (r1) {
                            r9 = newParameterizedTypeWithOwner(r4, r11.getRawType(), r5);
                            r11 = r9;
                        }
                    } else if (r11 instanceof java.lang.reflect.WildcardType) {
                        r11 = (java.lang.reflect.WildcardType) r11;
                        java.lang.reflect.Type[] r1 = r11.getLowerBounds();
                        java.lang.reflect.Type[] r4 = r11.getUpperBounds();
                        if (r1.length == 1) {
                            java.lang.reflect.Type r9 = resolve(r9, r10, r1[0], r12);
                            if (r9 != r1[0]) {
                                r11 = supertypeOf(r9);
                            }
                        } else if (r4.length == 1 && (r9 = resolve(r9, r10, r4[0], r12)) != r4[0]) {
                            r11 = subtypeOf(r9);
                        }
                    }
                }
