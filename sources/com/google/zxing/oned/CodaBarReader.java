...
public final class CodaBarReader extends OneDReader {
    ...
    */
    private void validatePattern(int r15) throws com.google.zxing.NotFoundException {
        int[] r1 = {0, 0, 0, 0};
        int[] r2 = {0, 0, 0, 0};
        int r3 = r14.decodeRowResult.length() - 1;
        int r4 = 0;
        int r6 = r15;
        int r5 = 0;
        while (true) {
            int r7 = com.google.zxing.oned.CodaBarReader.CHARACTER_ENCODINGS[r14.decodeRowResult.charAt(r5)];
            for (int r9 = 6; r9 >= 0; r9--) {
                int r10 = (r9 & 1) + ((r7 & 1) << 1);
                r1[r10] = r1[r10] + r14.counters[r6 + r9];
                r2[r10] = r2[r10] + 1;
                r7 >>= 1;
            }
            if (r5 >= r3) {
        ...
        float[] r5 = new float[4];
        float[] r0 = new float[4];
        for (int r6 = 0; r6 < 2; r6++) {
            r0[r6] = 0.0f;
            int r7 = r6 + 2;
            r0[r7] = ((r1[r6] / r2[r6]) + (r1[r7] / r2[r7])) / com.google.zxing.oned.CodaBarReader.MAX_ACCEPTABLE;
            r5[r6] = r0[r7];
            r5[r7] = ((r1[r7] * com.google.zxing.oned.CodaBarReader.MAX_ACCEPTABLE) + com.google.zxing.oned.CodaBarReader.PADDING) / r2[r7];
        }
        loop3: while (true) {
            int r1 = com.google.zxing.oned.CodaBarReader.CHARACTER_ENCODINGS[r14.decodeRowResult.charAt(r4)];
            for (int r2 = 6; r2 >= 0; r2--) {
                int r6 = (r2 & 1) + ((r1 & 1) << 1);
                float r7 = r14.counters[r15 + r2];
                if (r7 < r0[r6] || r7 > r5[r6]) {
                    break loop3;
                }
                r1 >>= 1;
            }
