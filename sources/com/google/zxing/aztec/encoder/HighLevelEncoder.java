...
public final class HighLevelEncoder {
    ...
    */
    public com.google.zxing.common.BitArray encode() {
        int r3;
        java.util.Collection<com.google.zxing.aztec.encoder.State> r0 = java.util.Collections.singletonList(com.google.zxing.aztec.encoder.State.INITIAL_STATE);
        int r2 = 0;
        while (true) {
            byte[] r3 = r8.text;
            if (r2 < r3.length) {
                int r4 = r2 + 1;
                byte r5 = r4 < r3.length ? r3[r4] : (byte) 0;
                byte r3 = r3[r2];
                if (r3 == 13) {
                    if (r5 == 10) {
                        r3 = 2;
                    ...
                    if (r3 == 58 && r5 == 32) {
                        r3 = 5;
                        if (r3 <= 0) {
                            r0 = updateStateListForPair(r0, r2, r3);
                            r2 = r4;
                        } else {
                            r0 = updateStateListForChar(r0, r2);
                        }
                        r2++;
                    }
                    r3 = 0;
                ...
                return ((com.google.zxing.aztec.encoder.State) java.util.Collections.min(r0, new java.util.Comparator<com.google.zxing.aztec.encoder.State>() { // from class: com.google.zxing.aztec.encoder.HighLevelEncoder.1
                    {
                    }

                    @Override // java.util.Comparator
                    public /* bridge */ /* synthetic */ int compare(com.google.zxing.aztec.encoder.State r1, com.google.zxing.aztec.encoder.State r2) {
                        return compare(r1, r2);
                    }

                    @Override // java.util.Comparator
                    public int compare(com.google.zxing.aztec.encoder.State r1, com.google.zxing.aztec.encoder.State r2) {
                        return r1.getBitCount() - r2.getBitCount();
                    }
                })).toBitArray(r8.text);
            }
        }
