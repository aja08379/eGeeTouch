...
public final class Encoder {
    ...
    static void terminateBits(int i, BitArray bitArray) throws WriterException {
        ...
        for (int i4 = 0; i4 < sizeInBytes; i4++) {
            bitArray.appendBits((i4 & 1) == 0 ? BLEService.ReadResponse_scanTagId : 17, 8);
        }
        if (bitArray.getSize() != i2) {
    ...
    */
    static void appendKanjiBytes(java.lang.String r6, com.google.zxing.common.BitArray r7) throws com.google.zxing.WriterException {
        int r2;
        try {
            byte[] r6 = r6.getBytes("Shift_JIS");
            int r0 = r6.length;
            for (int r1 = 0; r1 < r0; r1 += 2) {
                int r2 = ((r6[r1] & kotlin.UByte.MAX_VALUE) << 8) | (r6[r1 + 1] & kotlin.UByte.MAX_VALUE);
                int r3 = 33088;
                if (r2 < 33088 || r2 > 40956) {
                    if (r2 < 57408 || r2 > 60351) {
                        ...
                        r7.appendBits(((r2 >> 8) * 192) + (r2 & 255), 13);
                    } else {
                        r3 = 49472;
                    }
                }
        ...
        } catch (java.io.UnsupportedEncodingException r6) {
            throw new com.google.zxing.WriterException(r6);
        }
    }
