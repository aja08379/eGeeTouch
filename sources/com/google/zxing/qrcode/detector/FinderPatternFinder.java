...
public class FinderPatternFinder {
    ...
    public final FinderPatternInfo find(Map<DecodeHintType, ?> map) throws NotFoundException {
        ...
        int i = (height * 3) / BLEService.Read_response_timestamp;
        if (i < 3 || z) {
            i = 3;
        }
        int[] iArr = new int[5];
    ...
    */
    private boolean crossCheckDiagonal(int r17, int r18, int r19, int r20) {
        int[] r4 = getCrossCheckStateCount();
        int r6 = 0;
        while (r17 >= r6 && r18 >= r6 && r16.image.get(r18 - r6, r17 - r6)) {
            r4[2] = r4[2] + 1;
            r6++;
        }
        return false;
    ...
    */
    private float crossCheckVertical(int r11, int r12, int r13, int r14) {
        ...
        int r1 = r0.getHeight();
        int[] r2 = getCrossCheckStateCount();
        int r3 = r11;
        while (r3 >= 0 && r0.get(r12, r3)) {
            r2[2] = r2[2] + 1;
            r3--;
        }
        if (r3 < 0) {
        ...
        while (r3 >= 0 && !r0.get(r12, r3) && r2[1] <= r13) {
            r2[1] = r2[1] + 1;
            r3--;
        }
        return Float.NaN;
    ...
    */
    private float crossCheckHorizontal(int r11, int r12, int r13, int r14) {
        ...
        while (r3 >= 0 && !r0.get(r3, r12) && r2[1] <= r13) {
            r2[1] = r2[1] + 1;
            r3--;
        }
        return Float.NaN;
