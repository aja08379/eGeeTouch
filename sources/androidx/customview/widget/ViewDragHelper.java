...
public class ViewDragHelper {
    ...
    */
    public boolean shouldInterceptTouchEvent(android.view.MotionEvent r17) {
        ...
        if (r16.mVelocityTracker == null) {
            r16.mVelocityTracker = android.view.VelocityTracker.obtain();
        }
        r16.mVelocityTracker.addMovement(r17);
        if (r2 == 0) {
            float r2 = r17.getX();
            float r3 = r17.getY();
            r5 = false;
            int r1 = r17.getPointerId(0);
            saveInitialMotion(r2, r3, r1);
            android.view.View r2 = findTopChildUnder((int) r2, (int) r3);
            if (r2 == r16.mCapturedView && r16.mDragState == 2) {
                tryCaptureViewForDrag(r2, r1);
            }
            int r2 = r16.mInitialEdgesTouched[r1];
            int r3 = r16.mTrackingEdges;
            if ((r2 & r3) != 0) {
                r16.mCallback.onEdgeTouched(r2 & r3, r1);
            }
        } else {
            if (r2 != 1) {
                if (r2 != 2) {
                    if (r2 != 3) {
                        if (r2 == 5) {
                            int r2 = r17.getPointerId(r3);
                            float r7 = r17.getX(r3);
                            float r1 = r17.getY(r3);
                            saveInitialMotion(r7, r1, r2);
                            int r3 = r16.mDragState;
                            if (r3 == 0) {
                                int r1 = r16.mInitialEdgesTouched[r2];
                                int r3 = r16.mTrackingEdges;
                                if ((r1 & r3) != 0) {
                                    r16.mCallback.onEdgeTouched(r1 & r3, r2);
                                }
                            } else if (r3 == 2 && (r1 = findTopChildUnder((int) r7, (int) r1)) == r16.mCapturedView) {
                                tryCaptureViewForDrag(r1, r2);
                            }
                        } else if (r2 == 6) {
                            clearMotionHistory(r17.getPointerId(r3));
                        }
                    }
                } else if (r16.mInitialMotionX != null && r16.mInitialMotionY != null) {
                    int r2 = r17.getPointerCount();
                    for (int r3 = 0; r3 < r2; r3++) {
                        int r4 = r17.getPointerId(r3);
                        if (isValidPointerForActionMove(r4)) {
                            float r7 = r17.getX(r3);
                            float r8 = r17.getY(r3);
                            float r9 = r7 - r16.mInitialMotionX[r4];
                            float r10 = r8 - r16.mInitialMotionY[r4];
                            android.view.View r7 = findTopChildUnder((int) r7, (int) r8);
                            boolean r8 = r7 != null && checkTouchSlop(r7, r9, r10);
                            if (r8) {
                                int r11 = r7.getLeft();
                                int r12 = (int) r9;
                                int r12 = r16.mCallback.clampViewPositionHorizontal(r7, r11 + r12, r12);
                                int r13 = r7.getTop();
                                int r14 = (int) r10;
                                int r5 = r16.mCallback.clampViewPositionVertical(r7, r13 + r14, r14);
                                int r14 = r16.mCallback.getViewHorizontalDragRange(r7);
                                int r15 = r16.mCallback.getViewVerticalDragRange(r7);
                                if (r14 != 0) {
                                    if (r14 > 0) {
                                    }
                                }
                                if (r15 == 0) {
                                    break;
                                } else if (r15 > 0 && r5 == r13) {
                                    break;
                                }
                            }
                            reportNewEdgeDrags(r9, r10, r4);
                            if (r16.mDragState != 1) {
                                if (r8 && tryCaptureViewForDrag(r7, r4)) {
                                    break;
                                }
                            } else {
                                break;
