                ...
                while (i2 < arrayList3.size()) {
                    ...
                    if (receiverRecord.broadcasting) {
                        ...
                        if (match >= 0) {
                            ...
                            Log.v(TAG, "  Filter did not match: " + (match != -4 ? match != -3 ? match != -2 ? match != -1 ? "unknown reason" : "type" : ShareConstants.WEB_DIALOG_PARAM_DATA : NativeProtocol.WEB_DIALOG_ACTION : "category"));
                        }
                    }
