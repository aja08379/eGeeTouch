...
public class AnimatorInflaterCompat {
    ...
    */
    private static android.animation.Animator createAnimatorFromXml(android.content.Context r18, android.content.res.Resources r19, android.content.res.Resources.Theme r20, org.xmlpull.v1.XmlPullParser r21, android.util.AttributeSet r22, android.animation.AnimatorSet r23, int r24, float r25) throws org.xmlpull.v1.XmlPullParserException, java.io.IOException {
        ...
        android.animation.AnimatorSet r0 = null;
        java.util.ArrayList r13 = null;
        while (true) {
            int r1 = r21.next();
            r14 = 0;
            if ((r1 != 3 || r21.getDepth() > r12) && r1 != 1) {
                if (r1 == 2) {
                    java.lang.String r1 = r21.getName();
                    if (r1.equals("objectAnimator")) {
                        r0 = loadObjectAnimator(r18, r19, r20, r22, r25, r21);
                    } else if (r1.equals("animator")) {
                        r0 = loadAnimator(r18, r19, r20, r22, null, r25, r21);
                    } else {
                        if (r1.equals("set")) {
                            android.animation.AnimatorSet r15 = new android.animation.AnimatorSet();
                            android.content.res.TypedArray r6 = androidx.core.content.res.TypedArrayUtils.obtainAttributes(r19, r20, r22, androidx.vectordrawable.graphics.drawable.AndroidResources.STYLEABLE_ANIMATOR_SET);
                            createAnimatorFromXml(r18, r19, r20, r21, r22, r15, androidx.core.content.res.TypedArrayUtils.getNamedInt(r6, r21, "ordering", 0, 0), r25);
                            r6.recycle();
                            r0 = r15;
                        } else if (r1.equals("propertyValuesHolder")) {
                            android.animation.PropertyValuesHolder[] r1 = loadValues(r18, r19, r20, r21, android.util.Xml.asAttributeSet(r21));
                            if (r1 != null && (r0 instanceof android.animation.ValueAnimator)) {
                                ((android.animation.ValueAnimator) r0).setValues(r1);
                            }
                            r14 = 1;
                        } else {
                            throw new java.lang.RuntimeException("Unknown animator name: " + r21.getName());
                        }
                        if (r23 != null && r14 == 0) {
                            if (r13 == null) {
        ...
        if (r23 != null && r13 != null) {
            android.animation.Animator[] r1 = new android.animation.Animator[r13.size()];
