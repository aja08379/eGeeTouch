...
public class SupportMenuInflater extends MenuInflater {
    ...
    */
    private void parseMenu(org.xmlpull.v1.XmlPullParser r13, android.util.AttributeSet r14, android.view.Menu r15) throws org.xmlpull.v1.XmlPullParserException, java.io.IOException {
        androidx.appcompat.view.SupportMenuInflater.MenuState r0 = new androidx.appcompat.view.SupportMenuInflater.MenuState(r15);
        int r15 = r13.getEventType();
        while (true) {
            if (r15 == 2) {
                java.lang.String r15 = r13.getName();
                if (r15.equals(androidx.appcompat.view.SupportMenuInflater.XML_MENU)) {
                    r15 = r13.next();
                } else {
