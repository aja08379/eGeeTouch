...
public class AppCompatDelegateImpl extends AppCompatDelegate implements MenuBuilder.Callback, LayoutInflater.Factory2 {
    ...
    */
    public void onDestroy() {
        ...
        if (r3.mHost instanceof android.app.Activity) {
            removeActivityDelegate(r3);
        }
        if (r3.mInvalidatePanelMenuPosted) {
            r3.mWindow.getDecorView().removeCallbacks(r3.mInvalidatePanelMenuRunnable);
        }
        r3.mStarted = false;
        r3.mIsDestroyed = true;
        if (r3.mLocalNightMode != -100) {
            java.lang.Object r0 = r3.mHost;
            if ((r0 instanceof android.app.Activity) && ((android.app.Activity) r0).isChangingConfigurations()) {
                androidx.appcompat.app.AppCompatDelegateImpl.sLocalNightModes.put(r3.mHost.getClass().getName(), java.lang.Integer.valueOf(r3.mLocalNightMode));
                r0 = r3.mActionBar;
                if (r0 != null) {
                    r0.onDestroy();
                }
        ...
        androidx.appcompat.app.AppCompatDelegateImpl.sLocalNightModes.remove(r3.mHost.getClass().getName());
        r0 = r3.mActionBar;
        if (r0 != null) {
        }
        cleanupAutoManagers();
    ...
    */
    androidx.appcompat.view.ActionMode startSupportActionModeFromWindow(androidx.appcompat.view.ActionMode.Callback r8) {
        ...
        androidx.appcompat.view.ActionMode r8;
        androidx.appcompat.app.AppCompatCallback r0;
        endOnGoingFadeAnimation();
        androidx.appcompat.view.ActionMode r0 = r7.mActionMode;
        if (r0 != null) {
            r0.finish();
        }
        if (!(r8 instanceof androidx.appcompat.app.AppCompatDelegateImpl.ActionModeCallbackWrapperV9)) {
            r8 = new androidx.appcompat.app.AppCompatDelegateImpl.ActionModeCallbackWrapperV9(r8);
        }
        androidx.appcompat.app.AppCompatCallback r0 = r7.mAppCompatCallback;
        if (r0 != null && !r7.mIsDestroyed) {
            try {
                r0 = r0.onWindowStartingSupportActionMode(r8);
            } catch (java.lang.AbstractMethodError unused) {
            }
            if (r0 == null) {
                r7.mActionMode = r0;
            } else {
                if (r7.mActionModeView == null) {
                    if (r7.mIsFloating) {
                        android.util.TypedValue r0 = new android.util.TypedValue();
                        android.content.res.Resources.Theme r4 = r7.mContext.getTheme();
                        r4.resolveAttribute(androidx.appcompat.R.attr.actionBarTheme, r0, true);
                        if (r0.resourceId != 0) {
                            android.content.res.Resources.Theme r5 = r7.mContext.getResources().newTheme();
                            r5.setTo(r4);
                            r5.applyStyle(r0.resourceId, true);
                            r4 = new androidx.appcompat.view.ContextThemeWrapper(r7.mContext, 0);
                            r4.getTheme().setTo(r5);
                        } else {
                            r4 = r7.mContext;
                        }
                        r7.mActionModeView = new androidx.appcompat.widget.ActionBarContextView(r4);
                        android.widget.PopupWindow r5 = new android.widget.PopupWindow(r4, (android.util.AttributeSet) null, androidx.appcompat.R.attr.actionModePopupWindowStyle);
                        r7.mActionModePopup = r5;
                        androidx.core.widget.PopupWindowCompat.setWindowLayoutType(r5, 2);
                        r7.mActionModePopup.setContentView(r7.mActionModeView);
                        r7.mActionModePopup.setWidth(-1);
                        r4.getTheme().resolveAttribute(androidx.appcompat.R.attr.actionBarSize, r0, true);
                        r7.mActionModeView.setContentHeight(android.util.TypedValue.complexToDimensionPixelSize(r0.data, r4.getResources().getDisplayMetrics()));
                        r7.mActionModePopup.setHeight(-2);
                        r7.mShowActionModePopup = new java.lang.Runnable() { // from class: androidx.appcompat.app.AppCompatDelegateImpl.6
                            {
                            }
                            ...
                            public void run() {
                                ...
                                if (androidx.appcompat.app.AppCompatDelegateImpl.this.shouldAnimateActionModeView()) {
                                    ...
                                    r0.mFadeAnim = androidx.core.view.ViewCompat.animate(r0.mActionModeView).alpha(1.0f);
                        ...
                        androidx.appcompat.widget.ViewStubCompat r0 = (androidx.appcompat.widget.ViewStubCompat) r7.mSubDecor.findViewById(androidx.appcompat.R.id.action_mode_bar_stub);
                        if (r0 != null) {
                            r0.setLayoutInflater(android.view.LayoutInflater.from(getActionBarThemedContext()));
                            r7.mActionModeView = (androidx.appcompat.widget.ActionBarContextView) r0.inflate();
                        }
                    }
                }
                if (r7.mActionModeView != null) {
                    endOnGoingFadeAnimation();
                    r7.mActionModeView.killMode();
                    androidx.appcompat.view.StandaloneActionMode r0 = new androidx.appcompat.view.StandaloneActionMode(r7.mActionModeView.getContext(), r7.mActionModeView, r8, r7.mActionModePopup == null);
                    if (r8.onCreateActionMode(r0, r0.getMenu())) {
                        r0.invalidate();
                        r7.mActionModeView.initForMode(r0);
                        r7.mActionMode = r0;
                        if (shouldAnimateActionModeView()) {
                            r7.mActionModeView.setAlpha(0.0f);
                            androidx.core.view.ViewPropertyAnimatorCompat r8 = androidx.core.view.ViewCompat.animate(r7.mActionModeView).alpha(1.0f);
                            r7.mFadeAnim = r8;
                            r8.setListener(new androidx.core.view.ViewPropertyAnimatorListenerAdapter() { // from class: androidx.appcompat.app.AppCompatDelegateImpl.7
                                {
                                }
                            ...
                            r7.mActionModeView.setAlpha(1.0f);
                            r7.mActionModeView.setVisibility(0);
                            r7.mActionModeView.sendAccessibilityEvent(32);
                            if (r7.mActionModeView.getParent() instanceof android.view.View) {
                                androidx.core.view.ViewCompat.requestApplyInsets((android.view.View) r7.mActionModeView.getParent());
                            }
                        }
                        if (r7.mActionModePopup != null) {
                            r7.mWindow.getDecorView().post(r7.mShowActionModePopup);
                        }
                    } else {
                        r7.mActionMode = null;
                    }
            ...
            r8 = r7.mActionMode;
            if (r8 != null && (r0 = r7.mAppCompatCallback) != null) {
                r0.onSupportActionModeStarted(r8);
            }
            return r7.mActionMode;
        }
        r0 = null;
        if (r0 == null) {
        }
    ...
    */
    public android.view.View createView(android.view.View r12, java.lang.String r13, android.content.Context r14, android.util.AttributeSet r15) {
        boolean r7;
        boolean r1 = false;
        if (r11.mAppCompatViewInflater == null) {
            java.lang.String r0 = r11.mContext.obtainStyledAttributes(androidx.appcompat.R.styleable.AppCompatTheme).getString(androidx.appcompat.R.styleable.AppCompatTheme_viewInflaterClass);
            if (r0 == null) {
                r11.mAppCompatViewInflater = new androidx.appcompat.app.AppCompatViewInflater();
            } else {
                try {
                    r11.mAppCompatViewInflater = (androidx.appcompat.app.AppCompatViewInflater) java.lang.Class.forName(r0).getDeclaredConstructor(new java.lang.Class[0]).newInstance(new java.lang.Object[0]);
                } catch (java.lang.Throwable r2) {
                    android.util.Log.i("AppCompatDelegate", "Failed to instantiate custom view inflater " + r0 + ". Falling back to default.", r2);
                    r11.mAppCompatViewInflater = new androidx.appcompat.app.AppCompatViewInflater();
                }
            }
        }
        ...
        boolean r0 = true;
        if (r8) {
            if (r11.mLayoutIncludeDetector == null) {
                r11.mLayoutIncludeDetector = new androidx.appcompat.app.LayoutIncludeDetector();
            }
            if (!r11.mLayoutIncludeDetector.detect(r15)) {
                if (!(r15 instanceof org.xmlpull.v1.XmlPullParser)) {
                    r0 = shouldInheritContext((android.view.ViewParent) r12);
                }
                r1 = r0;
            } else {
                r7 = true;
                return r11.mAppCompatViewInflater.createView(r12, r13, r14, r15, r7, r8, true, androidx.appcompat.widget.VectorEnabledTintResources.shouldBeUsed());
            }
        }
        r7 = r1;
        return r11.mAppCompatViewInflater.createView(r12, r13, r14, r15, r7, r8, true, androidx.appcompat.widget.VectorEnabledTintResources.shouldBeUsed());
    ...
    */
    private boolean updateForNightMode(int r7, boolean r8) {
        boolean r8;
        android.content.res.Configuration r0 = createOverrideConfigurationForDayNight(r6.mContext, r7, null);
        boolean r2 = isActivityManifestHandlingUiMode();
        int r3 = r6.mContext.getResources().getConfiguration().uiMode & 48;
        int r0 = r0.uiMode & 48;
        boolean r4 = true;
        if (r3 != r0 && r8 && !r2 && r6.mBaseContextAttached && (androidx.appcompat.app.AppCompatDelegateImpl.sCanReturnDifferentContext || r6.mCreated)) {
            java.lang.Object r8 = r6.mHost;
            if ((r8 instanceof android.app.Activity) && !((android.app.Activity) r8).isChild()) {
                androidx.core.app.ActivityCompat.recreate((android.app.Activity) r6.mHost);
                r8 = true;
                if (!r8 || r3 == r0) {
                    r4 = r8;
                } else {
                    updateResourcesConfigurationForNightMode(r0, r2, null);
                }
                if (r4) {
                    java.lang.Object r8 = r6.mHost;
                    if (r8 instanceof androidx.appcompat.app.AppCompatActivity) {
                        ((androidx.appcompat.app.AppCompatActivity) r8).onNightModeChanged(r7);
                    }
                }
                return r4;
            }
