...
public class Toolbar extends ViewGroup {
    ...
    */
    public void onLayout(boolean r20, int r21, int r22, int r23, int r24) {
        ...
        int r6;
        int r3;
        boolean r1 = androidx.core.view.ViewCompat.getLayoutDirection(r19) == 1;
        int r4 = getWidth();
        int r5 = getHeight();
        ...
        int r10 = r4 - r7;
        int[] r11 = r19.mTempMargins;
        r11[1] = 0;
        r11[0] = 0;
        int r12 = androidx.core.view.ViewCompat.getMinimumHeight(r19);
        int r12 = r12 >= 0 ? java.lang.Math.min(r12, r24 - r22) : 0;
        if (!shouldLayout(r19.mNavButtonView)) {
            r13 = r6;
        } else if (r1) {
            r14 = layoutChildRight(r19.mNavButtonView, r10, r11, r12);
            r13 = r6;
            if (shouldLayout(r19.mCollapseButtonView)) {
                if (r1) {
                    r14 = layoutChildRight(r19.mCollapseButtonView, r14, r11, r12);
                } else {
                    r13 = layoutChildLeft(r19.mCollapseButtonView, r13, r11, r12);
                }
            }
            if (shouldLayout(r19.mMenuView)) {
                if (r1) {
                    r13 = layoutChildLeft(r19.mMenuView, r13, r11, r12);
                } else {
                    r14 = layoutChildRight(r19.mMenuView, r14, r11, r12);
                }
            }
            int r15 = getCurrentContentInsetLeft();
            int r16 = getCurrentContentInsetRight();
            r11[0] = java.lang.Math.max(0, r15 - r13);
            r11[1] = java.lang.Math.max(0, r16 - (r10 - r14));
            int r2 = java.lang.Math.max(r13, r15);
            int r10 = java.lang.Math.min(r14, r10 - r16);
            if (shouldLayout(r19.mExpandedActionView)) {
                if (r1) {
                    r10 = layoutChildRight(r19.mExpandedActionView, r10, r11, r12);
                } else {
                    r2 = layoutChildLeft(r19.mExpandedActionView, r2, r11, r12);
                }
            }
            if (shouldLayout(r19.mLogoView)) {
                if (r1) {
                    r10 = layoutChildRight(r19.mLogoView, r10, r11, r12);
                } else {
                    r2 = layoutChildLeft(r19.mLogoView, r2, r11, r12);
                }
            }
            r13 = shouldLayout(r19.mTitleTextView);
            r14 = shouldLayout(r19.mSubtitleTextView);
            if (r13) {
                r23 = r7;
                r3 = 0;
            } else {
                androidx.appcompat.widget.Toolbar.LayoutParams r15 = (androidx.appcompat.widget.Toolbar.LayoutParams) r19.mTitleTextView.getLayoutParams();
                r23 = r7;
                r3 = r15.topMargin + r19.mTitleTextView.getMeasuredHeight() + r15.bottomMargin + 0;
            }
            if (r14) {
                r16 = r4;
            } else {
                androidx.appcompat.widget.Toolbar.LayoutParams r7 = (androidx.appcompat.widget.Toolbar.LayoutParams) r19.mSubtitleTextView.getLayoutParams();
                r16 = r4;
                r3 += r7.topMargin + r19.mSubtitleTextView.getMeasuredHeight() + r7.bottomMargin;
            }
            if (!r13 || r14) {
                android.widget.TextView r4 = !r13 ? r19.mTitleTextView : r19.mSubtitleTextView;
                android.widget.TextView r7 = !r14 ? r19.mSubtitleTextView : r19.mTitleTextView;
                androidx.appcompat.widget.Toolbar.LayoutParams r4 = (androidx.appcompat.widget.Toolbar.LayoutParams) r4.getLayoutParams();
                androidx.appcompat.widget.Toolbar.LayoutParams r7 = (androidx.appcompat.widget.Toolbar.LayoutParams) r7.getLayoutParams();
                boolean r17 = (!r13 && r19.mTitleTextView.getMeasuredWidth() > 0) || (r14 && r19.mSubtitleTextView.getMeasuredWidth() > 0);
                r15 = r19.mGravity & 112;
                r18 = r6;
                if (r15 != 48) {
                    r22 = r12;
                    r8 = getPaddingTop() + r4.topMargin + r19.mTitleMarginTop;
                } else if (r15 != 80) {
                    int r6 = (((r5 - r8) - r9) - r3) / 2;
                    r22 = r12;
                    if (r6 < r4.topMargin + r19.mTitleMarginTop) {
                        r6 = r4.topMargin + r19.mTitleMarginTop;
                    } else {
                        int r5 = (((r5 - r9) - r3) - r6) - r8;
                        if (r5 < r4.bottomMargin + r19.mTitleMarginBottom) {
                            r6 = java.lang.Math.max(0, r6 - ((r7.bottomMargin + r19.mTitleMarginBottom) - r5));
                        }
                    }
                    r8 = r8 + r6;
                } else {
                    r22 = r12;
                    r8 = (((r5 - r9) - r7.bottomMargin) - r19.mTitleMarginBottom) - r3;
                }
                if (!r1) {
                    int r1 = (r17 ? r19.mTitleMarginStart : 0) - r11[1];
                    r10 -= java.lang.Math.max(0, r1);
                    r11[1] = java.lang.Math.max(0, -r1);
                    if (r13) {
                        int r3 = r10 - r19.mTitleTextView.getMeasuredWidth();
                        int r4 = r19.mTitleTextView.getMeasuredHeight() + r8;
                        r19.mTitleTextView.layout(r3, r8, r10, r4);
                        r3 = r3 - r19.mTitleMarginEnd;
                        r8 = r4 + ((androidx.appcompat.widget.Toolbar.LayoutParams) r19.mTitleTextView.getLayoutParams()).bottomMargin;
                    } else {
                        r3 = r10;
                    }
                    if (r14) {
                        androidx.appcompat.widget.Toolbar.LayoutParams r1 = (androidx.appcompat.widget.Toolbar.LayoutParams) r19.mSubtitleTextView.getLayoutParams();
                        int r8 = r8 + r1.topMargin;
                        r19.mSubtitleTextView.layout(r10 - r19.mSubtitleTextView.getMeasuredWidth(), r8, r10, r19.mSubtitleTextView.getMeasuredHeight() + r8);
                        r4 = r10 - r19.mTitleMarginEnd;
                    ...
                    int r7 = r7 - r11[r1];
                    r2 += java.lang.Math.max(r1, r7);
                    r11[r1] = java.lang.Math.max(r1, -r7);
                    if (r13) {
                        int r4 = r19.mTitleTextView.getMeasuredWidth() + r2;
                        int r5 = r19.mTitleTextView.getMeasuredHeight() + r8;
                        r19.mTitleTextView.layout(r2, r8, r4, r5);
                        r4 = r4 + r19.mTitleMarginEnd;
                        r8 = r5 + ((androidx.appcompat.widget.Toolbar.LayoutParams) r19.mTitleTextView.getLayoutParams()).bottomMargin;
                    } else {
                        r4 = r2;
                    }
                    if (r14) {
                        androidx.appcompat.widget.Toolbar.LayoutParams r3 = (androidx.appcompat.widget.Toolbar.LayoutParams) r19.mSubtitleTextView.getLayoutParams();
                        int r8 = r8 + r3.topMargin;
                        int r5 = r19.mSubtitleTextView.getMeasuredWidth() + r2;
                        r19.mSubtitleTextView.layout(r2, r8, r5, r19.mSubtitleTextView.getMeasuredHeight() + r8);
                        r5 = r5 + r19.mTitleMarginEnd;
                        int r3 = r3.bottomMargin;
                    } else {
                        r5 = r2;
                    }
                    if (r17) {
                        r2 = java.lang.Math.max(r4, r5);
                    }
                    addCustomViewsWithGravity(r19.mTempViews, 3);
                    r3 = r19.mTempViews.size();
                    for (r7 = r1; r7 < r3; r7++) {
                        r2 = layoutChildLeft(r19.mTempViews.get(r7), r2, r11, r22);
                    }
                    int r12 = r22;
                    addCustomViewsWithGravity(r19.mTempViews, 5);
                    r3 = r19.mTempViews.size();
                    for (r7 = r1; r7 < r3; r7++) {
                        r10 = layoutChildRight(r19.mTempViews.get(r7), r10, r11, r12);
                    }
                    addCustomViewsWithGravity(r19.mTempViews, 1);
                    int r3 = getViewListMeasuredWidth(r19.mTempViews, r11);
                    r6 = (r18 + (((r16 - r18) - r23) / 2)) - (r3 / 2);
                    int r3 = r3 + r6;
                    if (r6 >= r2) {
                        r2 = r3 > r10 ? r6 - (r3 - r10) : r6;
                    }
                    r3 = r19.mTempViews.size();
                    while (r1 < r3) {
                        r2 = layoutChildLeft(r19.mTempViews.get(r1), r2, r11, r12);
                        r1++;
                    }
                    r19.mTempViews.clear();
                    return;
                }
            } else {
                r18 = r6;
            ...
            r13 = layoutChildLeft(r19.mNavButtonView, r6, r11, r12);
        }
        r14 = r10;
        if (shouldLayout(r19.mCollapseButtonView)) {
        }
