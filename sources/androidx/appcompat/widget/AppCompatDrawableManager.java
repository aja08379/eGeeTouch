                ...
                INSTANCE.mResourceManager.setHooks(new ResourceManagerInternal.ResourceManagerHooks() { // from class: androidx.appcompat.widget.AppCompatDrawableManager.1
                    ...
                    */
                    public boolean tintDrawableUsingColorFilter(android.content.Context r7, int r8, android.graphics.drawable.Drawable r9) {
                        ...
                        int r2 = 16842801;
                        if (arrayContains(r6.COLORFILTER_TINT_COLOR_CONTROL_NORMAL, r8)) {
                            r2 = androidx.appcompat.R.attr.colorControlNormal;
                        } else if (arrayContains(r6.COLORFILTER_COLOR_CONTROL_ACTIVATED, r8)) {
                            r2 = androidx.appcompat.R.attr.colorControlActivated;
                        } else if (arrayContains(r6.COLORFILTER_COLOR_BACKGROUND_MULTIPLY, r8)) {
                            r0 = android.graphics.PorterDuff.Mode.MULTIPLY;
                        } else if (r8 == androidx.appcompat.R.drawable.abc_list_divider_mtrl_alpha) {
                            r2 = 16842800;
                            r8 = java.lang.Math.round(40.8f);
                            r1 = true;
                            if (r1) {
                                if (androidx.appcompat.widget.DrawableUtils.canSafelyMutateDrawable(r9)) {
                                    r9 = r9.mutate();
                                }
                                r9.setColorFilter(androidx.appcompat.widget.AppCompatDrawableManager.getPorterDuffColorFilter(androidx.appcompat.widget.ThemeUtils.getThemeAttrColor(r7, r2), r0));
                                if (r8 != -1) {
                                    r9.setAlpha(r8);
                                }
                                return true;
                            ...
                            return false;
                        } else if (r8 != androidx.appcompat.R.drawable.abc_dialog_material_background) {
                            r8 = -1;
                            r1 = false;
                            r2 = 0;
                            if (r1) {
