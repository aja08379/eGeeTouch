...
public class DropDownListView extends ListView {
    ...
    */
    public boolean onForwardedEvent(android.view.MotionEvent r8, int r9) {
        ...
        if (r9 >= 0) {
            int r4 = (int) r8.getX(r9);
            int r9 = (int) r8.getY(r9);
            int r5 = pointToPosition(r4, r9);
            if (r5 != -1) {
                android.view.View r3 = getChildAt(r5 - getFirstVisiblePosition());
                setPressedItem(r3, r5, r4, r9);
                if (r0 == 1) {
                    clickPressedItem(r3, r5);
                }
                r9 = false;
                r3 = true;
                if (r3) {
            ...
            if (r3) {
                if (r7.mScrollHelper == null) {
                    r7.mScrollHelper = new androidx.core.widget.ListViewAutoScrollHelper(r7);
                }
                r7.mScrollHelper.setEnabled(true);
                r7.mScrollHelper.onTouch(r7, r8);
            } else {
