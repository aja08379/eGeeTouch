    ...
    public final class PersistHistoryAsyncTask extends AsyncTask<Object, Void, Void> {
        ...
        */
        public java.lang.Void doInBackground(java.lang.Object... r15) {
            java.util.List r4 = (java.util.List) r15[0];
            java.lang.String r15 = (java.lang.String) r15[1];
            try {
                java.io.FileOutputStream r15 = androidx.appcompat.widget.ActivityChooserModel.this.mContext.openFileOutput(r15, 0);
                org.xmlpull.v1.XmlSerializer r7 = android.util.Xml.newSerializer();
                try {
                    try {
                        try {
                            try {
                                r7.setOutput(r15, null);
                                r7.startDocument("UTF-8", true);
                                r7.startTag(null, androidx.appcompat.widget.ActivityChooserModel.TAG_HISTORICAL_RECORDS);
                                int r8 = r4.size();
                                for (int r9 = 0; r9 < r8; r9++) {
                                    androidx.appcompat.widget.ActivityChooserModel.HistoricalRecord r10 = (androidx.appcompat.widget.ActivityChooserModel.HistoricalRecord) r4.remove(0);
                                    r7.startTag(null, androidx.appcompat.widget.ActivityChooserModel.TAG_HISTORICAL_RECORD);
                                    r7.attribute(null, androidx.appcompat.widget.ActivityChooserModel.ATTRIBUTE_ACTIVITY, r10.activity.flattenToString());
                                    r7.attribute(null, androidx.appcompat.widget.ActivityChooserModel.ATTRIBUTE_TIME, java.lang.String.valueOf(r10.time));
                                    r7.attribute(null, androidx.appcompat.widget.ActivityChooserModel.ATTRIBUTE_WEIGHT, java.lang.String.valueOf(r10.weight));
                                    r7.endTag(null, androidx.appcompat.widget.ActivityChooserModel.TAG_HISTORICAL_RECORD);
                                }
                                r7.endTag(null, androidx.appcompat.widget.ActivityChooserModel.TAG_HISTORICAL_RECORDS);
                                r7.endDocument();
                            ...
                            android.util.Log.e(androidx.appcompat.widget.ActivityChooserModel.LOG_TAG, "Error writing historical record file: " + androidx.appcompat.widget.ActivityChooserModel.this.mHistoryFileName, r0);
                            androidx.appcompat.widget.ActivityChooserModel.this.mCanReadHistoricalData = true;
                        }
                ...
                } catch (java.lang.IllegalStateException r0) {
                    android.util.Log.e(androidx.appcompat.widget.ActivityChooserModel.LOG_TAG, "Error writing historical record file: " + androidx.appcompat.widget.ActivityChooserModel.this.mHistoryFileName, r0);
                    androidx.appcompat.widget.ActivityChooserModel.this.mCanReadHistoricalData = true;
                }
            } catch (java.io.FileNotFoundException r0) {
                android.util.Log.e(androidx.appcompat.widget.ActivityChooserModel.LOG_TAG, "Error writing historical record file: " + r15, r0);
                return null;
            }
        }
    }
