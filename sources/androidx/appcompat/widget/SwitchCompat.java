...
public class SwitchCompat extends CompoundButton {
    ...
    */
    public boolean onTouchEvent(android.view.MotionEvent r7) {
        r6.mVelocityTracker.addMovement(r7);
        int r0 = r7.getActionMasked();
        if (r0 == 0) {
            float r0 = r7.getX();
            float r2 = r7.getY();
            if (isEnabled() && hitThumb(r0, r2)) {
                r6.mTouchMode = 1;
                r6.mTouchX = r0;
                r6.mTouchY = r2;
            }
            ...
            if (r0 != 1) {
                if (r0 == 2) {
                    ...
                    if (r0 == 1) {
                        float r0 = r7.getX();
                        float r3 = r7.getY();
                        if (java.lang.Math.abs(r0 - r6.mTouchX) > r6.mTouchSlop || java.lang.Math.abs(r3 - r6.mTouchY) > r6.mTouchSlop) {
                            r6.mTouchMode = 2;
                        ...
                        float r7 = r7.getX();
                        int r0 = getThumbScrollRange();
                        float r2 = r7 - r6.mTouchX;
                        float r2 = r0 != 0 ? r2 / r0 : r2 > 0.0f ? 1.0f : -1.0f;
                        if (androidx.appcompat.widget.ViewUtils.isLayoutRtl(r6)) {
                            r2 = -r2;
                        }
                        float r0 = constrain(r6.mThumbPosition + r2, 0.0f, 1.0f);
                        if (r0 != r6.mThumbPosition) {
                            r6.mTouchX = r7;
                            setThumbPosition(r0);
                        }
                        return true;
