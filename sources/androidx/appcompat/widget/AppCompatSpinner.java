...
public class AppCompatSpinner extends Spinner implements TintableBackgroundView {
    ...
    */
    public AppCompatSpinner(android.content.Context r7, android.util.AttributeSet r8, int r9, int r10, android.content.res.Resources.Theme r11) {
        ...
        r6.mTempRect = new android.graphics.Rect();
        androidx.appcompat.widget.ThemeUtils.checkAppCompatTheme(r6, getContext());
        androidx.appcompat.widget.TintTypedArray r0 = androidx.appcompat.widget.TintTypedArray.obtainStyledAttributes(r7, r8, androidx.appcompat.R.styleable.Spinner, r9, 0);
        r6.mBackgroundTintHelper = new androidx.appcompat.widget.AppCompatBackgroundHelper(r6);
        if (r11 != null) {
            r6.mPopupContext = new androidx.appcompat.view.ContextThemeWrapper(r7, r11);
        } else {
            int r11 = r0.getResourceId(androidx.appcompat.R.styleable.Spinner_popupTheme, 0);
            if (r11 != 0) {
                r6.mPopupContext = new androidx.appcompat.view.ContextThemeWrapper(r7, r11);
            } else {
                r6.mPopupContext = r7;
        ...
        android.content.res.TypedArray r2 = null;
        try {
            if (r10 == -1) {
                try {
                    r11 = r7.obtainStyledAttributes(r8, androidx.appcompat.widget.AppCompatSpinner.ATTRS_ANDROID_SPINNERMODE, r9, 0);
                    try {
                        r10 = r11.hasValue(0) ? r11.getInt(0, 0) : r10;
                    } catch (java.lang.Exception e) {
                        r3 = e;
                        android.util.Log.i(androidx.appcompat.widget.AppCompatSpinner.TAG, "Could not read android:spinnerMode", r3);
                    }
                } catch (java.lang.Exception e) {
                    r3 = e;
                    r11 = null;
            ...
            if (r10 == 0) {
                ...
                r6.mPopup = r10;
                r10.setPromptText(r0.getString(androidx.appcompat.R.styleable.Spinner_android_prompt));
            } else if (r10 == 1) {
                final androidx.appcompat.widget.AppCompatSpinner.DropdownPopup r10 = new androidx.appcompat.widget.AppCompatSpinner.DropdownPopup(r6.mPopupContext, r8, r9);
                androidx.appcompat.widget.TintTypedArray r1 = androidx.appcompat.widget.TintTypedArray.obtainStyledAttributes(r6.mPopupContext, r8, androidx.appcompat.R.styleable.Spinner, r9, 0);
                r6.mDropDownWidth = r1.getLayoutDimension(androidx.appcompat.R.styleable.Spinner_android_dropDownWidth, -2);
                r10.setBackgroundDrawable(r1.getDrawable(androidx.appcompat.R.styleable.Spinner_android_popupBackground));
                r10.setPromptText(r0.getString(androidx.appcompat.R.styleable.Spinner_android_prompt));
                r1.recycle();
                r6.mPopup = r10;
                r6.mForwardingListener = new androidx.appcompat.widget.ForwardingListener(r6) { // from class: androidx.appcompat.widget.AppCompatSpinner.1
                    {
                    }
            ...
            java.lang.CharSequence[] r10 = r0.getTextArray(androidx.appcompat.R.styleable.Spinner_android_entries);
            if (r10 != null) {
                android.widget.ArrayAdapter r1 = new android.widget.ArrayAdapter(r7, 17367048, r10);
            ...
            if (r7 != null) {
                setAdapter(r7);
                r6.mTempAdapter = null;
            }
            r6.mBackgroundTintHelper.loadFromAttributes(r8, r9);
        } catch (java.lang.Throwable th) {
            r7 = th;
            r2 = -1;
        }
