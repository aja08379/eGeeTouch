    ...
    */
    private boolean onTouchObserved(android.view.MotionEvent r6) {
        ...
        if (r0.isEnabled()) {
            ...
            if (r1 == 0) {
                r5.mActivePointerId = r6.getPointerId(0);
                if (r5.mDisallowIntercept == null) {
                    r5.mDisallowIntercept = new androidx.appcompat.widget.ForwardingListener.DisallowIntercept();
                }
                r0.postDelayed(r5.mDisallowIntercept, r5.mTapTimeout);
                if (r5.mTriggerLongPress == null) {
                    r5.mTriggerLongPress = new androidx.appcompat.widget.ForwardingListener.TriggerLongPress();
                }
                r0.postDelayed(r5.mTriggerLongPress, r5.mLongPressTimeout);
            } else {
                if (r1 != 1) {
                    if (r1 == 2) {
                        int r1 = r6.findPointerIndex(r5.mActivePointerId);
                        if (r1 >= 0 && !pointInView(r0, r6.getX(r1), r6.getY(r1), r5.mScaledTouchSlop)) {
                            clearCallbacks();
