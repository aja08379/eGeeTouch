    ...
    */
    void animate(boolean r14) {
        ...
        if (r3 != null) {
            ...
            if (r9 != 0) {
                if (r9 <= r1) {
                    r3.setAlpha(r13.mAlpha);
                    r13.mEnterAnimationEnd = 0L;
                } else {
                    r13.mCurrDrawable.setAlpha(((255 - (((int) ((r9 - r1) * 255)) / r13.mDrawableContainerState.mEnterFadeDuration)) * r13.mAlpha) / 255);
                    r3 = true;
                    ...
                    if (r9 == null) {
                        ...
                        if (r10 != 0) {
                            if (r10 <= r1) {
                                r9.setVisible(false, false);
                                r13.mLastDrawable = null;
                                r13.mExitAnimationEnd = 0L;
                            } else {
                                r13.mLastDrawable.setAlpha(((((int) ((r10 - r1) * 255)) / r13.mDrawableContainerState.mExitFadeDuration) * r13.mAlpha) / 255);
                                if (r14 && r0) {
                                    scheduleSelf(r13.mAnimationRunnable, r1 + 16);
                                    return;
                                }
                                return;
                            }
    ...
    static int resolveDensity(Resources resources, int i) {
        ...
        return i == 0 ? BLEService.check_version : i;
    }
