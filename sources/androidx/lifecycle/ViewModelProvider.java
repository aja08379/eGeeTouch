...
public class ViewModelProvider {
    ...
    */
    public ViewModelProvider(androidx.lifecycle.ViewModelStoreOwner r3) {
        ...
        if (r3 instanceof androidx.lifecycle.HasDefaultViewModelProviderFactory) {
            r3 = ((androidx.lifecycle.HasDefaultViewModelProviderFactory) r3).getDefaultViewModelProviderFactory();
        } else {
            r3 = androidx.lifecycle.ViewModelProvider.NewInstanceFactory.getInstance();
        }
    }
