...
public class FragmentTransition {
    ...
    */
    private static void addToFirstInLastOut(androidx.fragment.app.BackStackRecord r8, androidx.fragment.app.FragmentTransaction.Op r9, android.util.SparseArray<androidx.fragment.app.FragmentTransition.FragmentContainerTransition> r10, boolean r11, boolean r12) {
        ...
        boolean r4;
        boolean r9;
        androidx.fragment.app.FragmentTransition.FragmentContainerTransition r5;
        androidx.fragment.app.Fragment r0 = r9.mFragment;
        if (r0 == null || (r1 = r0.mContainerId) == 0) {
            return;
        }
        int r9 = r11 ? androidx.fragment.app.FragmentTransition.INVERSE_OPS[r9.mCmd] : r9.mCmd;
        boolean r2 = false;
        boolean r3 = true;
        if (r9 != 1) {
            if (r9 != 3) {
                if (r9 == 4) {
                    boolean r9 = !r12 ? false : false;
                    r4 = r9;
                    r9 = true;
                    r3 = false;
                    r5 = r10.get(r1);
                    ...
                    if (r9 != 6) {
                        if (r9 != 7) {
                            ...
                            r5 = r10.get(r1);
                            if (r2) {
                                r5 = ensureContainer(r5, r10, r1);
                                r5.lastIn = r0;
                                r5.lastInIsPop = r11;
                                r5.lastInTransaction = r8;
                            }
                            if (!r12 && r3) {
                                if (r5 != null && r5.firstOut == r0) {
                                    r5.firstOut = null;
                                }
                                if (!r8.mReorderingAllowed) {
                                    androidx.fragment.app.FragmentManager r3 = r8.mManager;
                                    r3.getFragmentStore().makeActive(r3.createOrGetFragmentStateManager(r0));
                                    r3.moveToState(r0);
                                }
                            }
                            if (r4 && (r5 == null || r5.firstOut == null)) {
                                r5 = ensureContainer(r5, r10, r1);
                                r5.firstOut = r0;
                                r5.firstOutIsPop = r11;
                                r5.firstOutTransaction = r8;
                            }
                            if (r12 || !r9 || r5 == null || r5.lastIn != r0) {
                                return;
                            }
                            r5.lastIn = null;
                            return;
