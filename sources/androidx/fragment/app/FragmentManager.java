...
public abstract class FragmentManager implements FragmentResultOwner {
    ...
    */
    void moveToState(androidx.fragment.app.Fragment r11, int r12) {
        androidx.fragment.app.FragmentStateManager r0 = r10.mFragmentStore.getFragmentStateManager(r11.mWho);
        int r1 = 1;
        if (r0 == null) {
            r0 = new androidx.fragment.app.FragmentStateManager(r10.mLifecycleCallbacksDispatcher, r10.mFragmentStore, r11);
            r0.setFragmentManagerState(1);
        }
        if (r11.mFromLayout && r11.mInLayout && r11.mState == 2) {
            r12 = java.lang.Math.max(r12, 2);
        }
        int r12 = java.lang.Math.min(r12, r0.computeExpectedState());
        if (r11.mState <= r12) {
            if (r11.mState < r12 && !r10.mExitAnimationCancellationSignals.isEmpty()) {
                cancelExitAnimation(r11);
            }
            int r2 = r11.mState;
            if (r2 != -1) {
                if (r2 != 0) {
                    ...
                    if (r2 != 2) {
                        ...
                        if (r12 < 4) {
                            if (isLoggingEnabled(3)) {
                                android.util.Log.d(androidx.fragment.app.FragmentManager.TAG, "movefrom ACTIVITY_CREATED: " + r11);
                            }
                            if (r11.mView != null && r10.mHost.onShouldSaveFragmentState(r11) && r11.mSavedViewState == null) {
                                r0.saveViewState();
                            }
                        }
                    }
                    if (r12 < 2) {
                        androidx.fragment.app.FragmentAnim.AnimationOrAnimator r2 = null;
                        if (r11.mView != null && r11.mContainer != null) {
                            r11.mContainer.endViewTransition(r11.mView);
                            r11.mView.clearAnimation();
                            if (!r11.isRemovingParent()) {
                                if (r10.mCurState > -1 && !r10.mDestroyed && r11.mView.getVisibility() == 0 && r11.mPostponedAlpha >= 0.0f) {
                                ...
                                if (isLoggingEnabled(2)) {
                                    android.util.Log.v(androidx.fragment.app.FragmentManager.TAG, "Removing view " + r7 + " for fragment " + r11 + " from container " + r6);
                                }
                                if (r6 != r11.mContainer) {
                                    return;
                                }
                            }
                        }
                        if (r10.mExitAnimationCancellationSignals.get(r11) == null) {
        ...
        if (r11.mState != r12) {
            if (isLoggingEnabled(3)) {
                android.util.Log.d(androidx.fragment.app.FragmentManager.TAG, "moveToState: Fragment state for " + r11 + " not updated inline; expected state " + r12 + " found " + r11.mState);
            }
            r11.mState = r12;
        }
    }
    ...
    */
    private void executeOpsTogether(java.util.ArrayList<androidx.fragment.app.BackStackRecord> r18, java.util.ArrayList<java.lang.Boolean> r19, int r20, int r21) {
        ...
        int r13;
        int r12;
        java.util.ArrayList<java.lang.Boolean> r11;
        int r0;
        java.util.ArrayList<java.lang.Boolean> r3;
        int r0;
        boolean r1;
        int r1;
        boolean r2 = r18.get(r20).mReorderingAllowed;
        java.util.ArrayList<androidx.fragment.app.Fragment> r0 = r17.mTmpAddedFragments;
        if (r0 == null) {
            r17.mTmpAddedFragments = new java.util.ArrayList<>();
        } else {
            r0.clear();
        }
        r17.mTmpAddedFragments.addAll(r17.mFragmentStore.getFragments());
        androidx.fragment.app.Fragment r0 = getPrimaryNavigationFragment();
        boolean r16 = false;
        for (int r7 = r20; r7 < r21; r7++) {
            androidx.fragment.app.BackStackRecord r8 = r18.get(r7);
            if (!r19.get(r7).booleanValue()) {
                r0 = r8.expandOps(r17.mTmpAddedFragments, r0);
            } else {
                r0 = r8.trackAddedFragmentsInPop(r17.mTmpAddedFragments, r0);
            }
            r16 = r16 || r8.mAddToBackStack;
        }
        r17.mTmpAddedFragments.clear();
        if (!r2 && r17.mCurState >= 1) {
            if (!androidx.fragment.app.FragmentManager.USE_STATE_MANAGER) {
                r1 = 1;
                androidx.fragment.app.FragmentTransition.startTransitions(r17.mHost.getContext(), r17.mContainer, r18, r19, r20, r21, false, r17.mFragmentTransitionCallback);
                executeOps(r18, r19, r20, r21);
                if (androidx.fragment.app.FragmentManager.USE_STATE_MANAGER) {
                    if (r2) {
                        androidx.collection.ArraySet r7 = new androidx.collection.ArraySet();
                        addAddedFragments(r7);
                        r14 = r1;
                        r8 = r2;
                        r13 = r21;
                        r12 = r20;
                        r11 = r19;
                        r0 = postponePostponableTransactions(r18, r19, r20, r21, r7);
                        makeRemovedFragmentsInvisible(r7);
                    } else {
                        r14 = r1;
                        r8 = r2;
                        r13 = r21;
                    ...
                    if (r0 == r12 || !r8) {
                        ...
                        if (r17.mCurState >= r14) {
                            r3 = r11;
                            int r12 = r0;
                            r0 = r13;
                            r1 = r14;
                            androidx.fragment.app.FragmentTransition.startTransitions(r17.mHost.getContext(), r17.mContainer, r18, r19, r20, r12, true, r17.mFragmentTransitionCallback);
                        } else {
                            r3 = r11;
                            r0 = r13;
                            r1 = r14;
                        }
                        moveToState(r17.mCurState, r1);
                    }
                } else {
                    boolean r0 = r19.get(r21 - 1).booleanValue();
                    for (int r2 = r20; r2 < r21; r2++) {
                        androidx.fragment.app.BackStackRecord r7 = r18.get(r2);
                        if (r0) {
                            for (int r8 = r7.mOps.size() - r1; r8 >= 0; r8--) {
                                androidx.fragment.app.Fragment r9 = r7.mOps.get(r8).mFragment;
                                if (r9 != null) {
                                    createOrGetFragmentStateManager(r9).moveToExpectedState();
                                }
                            }
                        } else {
                            java.util.Iterator<androidx.fragment.app.FragmentTransaction.Op> r7 = r7.mOps.iterator();
                            while (r7.hasNext()) {
                                androidx.fragment.app.Fragment r8 = r7.next().mFragment;
                                if (r8 != null) {
                                    createOrGetFragmentStateManager(r8).moveToExpectedState();
                                }
                            }
                        }
                    }
                    moveToState(r17.mCurState, (boolean) r1);
                    for (androidx.fragment.app.SpecialEffectsController r2 : collectChangedControllers(r18, r20, r21)) {
                ...
                for (r1 = r20; r1 < r0; r1++) {
                    androidx.fragment.app.BackStackRecord r2 = r18.get(r1);
                    if (r3.get(r1).booleanValue() && r2.mIndex >= 0) {
                        r2.mIndex = -1;
                    }
            ...
            for (int r0 = r20; r0 < r21; r0++) {
                java.util.Iterator<androidx.fragment.app.FragmentTransaction.Op> r1 = r18.get(r0).mOps.iterator();
                while (r1.hasNext()) {
                    androidx.fragment.app.Fragment r7 = r1.next().mFragment;
                    if (r7 != null && r7.mFragmentManager != null) {
                        r17.mFragmentStore.makeActive(createOrGetFragmentStateManager(r7));
                    }
                }
            }
        }
