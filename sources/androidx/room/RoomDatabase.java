    ...
    public static class MigrationContainer {
        ...
        */
        private java.util.List<androidx.room.migration.Migration> findUpMigrationPath(java.util.List<androidx.room.migration.Migration> r7, boolean r8, int r9, int r10) {
            java.util.TreeMap<java.lang.Integer, androidx.room.migration.Migration> r0;
            java.util.Set<java.lang.Integer> r2;
            boolean r4;
            do {
                if (r8) {
                    if (r9 >= r10) {
                    ...
                    r0 = r6.mMigrations.get(java.lang.Integer.valueOf(r9));
                    if (r0 == null) {
                        if (r8) {
                        ...
                        java.util.Iterator<java.lang.Integer> r2 = r2.iterator();
                        while (true) {
                            r4 = true;
                            boolean r5 = false;
                            if (!r2.hasNext()) {
                            ...
                            int r3 = r2.next().intValue();
                            if (!r8 ? !(r3 < r10 || r3 >= r9) : !(r3 > r10 || r3 <= r9)) {
                                r5 = true;
                                continue;
                            }
                            if (r5) {
                                r7.add(r0.get(java.lang.Integer.valueOf(r3)));
                                r9 = r3;
                                continue;
                                break;
                            }
