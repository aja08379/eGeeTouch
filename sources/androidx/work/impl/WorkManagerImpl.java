...
public class WorkManagerImpl extends WorkManager {
    ...
    */
    public static void initialize(android.content.Context r4, androidx.work.Configuration r5) {
        synchronized (androidx.work.impl.WorkManagerImpl.sLock) {
            androidx.work.impl.WorkManagerImpl r1 = androidx.work.impl.WorkManagerImpl.sDelegatedInstance;
            if (r1 != null && androidx.work.impl.WorkManagerImpl.sDefaultInstance != null) {
