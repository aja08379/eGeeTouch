...
public class CoordinatorLayout extends ViewGroup implements NestedScrollingParent2, NestedScrollingParent3 {
    ...
    */
    public boolean onTouchEvent(android.view.MotionEvent r18) {
        ...
        if (r17.mBehaviorTouchView == null) {
            r3 = performIntercept(r18, 1);
        } else {
            r3 = false;
        }
        androidx.coordinatorlayout.widget.CoordinatorLayout.Behavior r6 = ((androidx.coordinatorlayout.widget.CoordinatorLayout.LayoutParams) r17.mBehaviorTouchView.getLayoutParams()).getBehavior();
        if (r6 != null) {
            r6 = r6.onTouchEvent(r17, r17.mBehaviorTouchView, r18);
            r8 = null;
            if (r17.mBehaviorTouchView != null) {
                r6 |= super.onTouchEvent(r18);
            } else if (r3) {
                long r11 = android.os.SystemClock.uptimeMillis();
                r8 = android.view.MotionEvent.obtain(r11, r11, 3, 0.0f, 0.0f, 0);
    ...
    */
    protected void onMeasure(int r31, int r32) {
        ...
        int r11;
        int r23;
        androidx.coordinatorlayout.widget.CoordinatorLayout.Behavior r0;
        androidx.coordinatorlayout.widget.CoordinatorLayout.LayoutParams r26;
        int r27;
        int r29;
        int r28;
        int r25;
        ...
        int r17 = r8 + r9;
        int r18 = r0 + r1;
        int r0 = getSuggestedMinimumWidth();
        int r1 = getSuggestedMinimumHeight();
        boolean r19 = r30.mLastInsets != null && androidx.core.view.ViewCompat.getFitsSystemWindows(r30);
        int r6 = r30.mDependencySortedChildren.size();
        int r5 = r0;
        int r4 = r1;
        int r2 = 0;
        int r3 = 0;
        while (r3 < r6) {
            android.view.View r20 = r30.mDependencySortedChildren.get(r3);
            if (r20.getVisibility() == 8) {
                r22 = r3;
                r29 = r6;
                r28 = r8;
            } else {
                androidx.coordinatorlayout.widget.CoordinatorLayout.LayoutParams r1 = (androidx.coordinatorlayout.widget.CoordinatorLayout.LayoutParams) r20.getLayoutParams();
                if (r1.keyline < 0 || r13 == 0) {
                    r22 = r2;
                } else {
                    int r0 = getKeyline(r1.keyline);
                    int r11 = androidx.core.view.GravityCompat.getAbsoluteGravity(resolveKeylineGravity(r1.gravity), r10) & 7;
                    r22 = r2;
                    if ((r11 == 3 && !r12) || (r11 == 5 && r12)) {
                        r21 = java.lang.Math.max(0, (r14 - r9) - r0);
                    } else if ((r11 == 5 && !r12) || (r11 == 3 && r12)) {
                        r21 = java.lang.Math.max(0, r0 - r8);
                    }
                    if (r19 || androidx.core.view.ViewCompat.getFitsSystemWindows(r20)) {
                        r11 = r31;
                        r23 = r32;
                    } else {
                        r11 = android.view.View.MeasureSpec.makeMeasureSpec(r14 - (r30.mLastInsets.getSystemWindowInsetLeft() + r30.mLastInsets.getSystemWindowInsetRight()), r13);
                        r23 = android.view.View.MeasureSpec.makeMeasureSpec(r16 - (r30.mLastInsets.getSystemWindowInsetTop() + r30.mLastInsets.getSystemWindowInsetBottom()), r15);
                    }
                    r0 = r1.getBehavior();
                    if (r0 == null) {
                        r26 = r1;
                    ...
                    onMeasureChild(r20, r11, r21, r23, 0);
                    androidx.coordinatorlayout.widget.CoordinatorLayout.LayoutParams r1 = r26;
                    int r0 = java.lang.Math.max(r8, r17 + r20.getMeasuredWidth() + r1.leftMargin + r1.rightMargin);
                    int r1 = java.lang.Math.max(r27, r18 + r20.getMeasuredHeight() + r1.topMargin + r1.bottomMargin);
                    r2 = android.view.View.combineMeasuredStates(r25, r20.getMeasuredState());
                    r5 = r0;
                    r4 = r1;
                }
                r21 = 0;
        ...
        int r11 = r2;
        setMeasuredDimension(android.view.View.resolveSizeAndState(r5, r31, (-16777216) & r11), android.view.View.resolveSizeAndState(r4, r32, r11 << 16));
    }
