...
public class ViewPager extends ViewGroup {
    ...
    */
    void populate(int r18) {
        androidx.viewpager.widget.ViewPager.ItemInfo r2;
        java.lang.String r1;
        androidx.viewpager.widget.ViewPager.ItemInfo r8;
        androidx.viewpager.widget.ViewPager.ItemInfo r3;
        androidx.viewpager.widget.ViewPager.ItemInfo r5;
        int r2 = r17.mCurItem;
        if (r2 != r18) {
            r2 = infoForPosition(r2);
            r17.mCurItem = r18;
        } else {
            r2 = null;
        }
        if (r17.mAdapter == null) {
            sortChildDrawingOrder();
        } else if (r17.mPopulatePending) {
            sortChildDrawingOrder();
        } else if (getWindowToken() != null) {
            r17.mAdapter.startUpdate((android.view.ViewGroup) r17);
            int r1 = r17.mOffscreenPageLimit;
            int r4 = java.lang.Math.max(0, r17.mCurItem - r1);
            int r6 = r17.mAdapter.getCount();
            int r1 = java.lang.Math.min(r6 - 1, r17.mCurItem + r1);
            if (r6 != r17.mExpectedAdapterCount) {
                try {
                    r1 = getResources().getResourceName(getId());
                } catch (android.content.res.Resources.NotFoundException unused) {
                    r1 = java.lang.Integer.toHexString(getId());
                }
                throw new java.lang.IllegalStateException("The application's PagerAdapter changed the adapter's contents without calling PagerAdapter#notifyDataSetChanged! Expected adapter item count: " + r17.mExpectedAdapterCount + ", found: " + r6 + " Pager id: " + r1 + " Pager class: " + getClass() + " Problematic adapter: " + r17.mAdapter.getClass());
            }
            int r7 = 0;
            while (true) {
                if (r7 >= r17.mItems.size()) {
                    break;
                }
                r8 = r17.mItems.get(r7);
                if (r8.position < r17.mCurItem) {
                    r7++;
                }
            }
            if (r8 == null && r6 > 0) {
                r8 = addNewItem(r17.mCurItem, r7);
            }
            if (r8 != null) {
                int r10 = r7 - 1;
                androidx.viewpager.widget.ViewPager.ItemInfo r11 = r10 >= 0 ? r17.mItems.get(r10) : null;
                int r12 = getClientWidth();
                float r14 = r12 <= 0 ? 0.0f : (2.0f - r8.widthFactor) + (getPaddingLeft() / r12);
                float r15 = 0.0f;
                for (int r3 = r17.mCurItem - 1; r3 >= 0; r3--) {
                    if (r15 < r14 || r3 >= r4) {
                        if (r11 != null && r3 == r11.position) {
                            r15 += r11.widthFactor;
                            r10--;
                            if (r10 >= 0) {
                            ...
                            r15 += addNewItem(r3, r10 + 1).widthFactor;
                            r7++;
                            if (r10 >= 0) {
                                r5 = r17.mItems.get(r10);
                                r11 = r5;
                        ...
                        if (r3 == r11.position && !r11.scrolling) {
                            r17.mItems.remove(r10);
                            r17.mAdapter.destroyItem((android.view.ViewGroup) r17, r3, r11.object);
                            r10--;
                            r7--;
                            if (r10 >= 0) {
                                r5 = r17.mItems.get(r10);
                ...
                int r4 = r7 + 1;
                if (r3 < 2.0f) {
                    androidx.viewpager.widget.ViewPager.ItemInfo r5 = r4 < r17.mItems.size() ? r17.mItems.get(r4) : null;
                    float r10 = r12 <= 0 ? 0.0f : (getPaddingRight() / r12) + 2.0f;
                    int r11 = r17.mCurItem;
                    while (true) {
                        r11++;
                        if (r11 >= r6) {
                            break;
                        } else if (r3 < r10 || r11 <= r1) {
                            if (r5 != null && r11 == r5.position) {
                                r3 += r5.widthFactor;
                                r4++;
                                if (r4 < r17.mItems.size()) {
                                    r5 = r17.mItems.get(r4);
                                }
                            } else {
                                androidx.viewpager.widget.ViewPager.ItemInfo r5 = addNewItem(r11, r4);
                                r4++;
                                r3 += r5.widthFactor;
                                r5 = r4 < r17.mItems.size() ? r17.mItems.get(r4) : null;
                            }
                        } else if (r5 == null) {
                            break;
                        } else if (r11 == r5.position && !r5.scrolling) {
                            r17.mItems.remove(r4);
                            r17.mAdapter.destroyItem((android.view.ViewGroup) r17, r11, r5.object);
                            if (r4 < r17.mItems.size()) {
                                r5 = r17.mItems.get(r4);
                            }
                        }
                ...
                calculatePageOffsets(r8, r7, r2);
                r17.mAdapter.setPrimaryItem((android.view.ViewGroup) r17, r17.mCurItem, r8.object);
            }
            r17.mAdapter.finishUpdate((android.view.ViewGroup) r17);
            int r1 = getChildCount();
            for (int r2 = 0; r2 < r1; r2++) {
                android.view.View r3 = getChildAt(r2);
                androidx.viewpager.widget.ViewPager.LayoutParams r4 = (androidx.viewpager.widget.ViewPager.LayoutParams) r3.getLayoutParams();
                r4.childIndex = r2;
                if (!r4.isDecor && r4.widthFactor == 0.0f && (r3 = infoForChild(r3)) != null) {
                    r4.widthFactor = r3.widthFactor;
                    r4.position = r3.position;
                }
            }
            sortChildDrawingOrder();
            if (hasFocus()) {
                android.view.View r1 = findFocus();
                androidx.viewpager.widget.ViewPager.ItemInfo r3 = r1 != null ? infoForAnyChild(r1) : null;
                if (r3 == null || r3.position != r17.mCurItem) {
                    for (int r5 = 0; r5 < getChildCount(); r5++) {
                        android.view.View r1 = getChildAt(r5);
                        androidx.viewpager.widget.ViewPager.ItemInfo r2 = infoForChild(r1);
                        if (r2 != null && r2.position == r17.mCurItem && r1.requestFocus(2)) {
                            return;
                        }
                    }
                }
    ...
    */
    protected void onLayout(boolean r19, int r20, int r21, int r22, int r23) {
        boolean r2;
        androidx.viewpager.widget.ViewPager.ItemInfo r10;
        int r14;
        int r14;
        int r12;
        int r12;
        ...
        for (int r10 = 0; r10 < r1; r10++) {
            android.view.View r13 = getChildAt(r10);
            if (r13.getVisibility() != 8) {
                androidx.viewpager.widget.ViewPager.LayoutParams r12 = (androidx.viewpager.widget.ViewPager.LayoutParams) r13.getLayoutParams();
                if (r12.isDecor) {
                    int r14 = r12.gravity & 7;
                    int r12 = r12.gravity & 112;
                    if (r14 == 1) {
                        r14 = java.lang.Math.max((r2 - r13.getMeasuredWidth()) / 2, r4);
                    } else {
                        if (r14 == 3) {
                            r14 = r13.getMeasuredWidth() + r4;
                        } else if (r14 != 5) {
                            r14 = r4;
                        } else {
                            r14 = (r2 - r6) - r13.getMeasuredWidth();
                            r6 += r13.getMeasuredWidth();
                        }
                        if (r12 != 16) {
                            r12 = java.lang.Math.max((r3 - r13.getMeasuredHeight()) / 2, r5);
                        } else {
                            if (r12 == 48) {
                                r12 = r13.getMeasuredHeight() + r5;
                            } else if (r12 != 80) {
                                r12 = r5;
                            } else {
                                r12 = (r3 - r7) - r13.getMeasuredHeight();
                                r7 += r13.getMeasuredHeight();
                            }
                            int r4 = r4 + r8;
                            r13.layout(r4, r5, r13.getMeasuredWidth() + r4, r5 + r13.getMeasuredHeight());
                            r11++;
                            r5 = r12;
                            r4 = r14;
                        }
        ...
        for (int r6 = 0; r6 < r1; r6++) {
            android.view.View r8 = getChildAt(r6);
            if (r8.getVisibility() != 8) {
                androidx.viewpager.widget.ViewPager.LayoutParams r9 = (androidx.viewpager.widget.ViewPager.LayoutParams) r8.getLayoutParams();
                if (!r9.isDecor && (r10 = infoForChild(r8)) != null) {
                    float r13 = r2;
                    int r10 = ((int) (r10.offset * r13)) + r4;
                    if (r9.needsMeasure) {
                        r9.needsMeasure = false;
                        r8.measure(android.view.View.MeasureSpec.makeMeasureSpec((int) (r13 * r9.widthFactor), androidx.constraintlayout.core.widgets.analyzer.BasicMeasure.EXACTLY), android.view.View.MeasureSpec.makeMeasureSpec((r3 - r5) - r7, androidx.constraintlayout.core.widgets.analyzer.BasicMeasure.EXACTLY));
                    }
                    r8.layout(r10, r5, r8.getMeasuredWidth() + r10, r8.getMeasuredHeight() + r5);
                }
            }
        }
        r18.mTopPageBounds = r5;
        r18.mBottomPageBounds = r3 - r7;
        r18.mDecorChildCount = r11;
        if (r18.mFirstLayout) {
            r2 = false;
            scrollToItem(r18.mCurItem, false, 0, false);
        } else {
            r2 = false;
        }
        r18.mFirstLayout = r2;
    ...
    protected void onPageScrolled(int r13, float r14, int r15) {
        ...
        if (r12.mDecorChildCount > 0) {
            ...
            for (int r7 = 0; r7 < r6; r7++) {
                android.view.View r8 = getChildAt(r7);
                androidx.viewpager.widget.ViewPager.LayoutParams r9 = (androidx.viewpager.widget.ViewPager.LayoutParams) r8.getLayoutParams();
                if (r9.isDecor) {
                    int r9 = r9.gravity & 7;
                    if (r9 == 1) {
                        r9 = java.lang.Math.max((r5 - r8.getMeasuredWidth()) / 2, r3);
                    } else {
                        if (r9 == 3) {
                            r9 = r8.getWidth() + r3;
                        } else if (r9 != 5) {
                            ...
                            r9 = (r5 - r4) - r8.getMeasuredWidth();
                            r4 += r8.getMeasuredWidth();
                        }
                        r3 = (r3 + r0) - r8.getLeft();
                        if (r3 != 0) {
        ...
        if (r12.mPageTransformer != null) {
            int r13 = getScrollX();
            int r14 = getChildCount();
            for (int r1 = 0; r1 < r14; r1++) {
                android.view.View r15 = getChildAt(r1);
                if (!((androidx.viewpager.widget.ViewPager.LayoutParams) r15.getLayoutParams()).isDecor) {
                    r12.mPageTransformer.transformPage(r15, (r15.getLeft() - r13) / getClientWidth());
                }
            }
        }
        r12.mCalledSuper = true;
    }
    ...
    */
    public boolean arrowScroll(int r8) {
        ...
        boolean r0;
        android.view.View r0 = findFocus();
        boolean r2 = false;
        if (r0 != r7) {
            if (r0 != null) {
                android.view.ViewParent r4 = r0.getParent();
                while (true) {
                    if (!(r4 instanceof android.view.ViewGroup)) {
                        r4 = false;
                        break;
                    } else if (r4 == r7) {
                        r4 = true;
                ...
                if (!r4) {
                    ...
                    for (android.view.ViewParent r0 = r0.getParent(); r0 instanceof android.view.ViewGroup; r0 = r0.getParent()) {
                        r4.append(" => ").append(r0.getClass().getSimpleName());
                    }
                    android.util.Log.e(androidx.viewpager.widget.ViewPager.TAG, "arrowScroll tried to find focus based on non-child current focused view " + r4.toString());
                }
            }
            r3 = android.view.FocusFinder.getInstance().findNextFocus(r7, r0, r8);
            if (r3 == null && r3 != r0) {
                if (r8 == 17) {
                    int r1 = getChildRectInPagerCoordinates(r7.mTempRect, r3).left;
                    int r2 = getChildRectInPagerCoordinates(r7.mTempRect, r0).left;
                    if (r0 != null && r1 >= r2) {
                        r0 = pageLeft();
                    } else {
                        r0 = r3.requestFocus();
            ...
            if (r2) {
                playSoundEffect(android.view.SoundEffectConstants.getContantForFocusDirection(r8));
            }
            return r2;
        }
        r0 = null;
