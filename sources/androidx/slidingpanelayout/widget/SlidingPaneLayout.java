...
public class SlidingPaneLayout extends ViewGroup {
    ...
    */
    private void parallaxOtherViews(float r10) {
        ...
        androidx.slidingpanelayout.widget.SlidingPaneLayout.LayoutParams r1 = (androidx.slidingpanelayout.widget.SlidingPaneLayout.LayoutParams) r9.mSlideableView.getLayoutParams();
        if (r1.dimWhenOffset) {
            if ((r0 ? r1.rightMargin : r1.leftMargin) <= 0) {
                r1 = true;
                r2 = getChildCount();
                for (int r3 = 0; r3 < r2; r3++) {
                    android.view.View r4 = getChildAt(r3);
                    if (r4 != r9.mSlideableView) {
                        int r7 = r9.mParallaxBy;
                        r9.mParallaxOffset = r10;
                        int r5 = ((int) ((1.0f - r9.mParallaxOffset) * r7)) - ((int) ((1.0f - r10) * r7));
                        if (r0) {
                            r5 = -r5;
                        }
                        ...
                        if (r1) {
                            ...
                            dimChildView(r4, r0 ? r5 - 1.0f : 1.0f - r5, r9.mCoveredFadeColor);
                        }
                    }
                }
            }
