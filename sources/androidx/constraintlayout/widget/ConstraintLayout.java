        ...
        public void resolveLayoutDirection(int r11) {
            ...
            if (android.os.Build.VERSION.SDK_INT >= 17) {
                ...
                if (1 == getLayoutDirection()) {
                    r11 = true;
                    r10.resolvedRightToLeft = -1;
                    r10.resolvedRightToRight = -1;
                    r10.resolvedLeftToLeft = -1;
                    r10.resolvedLeftToRight = -1;
                    r10.resolveGoneLeftMargin = -1;
                    r10.resolveGoneRightMargin = -1;
                    r10.resolveGoneLeftMargin = r10.goneLeftMargin;
                    r10.resolveGoneRightMargin = r10.goneRightMargin;
                    ...
                    if (!r11) {
                        ...
                        if (r11 != -1) {
                            ...
                            r11 = r10.goneStartMargin;
                            if (r11 != Integer.MIN_VALUE) {
                                r10.resolveGoneRightMargin = r11;
                            }
                            r11 = r10.goneEndMargin;
                            if (r11 != Integer.MIN_VALUE) {
                                r10.resolveGoneLeftMargin = r11;
                            }
                            if (r3) {
                                r10.resolvedHorizontalBias = 1.0f - r5;
                            }
                            if (r10.isGuideline && r10.orientation == 1 && r10.guidelineUseRtl) {
                                if (r8 == -1.0f) {
                                    r10.resolvedGuidePercent = 1.0f - r8;
                                    r10.resolvedGuideBegin = -1;
                                    r10.resolvedGuideEnd = -1;
                                } else if (r6 != -1) {
                                    r10.resolvedGuideEnd = r6;
                                    r10.resolvedGuideBegin = -1;
                                    r10.resolvedGuidePercent = -1.0f;
                                } else if (r7 != -1) {
                    ...
                    if (r10.endToStart != -1 && r10.endToEnd == -1 && r10.startToStart == -1 && r10.startToEnd == -1) {
                        int r11 = r10.rightToLeft;
                        if (r11 != -1) {
                            r10.resolvedRightToLeft = r11;
                            if (r10.rightMargin <= 0 && r1 > 0) {
                                r10.rightMargin = r1;
                            }
                        } else {
