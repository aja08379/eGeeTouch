...
public class ConstraintSet {
    ...
    */
    public void load(android.content.Context r10, org.xmlpull.v1.XmlPullParser r11) {
        androidx.constraintlayout.widget.ConstraintSet.Constraint r0;
        try {
            int r0 = r11.getEventType();
            androidx.constraintlayout.widget.ConstraintSet.Constraint r2 = null;
            while (r0 != 1) {
                if (r0 != 0) {
                    char r4 = 65535;
                    if (r0 == 2) {
                        ...
                        switch (r0.hashCode()) {
                            case -2025855158:
                                ...
                                break;
                            case -1984451626:
                                if (r0.equals(androidx.constraintlayout.core.motion.utils.TypedValues.MotionType.NAME)) {
                                    r4 = 7;
                                    break;
                                }
                                break;
                            case -1962203927:
                                if (r0.equals(androidx.constraintlayout.motion.widget.ViewTransition.CONSTRAINT_OVERRIDE)) {
                                    r4 = 1;
                                    break;
                                }
                                break;
                            case -1269513683:
                                ...
                                break;
                            case -1238332596:
                                if (r0.equals("Transform")) {
                                    r4 = 5;
                                    break;
                                }
                                break;
                            case -71750448:
                                if (r0.equals("Guideline")) {
                                    r4 = 2;
                                    break;
                                }
                                break;
                            case 366511058:
                                if (r0.equals(androidx.constraintlayout.motion.widget.ViewTransition.CUSTOM_METHOD)) {
                                    r4 = '\t';
                                    break;
                                }
                                break;
                            case 1331510167:
                                if (r0.equals("Barrier")) {
                                    r4 = 3;
                                    break;
                                }
                                break;
                            case 1791837707:
                                if (r0.equals(androidx.constraintlayout.motion.widget.ViewTransition.CUSTOM_ATTRIBUTE)) {
                                    r4 = '\b';
                                    break;
                                }
                                break;
                            case 1803088381:
                                if (r0.equals("Constraint")) {
                                    r4 = 0;
                                    break;
                                }
                                break;
                        ...
                        switch (r4) {
                            case 0:
                                r0 = fillFromAttributeList(r10, android.util.Xml.asAttributeSet(r11), false);
                                r2 = r0;
                                break;
                            case 1:
                                r0 = fillFromAttributeList(r10, android.util.Xml.asAttributeSet(r11), true);
                                r2 = r0;
                                break;
                            case 2:
                                r0 = fillFromAttributeList(r10, android.util.Xml.asAttributeSet(r11), false);
                                r0.layout.mIsGuideline = true;
                                r0.layout.mApply = true;
                                r2 = r0;
                                break;
                            case 3:
                                r0 = fillFromAttributeList(r10, android.util.Xml.asAttributeSet(r11), false);
                                r0.layout.mHelperType = 1;
                                r2 = r0;
                                break;
                            case 4:
                                if (r2 == null) {
                                    throw new java.lang.RuntimeException(androidx.constraintlayout.widget.ConstraintSet.ERROR_MESSAGE + r11.getLineNumber());
                                }
                                r2.propertySet.fillFromAttributeList(r10, android.util.Xml.asAttributeSet(r11));
                                break;
                            case 5:
                                if (r2 == null) {
                                    throw new java.lang.RuntimeException(androidx.constraintlayout.widget.ConstraintSet.ERROR_MESSAGE + r11.getLineNumber());
                                }
                                r2.transform.fillFromAttributeList(r10, android.util.Xml.asAttributeSet(r11));
                                break;
                            case 6:
                                if (r2 == null) {
                                    throw new java.lang.RuntimeException(androidx.constraintlayout.widget.ConstraintSet.ERROR_MESSAGE + r11.getLineNumber());
                                }
                                r2.layout.fillFromAttributeList(r10, android.util.Xml.asAttributeSet(r11));
                                break;
                            case 7:
                                if (r2 == null) {
                                    throw new java.lang.RuntimeException(androidx.constraintlayout.widget.ConstraintSet.ERROR_MESSAGE + r11.getLineNumber());
                                }
                                r2.motion.fillFromAttributeList(r10, android.util.Xml.asAttributeSet(r11));
                                break;
                            case '\b':
                            case '\t':
                                if (r2 == null) {
                                ...
                                androidx.constraintlayout.widget.ConstraintAttribute.parse(r10, r11, r2.mCustomConstraints);
                                break;
                        }
                    } else if (r0 == 3) {
                        java.lang.String r0 = r11.getName().toLowerCase(java.util.Locale.ROOT);
                        switch (r0.hashCode()) {
                            case -2075718416:
                                if (r0.equals("guideline")) {
                                    r4 = 3;
                            ...
                            case -190376483:
                                ...
                                break;
                            case 426575017:
                                if (r0.equals("constraintoverride")) {
                                    r4 = 2;
                                    break;
                                }
                                break;
                            case 2146106725:
                                if (r0.equals("constraintset")) {
                                    r4 = 0;
                                    break;
                                }
                                break;
                        ...
                        if (r4 == 1 || r4 == 2 || r4 == 3) {
                            r9.mConstraints.put(java.lang.Integer.valueOf(r2.mViewId), r2);
                            r2 = null;
                        }
                    }
                } else {
        ...
        } catch (java.io.IOException r10) {
            r10.printStackTrace();
        } catch (org.xmlpull.v1.XmlPullParserException r10) {
            r10.printStackTrace();
        }
    }
