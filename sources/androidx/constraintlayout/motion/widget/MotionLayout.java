...
public class MotionLayout extends ConstraintLayout implements NestedScrollingParent3 {
    ...
    */
    public void touchAnimateTo(int r10, float r11, float r12) {
        if (r9.mScene == null || r9.mTransitionLastPosition == r11) {
            return;
        }
        r9.mTemporalInterpolator = true;
        r9.mAnimationStartTime = getNanoTime();
        r9.mTransitionDuration = r9.mScene.getDuration() / 1000.0f;
        r9.mTransitionGoalPosition = r11;
        r9.mInTransition = true;
        if (r10 != 0 && r10 != 1 && r10 != 2) {
            if (r10 == 4) {
                r9.mDecelerateLogic.config(r12, r9.mTransitionLastPosition, r9.mScene.getMaxAcceleration());
                r9.mInterpolator = r9.mDecelerateLogic;
            } else if (r10 != 5) {
                if (r10 != 6) {
                }
            } else if (willJump(r12, r9.mTransitionLastPosition, r9.mScene.getMaxAcceleration())) {
                r9.mDecelerateLogic.config(r12, r9.mTransitionLastPosition, r9.mScene.getMaxAcceleration());
                r9.mInterpolator = r9.mDecelerateLogic;
            } else {
                r9.mStopLogic.config(r9.mTransitionLastPosition, r11, r12, r9.mTransitionDuration, r9.mScene.getMaxAcceleration(), r9.mScene.getMaxVelocity());
                r9.mLastVelocity = 0.0f;
                int r10 = r9.mCurrentState;
                r9.mTransitionGoalPosition = r11;
                r9.mCurrentState = r10;
                r9.mInterpolator = r9.mStopLogic;
            }
            r9.mTransitionInstantly = false;
            r9.mAnimationStartTime = getNanoTime();
            invalidate();
        }
        if (r10 == 1 || r10 == 7) {
        ...
        if (r9.mScene.getAutoCompleteMode() == 0) {
            r9.mStopLogic.config(r9.mTransitionLastPosition, r11, r12, r9.mTransitionDuration, r9.mScene.getMaxAcceleration(), r9.mScene.getMaxVelocity());
        } else {
            r9.mStopLogic.springConfig(r9.mTransitionLastPosition, r11, r12, r9.mScene.getSpringMass(), r9.mScene.getSpringStiffiness(), r9.mScene.getSpringDamping(), r9.mScene.getSpringStopThreshold(), r9.mScene.getSpringBoundary());
        }
        int r10 = r9.mCurrentState;
        r9.mTransitionGoalPosition = r11;
        r9.mCurrentState = r10;
    ...
    public class Model {
        ...
        */
        public void build() {
            ...
            java.lang.String r2;
            int r1 = androidx.constraintlayout.motion.widget.MotionLayout.this.getChildCount();
            androidx.constraintlayout.motion.widget.MotionLayout.this.mFrameArrayList.clear();
            android.util.SparseArray r2 = new android.util.SparseArray();
            int[] r3 = new int[r1];
            for (int r5 = 0; r5 < r1; r5++) {
                android.view.View r6 = androidx.constraintlayout.motion.widget.MotionLayout.this.getChildAt(r5);
                androidx.constraintlayout.motion.widget.MotionController r7 = new androidx.constraintlayout.motion.widget.MotionController(r6);
                int r8 = r6.getId();
                r3[r5] = r8;
                r2.put(r8, r7);
                androidx.constraintlayout.motion.widget.MotionLayout.this.mFrameArrayList.put(r6, r7);
            }
            int r5 = 0;
            while (r5 < r1) {
                android.view.View r6 = androidx.constraintlayout.motion.widget.MotionLayout.this.getChildAt(r5);
                androidx.constraintlayout.motion.widget.MotionController r13 = androidx.constraintlayout.motion.widget.MotionLayout.this.mFrameArrayList.get(r6);
                if (r13 == null) {
                    r16 = r2;
                } else {
                    if (r18.mStart == null) {
                        if (androidx.constraintlayout.motion.widget.MotionLayout.this.mInRotation) {
                            androidx.constraintlayout.motion.utils.ViewState r8 = androidx.constraintlayout.motion.widget.MotionLayout.this.mPreRotate.get(r6);
                            int r10 = androidx.constraintlayout.motion.widget.MotionLayout.this.mRotatMode;
                            int r16 = androidx.constraintlayout.motion.widget.MotionLayout.this.mPreRotateWidth;
                            int r17 = androidx.constraintlayout.motion.widget.MotionLayout.this.mPreRotateHeight;
                            r4 = androidx.constraintlayout.motion.widget.MotionLayout.TAG;
                            r16 = r2;
                            r2 = "no widget for  ";
                            r13.setStartState(r8, r6, r10, r16, r17);
                            if (r18.mEnd != null) {
                                androidx.constraintlayout.core.widgets.ConstraintWidget r7 = getWidget(r18.mLayoutEnd, r6);
                                if (r7 != null) {
                                    r13.setEndState(androidx.constraintlayout.motion.widget.MotionLayout.this.toRect(r7), r18.mEnd, androidx.constraintlayout.motion.widget.MotionLayout.this.getWidth(), androidx.constraintlayout.motion.widget.MotionLayout.this.getHeight());
                                } else if (androidx.constraintlayout.motion.widget.MotionLayout.this.mDebugPath != 0) {
                                    android.util.Log.e(r4, androidx.constraintlayout.motion.widget.Debug.getLocation() + r2 + androidx.constraintlayout.motion.widget.Debug.getName(r6) + " (" + r6.getClass().getName() + ")");
                                }
                            }
                        }
                    } else {
                        androidx.constraintlayout.core.widgets.ConstraintWidget r7 = getWidget(r18.mLayoutStart, r6);
                        if (r7 != null) {
                            r13.setStartState(androidx.constraintlayout.motion.widget.MotionLayout.this.toRect(r7), r18.mStart, androidx.constraintlayout.motion.widget.MotionLayout.this.getWidth(), androidx.constraintlayout.motion.widget.MotionLayout.this.getHeight());
                        } else if (androidx.constraintlayout.motion.widget.MotionLayout.this.mDebugPath != 0) {
                            android.util.Log.e(androidx.constraintlayout.motion.widget.MotionLayout.TAG, androidx.constraintlayout.motion.widget.Debug.getLocation() + "no widget for  " + androidx.constraintlayout.motion.widget.Debug.getName(r6) + " (" + r6.getClass().getName() + ")");
                        }
                    }
                    r16 = r2;
                    r4 = androidx.constraintlayout.motion.widget.MotionLayout.TAG;
            ...
            android.util.SparseArray r16 = r2;
            int r4 = 0;
            while (r4 < r1) {
                android.util.SparseArray r5 = r16;
                androidx.constraintlayout.motion.widget.MotionController r2 = (androidx.constraintlayout.motion.widget.MotionController) r5.get(r3[r4]);
                int r6 = r2.getAnimateRelativeTo();
                if (r6 != -1) {
                    r2.setupRelative((androidx.constraintlayout.motion.widget.MotionController) r5.get(r6));
                }
                r4++;
                r16 = r5;
            }
    ...
    */
    public void evaluate(boolean r24) {
        ...
        int r3;
        boolean r6;
        if (r23.mTransitionLastTime == -1) {
            r23.mTransitionLastTime = getNanoTime();
        }
        float r1 = r23.mTransitionLastPosition;
        if (r1 > 0.0f && r1 < 1.0f) {
            r23.mCurrentState = -1;
        }
        boolean r7 = false;
        if (r23.mKeepAnimating || (r23.mInTransition && (r24 || r23.mTransitionGoalPosition != r1))) {
            float r1 = java.lang.Math.signum(r23.mTransitionGoalPosition - r1);
            long r8 = getNanoTime();
            android.view.animation.Interpolator r3 = r23.mInterpolator;
            float r10 = !(r3 instanceof androidx.constraintlayout.motion.widget.MotionInterpolator) ? ((((float) (r8 - r23.mTransitionLastTime)) * r1) * 1.0E-9f) / r23.mTransitionDuration : 0.0f;
            float r12 = r23.mTransitionLastPosition + r10;
            if (r23.mTransitionInstantly) {
                r12 = r23.mTransitionGoalPosition;
            }
            int r13 = (r1 > 0.0f ? 1 : (r1 == 0.0f ? 0 : -1));
            if ((r13 <= 0 || r12 < r23.mTransitionGoalPosition) && (r1 > 0.0f || r12 > r23.mTransitionGoalPosition)) {
                r14 = false;
            } else {
                r12 = r23.mTransitionGoalPosition;
                r23.mInTransition = false;
                r14 = true;
            }
            r23.mTransitionLastPosition = r12;
            r23.mTransitionPosition = r12;
            r23.mTransitionLastTime = r8;
            if (r3 != null && !r14) {
                if (r23.mTemporalInterpolator) {
                    float r3 = r3.getInterpolation(((float) (r8 - r23.mAnimationStartTime)) * 1.0E-9f);
                    android.view.animation.Interpolator r4 = r23.mInterpolator;
                    androidx.constraintlayout.motion.utils.StopLogic r5 = r23.mStopLogic;
                    if (r4 == r5) {
                        r4 = r5.isStopped() ? true : true;
                    } else {
                        r4 = false;
                    }
                    r23.mTransitionLastPosition = r3;
                    r23.mTransitionLastTime = r8;
                    android.view.animation.Interpolator r5 = r23.mInterpolator;
                    if (r5 instanceof androidx.constraintlayout.motion.widget.MotionInterpolator) {
                        float r5 = ((androidx.constraintlayout.motion.widget.MotionInterpolator) r5).getVelocity();
                        r23.mLastVelocity = r5;
                        if (java.lang.Math.abs(r5) * r23.mTransitionDuration <= androidx.constraintlayout.motion.widget.MotionLayout.EPSILON && r4) {
                            r23.mInTransition = false;
                        }
                        if (r5 > 0.0f && r3 >= 1.0f) {
                            r23.mTransitionLastPosition = 1.0f;
                            r23.mInTransition = false;
                            r3 = 1.0f;
                        }
                        if (r5 < 0.0f && r3 <= 0.0f) {
                            r23.mTransitionLastPosition = 0.0f;
                            r23.mInTransition = false;
                            r12 = 0.0f;
                            if (java.lang.Math.abs(r23.mLastVelocity) > androidx.constraintlayout.motion.widget.MotionLayout.EPSILON) {
                            ...
                            if (!r4) {
                                ...
                                if (r12 >= 1.0f || r12 <= 0.0f) {
                                    r23.mInTransition = false;
                                    setState(androidx.constraintlayout.motion.widget.MotionLayout.TransitionState.FINISHED);
                                }
                            }
                            r3 = getChildCount();
                            r23.mKeepAnimating = false;
                            long r4 = getNanoTime();
                            r23.mPostInterpolationPosition = r12;
                            android.view.animation.Interpolator r8 = r23.mProgressInterpolator;
                            float r8 = r8 == null ? r12 : r8.getInterpolation(r12);
                            r9 = r23.mProgressInterpolator;
                            if (r9 != null) {
                                float r9 = r9.getInterpolation((r1 / r23.mTransitionDuration) + r12);
                                r23.mLastVelocity = r9;
                                r23.mLastVelocity = r9 - r23.mProgressInterpolator.getInterpolation(r12);
                            }
                            for (r9 = 0; r9 < r3; r9++) {
                                android.view.View r10 = getChildAt(r9);
                                androidx.constraintlayout.motion.widget.MotionController r17 = r23.mFrameArrayList.get(r10);
                                if (r17 != null) {
                                    r23.mKeepAnimating = r17.interpolate(r10, r8, r4, r23.mKeyCache) | r23.mKeepAnimating;
                                }
                            }
                            boolean r3 = (r13 <= 0 && r12 >= r23.mTransitionGoalPosition) || (r1 <= 0.0f && r12 <= r23.mTransitionGoalPosition);
                            if (!r23.mKeepAnimating && !r23.mInTransition && r3) {
                                setState(androidx.constraintlayout.motion.widget.MotionLayout.TransitionState.FINISHED);
                            }
                            if (r23.mMeasureDuringTransition) {
                                requestLayout();
                            }
                            r23.mKeepAnimating = (!r3) | r23.mKeepAnimating;
                            if (r12 <= 0.0f && (r3 = r23.mBeginState) != -1 && r23.mCurrentState != r3) {
                                r23.mCurrentState = r3;
                                r23.mScene.getConstraintSet(r3).applyCustomAttributes(r23);
                                setState(androidx.constraintlayout.motion.widget.MotionLayout.TransitionState.FINISHED);
                                r7 = true;
                            }
                            if (r12 >= 1.0d) {
                                int r3 = r23.mCurrentState;
                                int r4 = r23.mEndState;
                                if (r3 != r4) {
                                    r23.mCurrentState = r4;
                                    r23.mScene.getConstraintSet(r4).applyCustomAttributes(r23);
                                    setState(androidx.constraintlayout.motion.widget.MotionLayout.TransitionState.FINISHED);
                                    r7 = true;
                                }
                            }
                            if (!r23.mKeepAnimating || r23.mInTransition) {
                                invalidate();
                            } else if ((r13 > 0 && r12 == 1.0f) || (r1 < 0.0f && r12 == 0.0f)) {
                                setState(androidx.constraintlayout.motion.widget.MotionLayout.TransitionState.FINISHED);
                            }
                            if (!r23.mKeepAnimating && !r23.mInTransition && ((r13 > 0 && r12 == 1.0f) || (r1 < 0.0f && r12 == 0.0f))) {
                                onNewStateAttachHandlers();
                            }
                        }
                    }
                    ...
                    android.view.animation.Interpolator r4 = r23.mInterpolator;
                    if (r4 instanceof androidx.constraintlayout.motion.widget.MotionInterpolator) {
                        r23.mLastVelocity = ((androidx.constraintlayout.motion.widget.MotionInterpolator) r4).getVelocity();
                    } else {
                        r23.mLastVelocity = ((r4.getInterpolation(r12 + r10) - r3) * r1) / r10;
                    }
                    r12 = r3;
                }
            } else {
                r23.mLastVelocity = r10;
            }
            r4 = false;
            if (java.lang.Math.abs(r23.mLastVelocity) > androidx.constraintlayout.motion.widget.MotionLayout.EPSILON) {
            }
        ...
        float r1 = r23.mTransitionLastPosition;
        if (r1 >= 1.0f) {
            int r1 = r23.mCurrentState;
            int r2 = r23.mEndState;
            r6 = r1 == r2 ? r7 : true;
            r23.mCurrentState = r2;
        } else {
            if (r1 <= 0.0f) {
                int r1 = r23.mCurrentState;
                int r2 = r23.mBeginState;
                r6 = r1 == r2 ? r7 : true;
                r23.mCurrentState = r2;
            }
            r23.mNeedsFireTransitionCompleted |= r7;
            if (r7 && !r23.mInLayout) {
                requestLayout();
            }
            r23.mTransitionPosition = r23.mTransitionLastPosition;
        }
        r7 = r6;
        r23.mNeedsFireTransitionCompleted |= r7;
        if (r7) {
