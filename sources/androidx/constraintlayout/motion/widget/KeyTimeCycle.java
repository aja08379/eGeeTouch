    ...
    */
    public void addTimeValues(java.util.HashMap<java.lang.String, androidx.constraintlayout.motion.utils.ViewTimeCycle> r11) {
        ...
        while (r0.hasNext()) {
            ...
            androidx.constraintlayout.motion.utils.ViewTimeCycle r3 = r11.get(r1);
            if (r3 != null) {
                char r4 = 7;
                if (r1.startsWith("CUSTOM")) {
                    androidx.constraintlayout.widget.ConstraintAttribute r6 = r10.mCustomConstraints.get(r1.substring(7));
                    if (r6 != null) {
                        ((androidx.constraintlayout.motion.utils.ViewTimeCycle.CustomSet) r3).setPoint(r10.mFramePosition, r6, r10.mWavePeriod, r10.mWaveShape, r10.mWaveOffset);
                    }
                } else {
                    r1.hashCode();
                    switch (r1.hashCode()) {
                    ...
                    switch (r4) {
                        ...
                        case '\t':
                            if (!java.lang.Float.isNaN(r10.mElevation)) {
                                r3.setPoint(r10.mFramePosition, r10.mElevation, r10.mWavePeriod, r10.mWaveShape, r10.mWaveOffset);
                                break;
                            } else {
                                continue;
                            }
                        ...
                        default:
                            android.util.Log.e("KeyTimeCycles", "UNKNOWN addValues \"" + r1 + "\"");
                            continue;
                    }
                }
            }
