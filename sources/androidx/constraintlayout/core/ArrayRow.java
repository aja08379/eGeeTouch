...
public class ArrayRow implements LinearSystem.Row {
    ...
    */
    public java.lang.String toReadableString() {
        ...
        float r7;
        int r8;
        if (r10.variable == null) {
            r0 = "" + com.facebook.appevents.AppEventsConstants.EVENT_PARAM_VALUE_NO;
        } else {
            r0 = "" + r10.variable;
        }
        java.lang.String r0 = r0 + " = ";
        if (r10.constantValue != 0.0f) {
            r0 = r0 + r10.constantValue;
            r1 = true;
        } else {
            r1 = false;
        }
        int r5 = r10.variables.getCurrentSize();
        for (int r3 = 0; r3 < r5; r3++) {
            androidx.constraintlayout.core.SolverVariable r6 = r10.variables.getVariable(r3);
            if (r6 != null && (r10.variables.getVariableValue(r3)) != 0.0f) {
        ...
        return !r1 ? r0 + com.google.firebase.crashlytics.internal.common.IdManager.DEFAULT_VERSION_NAME : r0;
    }
