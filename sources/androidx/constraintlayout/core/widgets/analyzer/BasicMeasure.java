...
public class BasicMeasure {
    ...
    */
    private void measureChildren(androidx.constraintlayout.core.widgets.ConstraintWidgetContainer r12) {
        int r0 = r12.mChildren.size();
        boolean r1 = r12.optimizeFor(64);
        androidx.constraintlayout.core.widgets.analyzer.BasicMeasure.Measurer r2 = r12.getMeasurer();
        for (int r4 = 0; r4 < r0; r4++) {
            androidx.constraintlayout.core.widgets.ConstraintWidget r5 = r12.mChildren.get(r4);
            if (!(r5 instanceof androidx.constraintlayout.core.widgets.Guideline) && !(r5 instanceof androidx.constraintlayout.core.widgets.Barrier) && !r5.isInVirtualLayout() && (!r1 || r5.horizontalRun == null || r5.verticalRun == null || !r5.horizontalRun.dimension.resolved || !r5.verticalRun.dimension.resolved)) {
                androidx.constraintlayout.core.widgets.ConstraintWidget.DimensionBehaviour r6 = r5.getDimensionBehaviour(0);
                boolean r7 = true;
                androidx.constraintlayout.core.widgets.ConstraintWidget.DimensionBehaviour r8 = r5.getDimensionBehaviour(1);
                boolean r9 = r6 == androidx.constraintlayout.core.widgets.ConstraintWidget.DimensionBehaviour.MATCH_CONSTRAINT && r5.mMatchConstraintDefaultWidth != 1 && r8 == androidx.constraintlayout.core.widgets.ConstraintWidget.DimensionBehaviour.MATCH_CONSTRAINT && r5.mMatchConstraintDefaultHeight != 1;
                if (!r9 && r12.optimizeFor(1) && !(r5 instanceof androidx.constraintlayout.core.widgets.VirtualLayout)) {
                    if (r6 == androidx.constraintlayout.core.widgets.ConstraintWidget.DimensionBehaviour.MATCH_CONSTRAINT && r5.mMatchConstraintDefaultWidth == 0 && r8 != androidx.constraintlayout.core.widgets.ConstraintWidget.DimensionBehaviour.MATCH_CONSTRAINT && !r5.isInHorizontalChain()) {
                        r9 = true;
                    }
                    if (r8 == androidx.constraintlayout.core.widgets.ConstraintWidget.DimensionBehaviour.MATCH_CONSTRAINT && r5.mMatchConstraintDefaultHeight == 0 && r6 != androidx.constraintlayout.core.widgets.ConstraintWidget.DimensionBehaviour.MATCH_CONSTRAINT && !r5.isInHorizontalChain()) {
                        r9 = true;
                    }
                    if (r6 != androidx.constraintlayout.core.widgets.ConstraintWidget.DimensionBehaviour.MATCH_CONSTRAINT) {
                    }
                }
                r7 = r9;
                if (!r7) {
                    measure(r2, r5, androidx.constraintlayout.core.widgets.analyzer.BasicMeasure.Measure.SELF_DIMENSIONS);
                    if (r12.mMetrics != null) {
                        r12.mMetrics.measuredWidgets++;
                    }
                }
            }
        }
