...
public class Flow extends VirtualLayout {
    ...
    */
    private void measureAligned(androidx.constraintlayout.core.widgets.ConstraintWidget[] r17, int r18, int r19, int r20, int[] r21) {
        ...
        if (r19 == 0) {
            int r6 = r16.mMaxElementsWrap;
            if (r6 <= 0) {
                r6 = 0;
                int r8 = 0;
                for (int r7 = 0; r7 < r18; r7++) {
                    if (r7 > 0) {
                        r8 += r16.mHorizontalGap;
                    }
                    androidx.constraintlayout.core.widgets.ConstraintWidget r9 = r17[r7];
                    if (r9 != null) {
                        r8 += getWidgetWidth(r9, r20);
                        if (r8 > r20) {
                            break;
                        }
                        r6++;
        ...
        if (r16.mAlignedDimensions == null) {
            r16.mAlignedDimensions = new int[2];
        }
        if ((r6 != 0 || r19 != 1) && (r7 != 0 || r19 != 0)) {
            r9 = false;
            while (!r9) {
                if (r19 == 0) {
                    r6 = (int) java.lang.Math.ceil(r18 / r7);
                } else {
                    r7 = (int) java.lang.Math.ceil(r18 / r6);
                }
                androidx.constraintlayout.core.widgets.ConstraintWidget[] r10 = r16.mAlignedBiggestElementsInCols;
                if (r10 == null || r10.length < r7) {
                    r16.mAlignedBiggestElementsInCols = new androidx.constraintlayout.core.widgets.ConstraintWidget[r7];
                } else {
                    java.util.Arrays.fill(r10, (java.lang.Object) null);
                }
                androidx.constraintlayout.core.widgets.ConstraintWidget[] r10 = r16.mAlignedBiggestElementsInRows;
                if (r10 == null || r10.length < r6) {
                    r16.mAlignedBiggestElementsInRows = new androidx.constraintlayout.core.widgets.ConstraintWidget[r6];
                } else {
                    java.util.Arrays.fill(r10, (java.lang.Object) null);
                }
                for (int r10 = 0; r10 < r7; r10++) {
                    for (int r11 = 0; r11 < r6; r11++) {
                        int r12 = (r11 * r7) + r10;
                        if (r19 == 1) {
                            r12 = (r10 * r6) + r11;
                        }
                        if (r12 < r17.length && (r12 = r17[r12]) != null) {
                            int r13 = getWidgetWidth(r12, r20);
                            androidx.constraintlayout.core.widgets.ConstraintWidget[] r14 = r16.mAlignedBiggestElementsInCols;
                            if (r14[r10] == null || r14[r10].getWidth() < r13) {
                                r16.mAlignedBiggestElementsInCols[r10] = r12;
                            }
                            int r13 = getWidgetHeight(r12, r20);
                            androidx.constraintlayout.core.widgets.ConstraintWidget[] r14 = r16.mAlignedBiggestElementsInRows;
                            if (r14[r11] == null || r14[r11].getHeight() < r13) {
                                r16.mAlignedBiggestElementsInRows[r11] = r12;
                            }
                        }
                    }
                }
                int r11 = 0;
                for (int r10 = 0; r10 < r7; r10++) {
                    androidx.constraintlayout.core.widgets.ConstraintWidget r12 = r16.mAlignedBiggestElementsInCols[r10];
                    if (r12 != null) {
                        if (r10 > 0) {
                            r11 += r16.mHorizontalGap;
                        }
                        r11 += getWidgetWidth(r12, r20);
                    }
                }
                int r12 = 0;
                for (int r10 = 0; r10 < r6; r10++) {
                    androidx.constraintlayout.core.widgets.ConstraintWidget r13 = r16.mAlignedBiggestElementsInRows[r10];
                    if (r13 != null) {
                        if (r10 > 0) {
                            r12 += r16.mVerticalGap;
                        }
                        r12 += getWidgetHeight(r13, r20);
                    }
                }
                r21[0] = r11;
                r21[1] = r12;
                ...
                } else if (r11 > r20 && r7 > 1) {
                    r7--;
                }
                while (!r9) {
                }
            }
            int[] r1 = r16.mAlignedDimensions;
            r1[0] = r7;
            r1[1] = r6;
        }
        r9 = true;
