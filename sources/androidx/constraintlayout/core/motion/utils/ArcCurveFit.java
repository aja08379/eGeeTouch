...
public class ArcCurveFit extends CurveFit {
    ...
    */
    public ArcCurveFit(int[] r25, double[] r26, double[][] r27) {
        r24.mTime = r26;
        r24.mArcs = new androidx.constraintlayout.core.motion.utils.ArcCurveFit.Arc[r26.length - 1];
        int r5 = 1;
        int r6 = 1;
        int r4 = 0;
        while (true) {
            androidx.constraintlayout.core.motion.utils.ArcCurveFit.Arc[] r7 = r24.mArcs;
            if (r4 >= r7.length) {
                return;
            }
            int r8 = r25[r4];
            ...
            int r23 = r4 + 1;
            r7[r4] = new androidx.constraintlayout.core.motion.utils.ArcCurveFit.Arc(r6, r26[r4], r26[r23], r27[r4][0], r27[r4][1], r27[r23][0], r27[r23][1]);
            r4 = r23;
        }
    }
