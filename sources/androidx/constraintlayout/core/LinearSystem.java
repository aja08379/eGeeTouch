...
public class LinearSystem {
    ...
    */
    public void addConstraint(androidx.constraintlayout.core.ArrayRow r8) {
        androidx.constraintlayout.core.SolverVariable r0;
        if (r8 == null) {
            return;
        }
        ...
        if (r0 != null) {
            r0.constraints++;
            if (r8.isSimpleDefinition) {
                androidx.constraintlayout.core.LinearSystem.sMetrics.simpleconstraints++;
            }
        }
        boolean r3 = true;
        if (r7.mNumRows + 1 >= r7.mMaxRows || r7.mNumColumns + 1 >= r7.mMaxColumns) {
            increaseTableSize();
        }
        boolean r0 = false;
        if (!r8.isSimpleDefinition) {
            ...
            if (r8.chooseSubject(r7)) {
                androidx.constraintlayout.core.SolverVariable r4 = createExtraVariable();
                r8.variable = r4;
                int r5 = r7.mNumRows;
                addRow(r8);
                if (r7.mNumRows == r5 + 1) {
                    r7.mTempGoal.initFromRow(r8);
                    optimize(r7.mTempGoal, true);
                    if (r4.definitionId == -1) {
                        if (r8.variable == r4 && (r0 = r8.pickPivot(r4)) != null) {
                        ...
                        if (!r8.isSimpleDefinition) {
                            r8.variable.updateReferencesWithNewDefinition(r7, r8);
                        }
                        if (androidx.constraintlayout.core.LinearSystem.OPTIMIZED_ENGINE) {
                            r7.mCache.optimizedArrayRowPool.release(r8);
                        } else {
                            r7.mCache.arrayRowPool.release(r8);
                        }
                        r7.mNumRows--;
                    }
                    if (r8.hasKeyVariable()) {
                        return;
                    }
                    r0 = r3;
                }
