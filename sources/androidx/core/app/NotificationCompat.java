    ...
    public static abstract class Style {
        ...
        */
        public android.widget.RemoteViews applyStandardTemplate(boolean r13, int r14, boolean r15) {
            boolean r13;
            boolean r1;
            android.content.res.Resources r0 = r12.mBuilder.mContext.getResources();
            android.widget.RemoteViews r7 = new android.widget.RemoteViews(r12.mBuilder.mContext.getPackageName(), r14);
            boolean r8 = true;
            boolean r14 = r12.mBuilder.getPriority() < -1;
            if (android.os.Build.VERSION.SDK_INT >= 16 && android.os.Build.VERSION.SDK_INT < 21) {
                if (r14) {
                    r7.setInt(androidx.core.R.id.notification_background, "setBackgroundResource", androidx.core.R.drawable.notification_bg_low);
                    r7.setInt(androidx.core.R.id.icon, "setBackgroundResource", androidx.core.R.drawable.notification_template_icon_low_bg);
                } else {
                    r7.setInt(androidx.core.R.id.notification_background, "setBackgroundResource", androidx.core.R.drawable.notification_bg);
                    r7.setInt(androidx.core.R.id.icon, "setBackgroundResource", androidx.core.R.drawable.notification_template_icon_bg);
                }
            }
            if (r12.mBuilder.mLargeIcon != null) {
                if (android.os.Build.VERSION.SDK_INT >= 16) {
                    r7.setViewVisibility(androidx.core.R.id.icon, 0);
                    r7.setImageViewBitmap(androidx.core.R.id.icon, r12.mBuilder.mLargeIcon);
                } else {
                    r7.setViewVisibility(androidx.core.R.id.icon, 8);
                }
                if (r13 && r12.mBuilder.mNotification.icon != 0) {
                    int r13 = r0.getDimensionPixelSize(androidx.core.R.dimen.notification_right_icon_size);
                    int r14 = r13 - (r0.getDimensionPixelSize(androidx.core.R.dimen.notification_small_icon_background_padding) * 2);
                    if (android.os.Build.VERSION.SDK_INT >= 21) {
                        r7.setImageViewBitmap(androidx.core.R.id.right_icon, createIconWithBackground(r12.mBuilder.mNotification.icon, r13, r14, r12.mBuilder.getColor()));
                    } else {
                        r7.setImageViewBitmap(androidx.core.R.id.right_icon, createColoredBitmap(r12.mBuilder.mNotification.icon, -1));
                    }
                    r7.setViewVisibility(androidx.core.R.id.right_icon, 0);
                }
            } else if (r13 && r12.mBuilder.mNotification.icon != 0) {
                r7.setViewVisibility(androidx.core.R.id.icon, 0);
                if (android.os.Build.VERSION.SDK_INT >= 21) {
                    r7.setImageViewBitmap(androidx.core.R.id.icon, createIconWithBackground(r12.mBuilder.mNotification.icon, r0.getDimensionPixelSize(androidx.core.R.dimen.notification_large_icon_width) - r0.getDimensionPixelSize(androidx.core.R.dimen.notification_big_circle_margin), r0.getDimensionPixelSize(androidx.core.R.dimen.notification_small_icon_size_as_large), r12.mBuilder.getColor()));
                } else {
                    r7.setImageViewBitmap(androidx.core.R.id.icon, createColoredBitmap(r12.mBuilder.mNotification.icon, -1));
                }
            }
            if (r12.mBuilder.mContentTitle != null) {
                r7.setTextViewText(androidx.core.R.id.title, r12.mBuilder.mContentTitle);
            }
            if (r12.mBuilder.mContentText != null) {
                r7.setTextViewText(androidx.core.R.id.text, r12.mBuilder.mContentText);
                r13 = true;
            } else {
                r13 = false;
            }
            boolean r14 = android.os.Build.VERSION.SDK_INT < 21 && r12.mBuilder.mLargeIcon != null;
            if (r12.mBuilder.mContentInfo != null) {
                r7.setTextViewText(androidx.core.R.id.info, r12.mBuilder.mContentInfo);
                r7.setViewVisibility(androidx.core.R.id.info, 0);
            } else if (r12.mBuilder.mNumber > 0) {
                if (r12.mBuilder.mNumber > r0.getInteger(androidx.core.R.integer.status_bar_notification_info_maxnum)) {
                    r7.setTextViewText(androidx.core.R.id.info, r0.getString(androidx.core.R.string.status_bar_notification_info_overflow));
                } else {
                    r7.setTextViewText(androidx.core.R.id.info, java.text.NumberFormat.getIntegerInstance().format(r12.mBuilder.mNumber));
                }
                r7.setViewVisibility(androidx.core.R.id.info, 0);
            } else {
                r7.setViewVisibility(androidx.core.R.id.info, 8);
                if (r12.mBuilder.mSubText != null && android.os.Build.VERSION.SDK_INT >= 16) {
                    r7.setTextViewText(androidx.core.R.id.text, r12.mBuilder.mSubText);
                    if (r12.mBuilder.mContentText == null) {
                        r7.setTextViewText(androidx.core.R.id.text2, r12.mBuilder.mContentText);
                        r7.setViewVisibility(androidx.core.R.id.text2, 0);
                        r1 = true;
                        if (r1 && android.os.Build.VERSION.SDK_INT >= 16) {
                            if (r15) {
                        ...
                        if (r12.mBuilder.getWhenIfShowing() == 0) {
                            r8 = r14;
                        } else if (r12.mBuilder.mUseChronometer && android.os.Build.VERSION.SDK_INT >= 16) {
                            r7.setViewVisibility(androidx.core.R.id.chronometer, 0);
                            r7.setLong(androidx.core.R.id.chronometer, "setBase", r12.mBuilder.getWhenIfShowing() + (android.os.SystemClock.elapsedRealtime() - java.lang.System.currentTimeMillis()));
                            r7.setBoolean(androidx.core.R.id.chronometer, "setStarted", true);
                            if (r12.mBuilder.mChronometerCountDown && android.os.Build.VERSION.SDK_INT >= 24) {
                                r7.setChronometerCountDown(androidx.core.R.id.chronometer, r12.mBuilder.mChronometerCountDown);
                            }
                        } else {
                            r7.setViewVisibility(androidx.core.R.id.time, 0);
                            r7.setLong(androidx.core.R.id.time, "setTime", r12.mBuilder.getWhenIfShowing());
                        }
                        r7.setViewVisibility(androidx.core.R.id.right_side, r8 ? 0 : 8);
                        r7.setViewVisibility(androidx.core.R.id.line3, r13 ? 0 : 8);
                        return r7;
                    }
