...
class FindAddress {
    ...
    */
    private static int attemptMatch(java.lang.String r13, java.util.regex.MatchResult r14) {
        int r13;
        java.util.regex.MatchResult r14;
        int r14 = r14.end();
        java.util.regex.Matcher r0 = androidx.core.text.util.FindAddress.sWordRe.matcher(r13);
        java.lang.String r4 = "";
        int r9 = -1;
        int r10 = -1;
        boolean r8 = false;
        ...
        while (true) {
            if (r14 < r13.length()) {
                if (!r0.find(r14)) {
                    r13 = r13.length();
                    break;
                } else if (r0.end() - r0.start() > 25) {
                    r13 = r0.end();
                    break;
                } else {
                    while (r14 < r0.start()) {
                        int r11 = r14 + 1;
                        if (androidx.core.text.util.FindAddress.NL.indexOf(r13.charAt(r14)) != -1) {
                            r5++;
                        }
                        r14 = r11;
                    }
                    ...
                    if (matchHouseNumber(r13, r14) == null) {
                        if (!isValidLocationName(r0.group(0))) {
                            if (r6 == 5 && !r8) {
                                r14 = r0.end();
                                break;
                            }
                            if (r8 && r6 > 4 && (r14 = matchState(r13, r14)) != null) {
                                if (r4.equals("et") && r14.group(0).equals("al")) {
                                    r14 = r14.end();
                                    break;
                                }
                                java.util.regex.Matcher r4 = androidx.core.text.util.FindAddress.sWordRe.matcher(r13);
                                if (r4.find(r14.end())) {
                                    if (isValidZipCode(r4.group(0), r14)) {
                                        return r4.end();
                                    }
                                } else {
                                    r10 = r14.end();
