...
public final class LinkifyCompat {
    ...
    private static final Comparator<LinkSpec> COMPARATOR = new Comparator() { // from class: androidx.core.text.util.-$$Lambda$LinkifyCompat$ZKIVp-YQfVVlE_POSX3ZpOQbt6w
