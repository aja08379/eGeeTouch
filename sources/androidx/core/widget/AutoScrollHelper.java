...
public abstract class AutoScrollHelper implements View.OnTouchListener {
    ...
    */
    public boolean onTouch(android.view.View r6, android.view.MotionEvent r7) {
        ...
        if (r0 == 0) {
            r5.mNeedsCancel = true;
            r5.mAlreadyDelayed = false;
        } else {
            if (r0 != 1) {
                if (r0 != 2) {
                }
            ...
            requestStop();
            return r5.mExclusive && r5.mAnimating;
        }
        r5.mScroller.setTargetVelocity(computeTargetVelocity(0, r7.getX(), r6.getWidth(), r5.mTarget.getWidth()), computeTargetVelocity(1, r7.getY(), r6.getHeight(), r5.mTarget.getHeight()));
        if (!r5.mAnimating && shouldAnimate()) {
            startAnimating();
        }
        if (r5.mExclusive) {
            return false;
