...
public class NestedScrollView extends FrameLayout implements NestedScrollingParent3, NestedScrollingChild3, ScrollingView {
    ...
    public boolean executeKeyEvent(KeyEvent keyEvent) {
        ...
        int i = TaskManagement.restore_admin;
        if (!canScroll) {
            ...
            View findNextFocus = FocusFinder.getInstance().findNextFocus(this, findFocus, TaskManagement.restore_admin);
            return (findNextFocus == null || findNextFocus == this || !findNextFocus.requestFocus(TaskManagement.restore_admin)) ? false : true;
            ...
            if (keyCode == 19) {
                ...
                if (!keyEvent.isAltPressed()) {
                    return arrowScroll(TaskManagement.restore_admin);
                }
                return fullScroll(TaskManagement.restore_admin);
            } else if (keyCode != 62) {
                return false;
            } else {
    ...
    */
    public boolean onTouchEvent(android.view.MotionEvent r24) {
        ...
        boolean r12 = false;
        if (r0 == 0) {
            r23.mNestedYOffset = 0;
        }
        android.view.MotionEvent r13 = android.view.MotionEvent.obtain(r24);
        r13.offsetLocation(0.0f, r23.mNestedYOffset);
        if (r0 != 0) {
            if (r0 == 1) {
                android.view.VelocityTracker r0 = r23.mVelocityTracker;
                r0.computeCurrentVelocity(1000, r23.mMaximumVelocity);
                int r0 = (int) r0.getYVelocity(r23.mActivePointerId);
                if (java.lang.Math.abs(r0) >= r23.mMinimumVelocity) {
                    if (!edgeEffectFling(r0)) {
                        int r0 = -r0;
                        float r1 = r0;
                        if (!dispatchNestedPreFling(0.0f, r1)) {
                            dispatchNestedFling(0.0f, r1, true);
                            fling(r0);
                        }
                    }
                } else if (r23.mScroller.springBack(getScrollX(), getScrollY(), 0, 0, 0, getScrollRange())) {
                    androidx.core.view.ViewCompat.postInvalidateOnAnimation(r23);
                }
                r23.mActivePointerId = -1;
                endDrag();
            } else if (r0 == 2) {
                int r15 = r24.findPointerIndex(r23.mActivePointerId);
                if (r15 == -1) {
                    android.util.Log.e(androidx.core.widget.NestedScrollView.TAG, "Invalid pointerId=" + r23.mActivePointerId + " in onTouchEvent");
                } else {
                    int r6 = (int) r24.getY(r15);
                    int r0 = r23.mLastMotionY - r6;
                    int r0 = r0 - releaseVerticalGlow(r0, r24.getX(r15));
                    if (!r23.mIsBeingDragged && java.lang.Math.abs(r0) > r23.mTouchSlop) {
                        android.view.ViewParent r1 = getParent();
                        if (r1 != null) {
                            r1.requestDisallowInterceptTouchEvent(true);
                        }
                        r23.mIsBeingDragged = true;
                        r0 = r0 > 0 ? r0 - r23.mTouchSlop : r0 + r23.mTouchSlop;
                    }
                    int r7 = r0;
                    if (r23.mIsBeingDragged) {
                        if (dispatchNestedPreScroll(0, r7, r23.mScrollConsumed, r23.mScrollOffset, 0)) {
                            r7 -= r23.mScrollConsumed[1];
                            r23.mNestedYOffset += r23.mScrollOffset[1];
                        }
                        int r16 = r7;
                        r23.mLastMotionY = r6 - r23.mScrollOffset[1];
                        int r17 = getScrollY();
                        int r9 = getScrollRange();
                        int r0 = getOverScrollMode();
                        boolean r18 = r0 == 0 || (r0 == 1 && r9 > 0);
                        boolean r8 = overScrollByCompat(0, r16, 0, getScrollY(), 0, r9, 0, 0, true) && !hasNestedScrollingParent(0);
                        int r2 = getScrollY() - r17;
                        int[] r7 = r23.mScrollConsumed;
                        r7[1] = 0;
                        dispatchNestedScroll(0, r2, 0, r16 - r2, r23.mScrollOffset, 0, r7);
                        int r0 = r23.mLastMotionY;
                        int[] r1 = r23.mScrollOffset;
                        r23.mLastMotionY = r0 - r1[1];
                        r23.mNestedYOffset += r1[1];
                        if (r18) {
                            int r0 = r16 - r23.mScrollConsumed[1];
                            int r1 = r17 + r0;
                            if (r1 < 0) {
                                androidx.core.widget.EdgeEffectCompat.onPullDistance(r23.mEdgeGlowTop, (-r0) / getHeight(), r24.getX(r15) / getWidth());
                                if (!r23.mEdgeGlowBottom.isFinished()) {
                                    r23.mEdgeGlowBottom.onRelease();
                                }
                            } else if (r1 > r9) {
                                androidx.core.widget.EdgeEffectCompat.onPullDistance(r23.mEdgeGlowBottom, r0 / getHeight(), 1.0f - (r24.getX(r15) / getWidth()));
                                if (!r23.mEdgeGlowTop.isFinished()) {
                                    r23.mEdgeGlowTop.onRelease();
                                }
                            }
                            if (!r23.mEdgeGlowTop.isFinished() || !r23.mEdgeGlowBottom.isFinished()) {
                                androidx.core.view.ViewCompat.postInvalidateOnAnimation(r23);
                                if (r12) {
                                    r23.mVelocityTracker.clear();
                                }
                            }
                        }
                        r12 = r8;
                ...
                if (r23.mIsBeingDragged && getChildCount() > 0 && r23.mScroller.springBack(getScrollX(), getScrollY(), 0, 0, 0, getScrollRange())) {
                    androidx.core.view.ViewCompat.postInvalidateOnAnimation(r23);
                }
                r23.mActivePointerId = -1;
                endDrag();
                ...
                r23.mLastMotionY = (int) r24.getY(r0);
                r23.mActivePointerId = r24.getPointerId(r0);
            } else if (r0 == 6) {
                onSecondaryPointerUp(r24);
                r23.mLastMotionY = (int) r24.getY(r24.findPointerIndex(r23.mActivePointerId));
            }
        } else if (getChildCount() == 0) {
            return false;
        } else {
            if (r23.mIsBeingDragged && (r0 = getParent()) != null) {
                r0.requestDisallowInterceptTouchEvent(true);
            }
            if (!r23.mScroller.isFinished()) {
                abortAnimatedScroll();
            }
            r23.mLastMotionY = (int) r24.getY();
            r23.mActivePointerId = r24.getPointerId(0);
            startNestedScroll(2, 0);
        }
        android.view.VelocityTracker r0 = r23.mVelocityTracker;
        if (r0 != null) {
    ...
    */
    private int releaseVerticalGlow(int r4, float r5) {
        ...
        float r1 = 0.0f;
        if (androidx.core.widget.EdgeEffectCompat.getDistance(r3.mEdgeGlowTop) != 0.0f) {
            r4 = -androidx.core.widget.EdgeEffectCompat.onPullDistance(r3.mEdgeGlowTop, -r4, r5);
            if (androidx.core.widget.EdgeEffectCompat.getDistance(r3.mEdgeGlowTop) == 0.0f) {
                r3.mEdgeGlowTop.onRelease();
            }
        } else {
            if (androidx.core.widget.EdgeEffectCompat.getDistance(r3.mEdgeGlowBottom) != 0.0f) {
                r4 = androidx.core.widget.EdgeEffectCompat.onPullDistance(r3.mEdgeGlowBottom, r4, 1.0f - r5);
                if (androidx.core.widget.EdgeEffectCompat.getDistance(r3.mEdgeGlowBottom) == 0.0f) {
                    r3.mEdgeGlowBottom.onRelease();
                }
            }
            r4 = java.lang.Math.round(r1 * getHeight());
            if (r4 != 0) {
                invalidate();
            }
            return r4;
    ...
    protected boolean onRequestFocusInDescendants(int i, Rect rect) {
        ...
        if (i == 2) {
            i = TaskManagement.restore_admin;
        } else if (i == 1) {
            i = 33;
        }
        if (rect == null) {
