...
public class ShortcutManagerCompat {
    ...
    */
    public static boolean isRequestPinShortcutSupported(android.content.Context r4) {
        if (android.os.Build.VERSION.SDK_INT >= 26) {
            return ((android.content.pm.ShortcutManager) r4.getSystemService(android.content.pm.ShortcutManager.class)).isRequestPinShortcutSupported();
        }
        if (androidx.core.content.ContextCompat.checkSelfPermission(r4, androidx.core.content.pm.ShortcutManagerCompat.INSTALL_SHORTCUT_PERMISSION) != 0) {
            return false;
        }
        for (android.content.pm.ResolveInfo r1 : r4.getPackageManager().queryBroadcastReceivers(new android.content.Intent(androidx.core.content.pm.ShortcutManagerCompat.ACTION_INSTALL_SHORTCUT), 0)) {
            java.lang.String r1 = r1.activityInfo.permission;
            if (android.text.TextUtils.isEmpty(r1) || androidx.core.content.pm.ShortcutManagerCompat.INSTALL_SHORTCUT_PERMISSION.equals(r1)) {
                return true;
            }
            while (r4.hasNext()) {
            }
    ...
    */
    private static java.util.List<androidx.core.content.pm.ShortcutInfoChangeListener> getShortcutInfoListeners(android.content.Context r8) {
        ...
        if (androidx.core.content.pm.ShortcutManagerCompat.sShortcutInfoChangeListeners == null) {
            java.util.ArrayList r0 = new java.util.ArrayList();
            if (android.os.Build.VERSION.SDK_INT >= 21) {
                android.content.pm.PackageManager r1 = r8.getPackageManager();
                android.content.Intent r2 = new android.content.Intent(androidx.core.content.pm.ShortcutManagerCompat.SHORTCUT_LISTENER_INTENT_FILTER_ACTION);
                r2.setPackage(r8.getPackageName());
                for (android.content.pm.ResolveInfo r2 : r1.queryIntentActivities(r2, 128)) {
                    android.content.pm.ActivityInfo r2 = r2.activityInfo;
                    if (r2 != null && (r2 = r2.metaData) != null) {
                        java.lang.String r2 = r2.getString(androidx.core.content.pm.ShortcutManagerCompat.SHORTCUT_LISTENER_META_DATA_KEY);
                        if (r2 != null) {
                            try {
                                r0.add((androidx.core.content.pm.ShortcutInfoChangeListener) java.lang.Class.forName(r2, false, androidx.core.content.pm.ShortcutManagerCompat.class.getClassLoader()).getMethod("getInstance", android.content.Context.class).invoke(null, r8));
        ...
        return androidx.core.content.pm.ShortcutManagerCompat.sShortcutInfoChangeListeners;
    }
