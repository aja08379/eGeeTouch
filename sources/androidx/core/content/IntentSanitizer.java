...
public class IntentSanitizer {
    ...
    public Intent sanitizeByFiltering(Intent intent) {
        return sanitize(intent, new Consumer() { // from class: androidx.core.content.-$$Lambda$IntentSanitizer$cs9npxBvv_qtzxpDgSnPy7MmurY
    ...
    public Intent sanitizeByThrowing(Intent intent) {
        return sanitize(intent, new Consumer() { // from class: androidx.core.content.-$$Lambda$IntentSanitizer$NofwxHOZrEEV1MRTpUn9ROuxIY8
            @Override // androidx.core.util.Consumer
            public final void accept(Object obj) {
    ...
    public static final class Builder {
        ...
        private boolean mAllowSourceBounds;
        private int mAllowedFlags;
        private Predicate<String> mAllowedActions = new Predicate() { // from class: androidx.core.content.-$$Lambda$IntentSanitizer$Builder$JLHq9UnD7GuE-xNJ8qTW9WH_UCM
            @Override // androidx.core.util.Predicate
            public final boolean test(Object obj) {
                return IntentSanitizer.Builder.lambda$new$0((String) obj);
            }
        };
        private Predicate<Uri> mAllowedData = new Predicate() { // from class: androidx.core.content.-$$Lambda$IntentSanitizer$Builder$NqpErgsN-iCCwonMew-IjQVkdTQ
            @Override // androidx.core.util.Predicate
            public final boolean test(Object obj) {
                return IntentSanitizer.Builder.lambda$new$1((Uri) obj);
            }
        };
        private Predicate<String> mAllowedTypes = new Predicate() { // from class: androidx.core.content.-$$Lambda$IntentSanitizer$Builder$4U_GfrIZHjV6ewfvuClRif5BQ4U
            @Override // androidx.core.util.Predicate
            public final boolean test(Object obj) {
                return IntentSanitizer.Builder.lambda$new$2((String) obj);
            }
        };
        private Predicate<String> mAllowedCategories = new Predicate() { // from class: androidx.core.content.-$$Lambda$IntentSanitizer$Builder$QGDXK6Iz77ZiVenuuvMgc-uYOdA
            @Override // androidx.core.util.Predicate
            public final boolean test(Object obj) {
                return IntentSanitizer.Builder.lambda$new$3((String) obj);
            }
        };
        private Predicate<String> mAllowedPackages = new Predicate() { // from class: androidx.core.content.-$$Lambda$IntentSanitizer$Builder$LhhAvyYhT2VWSWan7HxDqulwnIA
            @Override // androidx.core.util.Predicate
            public final boolean test(Object obj) {
                return IntentSanitizer.Builder.lambda$new$4((String) obj);
            }
        };
        private Predicate<ComponentName> mAllowedComponents = new Predicate() { // from class: androidx.core.content.-$$Lambda$IntentSanitizer$Builder$iAMpnB3kBE20tG9-ZfpyJMElSSs
            @Override // androidx.core.util.Predicate
            public final boolean test(Object obj) {
        ...
        private Predicate<Uri> mAllowedClipDataUri = new Predicate() { // from class: androidx.core.content.-$$Lambda$IntentSanitizer$Builder$7_PLI9sHfa-phUU-wfc7c0K0hj4
            @Override // androidx.core.util.Predicate
            public final boolean test(Object obj) {
                return IntentSanitizer.Builder.lambda$new$6((Uri) obj);
            }
        };
        private Predicate<ClipData> mAllowedClipData = new Predicate() { // from class: androidx.core.content.-$$Lambda$IntentSanitizer$Builder$u88Zh5ZHnZ5xxf_Hz5dGwcPRwzU
            @Override // androidx.core.util.Predicate
            public final boolean test(Object obj) {
        ...
        public Builder allowAction(String str) {
            ...
            allowAction(new $$Lambda$IntentSanitizer$Builder$yzjFOqRUGseo4jtNtyZsqFTIwRc(str));
            return this;
        }
        ...
        public Builder allowDataWithAuthority(final String str) {
            Preconditions.checkNotNull(str);
            allowData(new Predicate() { // from class: androidx.core.content.-$$Lambda$IntentSanitizer$Builder$Xpt8uzicbIAL76-81iZQzx_qLWI
                @Override // androidx.core.util.Predicate
                public final boolean test(Object obj) {
                    boolean equals;
        ...
        public Builder allowType(String str) {
            Preconditions.checkNotNull(str);
            Objects.requireNonNull(str);
            return allowType(new $$Lambda$IntentSanitizer$Builder$yzjFOqRUGseo4jtNtyZsqFTIwRc(str));
        }
        ...
        public Builder allowCategory(String str) {
            Preconditions.checkNotNull(str);
            Objects.requireNonNull(str);
            return allowCategory(new $$Lambda$IntentSanitizer$Builder$yzjFOqRUGseo4jtNtyZsqFTIwRc(str));
        }
        ...
        public Builder allowPackage(String str) {
            Preconditions.checkNotNull(str);
            Objects.requireNonNull(str);
            return allowPackage(new $$Lambda$IntentSanitizer$Builder$yzjFOqRUGseo4jtNtyZsqFTIwRc(str));
        }
        ...
        public Builder allowComponent(final ComponentName componentName) {
            ...
            return allowComponent(new Predicate() { // from class: androidx.core.content.-$$Lambda$IntentSanitizer$Builder$f9aU52V4hLVPTW2v-TcMiSk5YDc
                @Override // androidx.core.util.Predicate
                public final boolean test(Object obj) {
                    boolean equals;
        ...
        public Builder allowComponentWithPackage(final String str) {
            Preconditions.checkNotNull(str);
            return allowComponent(new Predicate() { // from class: androidx.core.content.-$$Lambda$IntentSanitizer$Builder$eGekpZtVpL_YVf2hPyzEP-lEMe4
                @Override // androidx.core.util.Predicate
                public final boolean test(Object obj) {
                    boolean equals;
        ...
        public Builder allowAnyComponent() {
            ...
            this.mAllowedComponents = new Predicate() { // from class: androidx.core.content.-$$Lambda$IntentSanitizer$Builder$FsaUUrhV33pck7xEcNErjp6-t-I
                @Override // androidx.core.util.Predicate
                public final boolean test(Object obj) {
        ...
        public Builder allowClipDataUriWithAuthority(final String str) {
            Preconditions.checkNotNull(str);
            return allowClipDataUri(new Predicate() { // from class: androidx.core.content.-$$Lambda$IntentSanitizer$Builder$KxwlvcZEZo6c-8ioUfy-JK8aiwg
                @Override // androidx.core.util.Predicate
                public final boolean test(Object obj) {
                    boolean equals;
                    equals = str.equals(((Uri) obj).getAuthority());
        ...
        public Builder allowExtra(String str, Class<?> cls) {
            return allowExtra(str, cls, new Predicate() { // from class: androidx.core.content.-$$Lambda$IntentSanitizer$Builder$eCvXo7KAaM8a9dmzzdotDaaREs8
                @Override // androidx.core.util.Predicate
                public final boolean test(Object obj) {
        ...
        public <T> Builder allowExtra(String str, final Class<T> cls, final Predicate<T> predicate) {
            ...
            Preconditions.checkNotNull(predicate);
            return allowExtra(str, new Predicate() { // from class: androidx.core.content.-$$Lambda$IntentSanitizer$Builder$mjBYkmM8ToC_lDxhzbaIvMBaWXI
                @Override // androidx.core.util.Predicate
                public final boolean test(Object obj) {
        ...
        public Builder allowExtra(String str, Predicate<Object> predicate) {
            ...
            if (predicate2 == null) {
                predicate2 = new Predicate() { // from class: androidx.core.content.-$$Lambda$IntentSanitizer$Builder$JqtzG9U86Ag945qpBJ8rYic8JJ4
                    @Override // androidx.core.util.Predicate
                    public final boolean test(Object obj) {
        ...
        public Builder allowExtraStreamUriWithAuthority(final String str) {
            Preconditions.checkNotNull(str);
            allowExtra("android.intent.extra.STREAM", Uri.class, new Predicate() { // from class: androidx.core.content.-$$Lambda$IntentSanitizer$Builder$hP04n-Fqyx8Uqjz-Y2cMl4EYTQ4
                @Override // androidx.core.util.Predicate
                public final boolean test(Object obj) {
                    boolean equals;
                    equals = str.equals(((Uri) obj).getAuthority());
        ...
        public Builder allowExtraOutput(final String str) {
            allowExtra("output", Uri.class, new Predicate() { // from class: androidx.core.content.-$$Lambda$IntentSanitizer$Builder$Eddo0m3KohqNd-vDITva-WLNd_s
                @Override // androidx.core.util.Predicate
                public final boolean test(Object obj) {
                    boolean equals;
                    equals = str.equals(((Uri) obj).getAuthority());
    ...
    public static class Api16Impl {
        ...
        */
        static void sanitizeClipData(android.content.Intent r7, android.content.Intent r8, androidx.core.util.Predicate<android.content.ClipData> r9, boolean r10, androidx.core.util.Predicate<android.net.Uri> r11, androidx.core.util.Consumer<java.lang.String> r12) {
            ...
            if (r9 != null && r9.test(r7)) {
                r8.setClipData(r7);
                return;
            }
            android.content.ClipData r1 = null;
            for (int r9 = 0; r9 < r7.getItemCount(); r9++) {
                ...
                if (r10) {
                    ...
                    if (r2.getText() != null) {
                        r12.accept("Item text cannot contain value. Item position: " + r9 + ". Text: " + ((java.lang.Object) r2.getText()));
                    }
                    r3 = null;
                }
                if (r11 == null) {
                    if (r2.getUri() != null) {
                        r12.accept("Item URI is not allowed. Item position: " + r9 + ". URI: " + r2.getUri());
                    }
                } else if (r2.getUri() == null || r11.test(r2.getUri())) {
                    r2 = r2.getUri();
                    if (r3 == null || r2 != null) {
                        if (r1 != null) {
                            r1 = new android.content.ClipData(r7.getDescription(), new android.content.ClipData.Item(r3, null, r2));
                        } else {
                            r1.addItem(new android.content.ClipData.Item(r3, null, r2));
                        }
                    }
                } else {
                    r12.accept("Item URI is not allowed. Item position: " + r9 + ". URI: " + r2.getUri());
