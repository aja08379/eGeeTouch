...
class FontProvider {
    private static final Comparator<byte[]> sByteArrayComparator = new Comparator() { // from class: androidx.core.provider.-$$Lambda$FontProvider$Wi4h7Y1RxUrqSUowKMegxTqKvJo
        ...
        try {
            ...
            if (cursor != null && cursor.getCount() > 0) {
                ...
                while (cursor.moveToNext()) {
                    ...
                    int i6 = columnIndex5 != -1 ? cursor.getInt(columnIndex5) : TitleChanger.DEFAULT_ANIMATION_DELAY;
