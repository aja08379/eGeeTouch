...
final class LocaleListCompatWrapper implements LocaleListInterface {
    ...
    */
    private int computeFirstMatchIndex(java.util.Collection<java.lang.String> r5, boolean r6) {
        ...
        if (r6) {
            r6 = findFirstMatchIndex(androidx.core.os.LocaleListCompatWrapper.EN_LATN);
            if (r6 == 0) {
                return 0;
            }
        }
        r6 = Integer.MAX_VALUE;
        for (java.lang.String r1 : r5) {
            int r1 = findFirstMatchIndex(androidx.core.os.LocaleListCompat.forLanguageTagCompat(r1));
            if (r1 == 0) {
                return 0;
            }
            if (r1 < r6) {
