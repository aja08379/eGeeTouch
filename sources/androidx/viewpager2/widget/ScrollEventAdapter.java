...
public final class ScrollEventAdapter extends RecyclerView.OnScrollListener {
    ...
    */
    public void onScrolled(androidx.recyclerview.widget.RecyclerView r4, int r5, int r6) {
        boolean r5;
        int r5;
        r3.mScrollHappened = true;
        updateScrollEventValues();
        if (r3.mDispatchSelected) {
            r3.mDispatchSelected = false;
            if (r6 <= 0) {
                if (r6 == 0) {
                }
                r5 = false;
                r5 = (r5 || r3.mScrollValues.mOffsetPx == 0) ? r3.mScrollValues.mPosition : r3.mScrollValues.mPosition + 1;
                r3.mTarget = r5;
                if (r3.mDragStartPosition != r5) {
                    dispatchSelected(r5);
                }
            }
            r5 = true;
        ...
        } else if (r3.mAdapterState == 0) {
            int r5 = r3.mScrollValues.mPosition;
            if (r5 == -1) {
                r5 = 0;
            }
            dispatchSelected(r5);
        }
        dispatchScrolled(r3.mScrollValues.mPosition == -1 ? 0 : r3.mScrollValues.mPosition, r3.mScrollValues.mOffset, r3.mScrollValues.mOffsetPx);
        int r5 = r3.mScrollValues.mPosition;
        int r6 = r3.mTarget;
        if ((r5 == r6 || r6 == -1) && r3.mScrollValues.mOffsetPx == 0 && r3.mScrollState != 1) {
            dispatchStateChanged(0);
            resetState();
        }
    }
