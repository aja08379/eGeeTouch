...
public class StaggeredGridLayoutManager extends RecyclerView.LayoutManager implements RecyclerView.SmoothScroller.ScrollVectorProvider {
    ...
    */
    android.view.View hasGapsToFix() {
        ...
        java.util.BitSet r2 = new java.util.BitSet(r12.mSpanCount);
        r2.set(0, r12.mSpanCount, true);
        char r3 = (r12.mOrientation == 1 && isLayoutRTL()) ? (char) 1 : (char) 65535;
        if (r12.mShouldReverseLayout) {
            r6 = -1;
        } else {
            r6 = r0 + 1;
            r0 = 0;
        ...
        int r5 = r0 < r6 ? 1 : -1;
        while (r0 != r6) {
            android.view.View r7 = getChildAt(r0);
            androidx.recyclerview.widget.StaggeredGridLayoutManager.LayoutParams r8 = (androidx.recyclerview.widget.StaggeredGridLayoutManager.LayoutParams) r7.getLayoutParams();
            if (r2.get(r8.mSpan.mIndex)) {
                if (checkSpanForGap(r8.mSpan)) {
                    return r7;
                }
                r2.clear(r8.mSpan.mIndex);
            }
            if (!r8.mFullSpan && (r9 = r0 + r5) != r6) {
                android.view.View r9 = getChildAt(r9);
                if (r12.mShouldReverseLayout) {
                    int r10 = r12.mPrimaryOrientation.getDecoratedEnd(r7);
                    int r11 = r12.mPrimaryOrientation.getDecoratedEnd(r9);
                    if (r10 < r11) {
                        return r7;
                    }
                } else {
                    int r10 = r12.mPrimaryOrientation.getDecoratedStart(r7);
                    int r11 = r12.mPrimaryOrientation.getDecoratedStart(r9);
                    if (r10 > r11) {
                        return r7;
                    }
                }
                if (r10) {
                    if ((r8.mSpan.mIndex - ((androidx.recyclerview.widget.StaggeredGridLayoutManager.LayoutParams) r9.getLayoutParams()).mSpan.mIndex < 0) != (r3 < 0)) {
                        return r7;
                    }
                } else {
                    continue;
    ...
    */
    private void onLayoutChildren(androidx.recyclerview.widget.RecyclerView.Recycler r9, androidx.recyclerview.widget.RecyclerView.State r10, boolean r11) {
        ...
        if ((r8.mPendingSavedState != null || r8.mPendingScrollPosition != -1) && r10.getItemCount() == 0) {
            removeAndRecycleAllViews(r9);
            r0.reset();
            return;
        }
        boolean r4 = true;
        boolean r1 = (r0.mValid && r8.mPendingScrollPosition == -1 && r8.mPendingSavedState == null) ? false : true;
        if (r1) {
            r0.reset();
            if (r8.mPendingSavedState != null) {
                applyPendingSavedState(r0);
            } else {
                resolveShouldLayoutReverse();
                r0.mLayoutFromEnd = r8.mShouldReverseLayout;
            }
            updateAnchorInfoForLayout(r10, r0);
            r0.mValid = true;
        }
        if (r8.mPendingSavedState == null && r8.mPendingScrollPosition == -1 && (r0.mLayoutFromEnd != r8.mLastLayoutFromEnd || isLayoutRTL() != r8.mLastLayoutRTL)) {
            r8.mLazySpanLookup.clear();
            r0.mInvalidateOffsets = true;
        }
        if (getChildCount() > 0 && ((r5 = r8.mPendingSavedState) == null || r5.mSpanOffsetsSize < 1)) {
            if (r0.mInvalidateOffsets) {
                for (int r1 = 0; r1 < r8.mSpanCount; r1++) {
                    r8.mSpans[r1].clear();
                    if (r0.mOffset != Integer.MIN_VALUE) {
                        r8.mSpans[r1].setLine(r0.mOffset);
                    }
                }
            } else if (r1 || r8.mAnchorInfo.mSpanReferenceLines == null) {
                for (int r1 = 0; r1 < r8.mSpanCount; r1++) {
                    r8.mSpans[r1].cacheReferenceLineAndClear(r8.mShouldReverseLayout, r0.mOffset);
                }
                r8.mAnchorInfo.saveSpanReferenceLines(r8.mSpans);
            } else {
                for (int r1 = 0; r1 < r8.mSpanCount; r1++) {
                    androidx.recyclerview.widget.StaggeredGridLayoutManager.Span r5 = r8.mSpans[r1];
                    r5.clear();
                    r5.setLine(r8.mAnchorInfo.mSpanReferenceLines[r1]);
                }
            }
        }
        detachAndScrapAttachedViews(r9);
        r8.mLayoutState.mRecycle = false;
        r8.mLaidOutInvalidFullSpan = false;
        updateMeasureSpecs(r8.mSecondaryOrientation.getTotalSpace());
        updateLayoutState(r0.mPosition, r10);
        if (r0.mLayoutFromEnd) {
            setLayoutStateDirection(-1);
            fill(r9, r8.mLayoutState, r10);
            setLayoutStateDirection(1);
            r8.mLayoutState.mCurrentPosition = r0.mPosition + r8.mLayoutState.mItemDirection;
            fill(r9, r8.mLayoutState, r10);
        } else {
            setLayoutStateDirection(1);
            fill(r9, r8.mLayoutState, r10);
        ...
        if (getChildCount() > 0) {
            if (r8.mShouldReverseLayout) {
                fixEndGap(r9, r10, true);
                fixStartGap(r9, r10, false);
            } else {
                fixStartGap(r9, r10, true);
                fixEndGap(r9, r10, false);
            }
        }
        if (r11 && !r10.isPreLayout()) {
            if (r8.mGapStrategy != 0 && getChildCount() > 0 && (r8.mLaidOutInvalidFullSpan || hasGapsToFix() != null)) {
                removeCallbacks(r8.mCheckForGapsRunnable);
            }
        }
        r4 = false;
        if (r10.isPreLayout()) {
            r8.mAnchorInfo.reset();
        }
        r8.mLastLayoutFromEnd = r0.mLayoutFromEnd;
        r8.mLastLayoutRTL = isLayoutRTL();
        if (r4) {
            r8.mAnchorInfo.reset();
            onLayoutChildren(r9, r10, false);
        }
    }
    ...
    */
    private void handleUpdate(int r7, int r8, int r9) {
        int r2;
        int r3;
        int r0 = r6.mShouldReverseLayout ? getLastChildPosition() : getFirstChildPosition();
        if (r9 != 8) {
            r2 = r7 + r8;
        } else if (r7 >= r8) {
            r2 = r7 + 1;
            r3 = r8;
            r6.mLazySpanLookup.invalidateAfter(r3);
            if (r9 != 1) {
                r6.mLazySpanLookup.offsetForAddition(r7, r8);
            } else if (r9 == 2) {
                r6.mLazySpanLookup.offsetForRemoval(r7, r8);
            } else if (r9 == 8) {
                r6.mLazySpanLookup.offsetForRemoval(r7, 1);
                r6.mLazySpanLookup.offsetForAddition(r8, 1);
            }
            if (r2 > r0) {
                return;
            }
            if (r3 <= (r6.mShouldReverseLayout ? getFirstChildPosition() : getLastChildPosition())) {
                requestLayout();
                return;
            }
            return;
