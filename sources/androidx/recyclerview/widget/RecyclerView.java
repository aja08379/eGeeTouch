...
public class RecyclerView extends ViewGroup implements ScrollingView, NestedScrollingChild2, NestedScrollingChild3 {
    ...
    */
    private void pullGlows(float r7, float r8, float r9, float r10) {
        ...
        if (r8 < 0.0f) {
            ensureLeftGlow();
            androidx.core.widget.EdgeEffectCompat.onPull(r6.mLeftGlow, (-r8) / getWidth(), 1.0f - (r9 / getHeight()));
        } else if (r8 <= 0.0f) {
            r9 = false;
            if (r10 >= 0.0f) {
                ensureTopGlow();
                androidx.core.widget.EdgeEffectCompat.onPull(r6.mTopGlow, (-r10) / getHeight(), r7 / getWidth());
            } else if (r10 > 0.0f) {
                ensureBottomGlow();
                androidx.core.widget.EdgeEffectCompat.onPull(r6.mBottomGlow, r10 / getHeight(), 1.0f - (r7 / getWidth()));
            } else {
                r3 = r9;
            }
            if (r3 && r8 == 0.0f && r10 == 0.0f) {
                return;
            }
            androidx.core.view.ViewCompat.postInvalidateOnAnimation(r6);
        } else {
            ensureRightGlow();
            androidx.core.widget.EdgeEffectCompat.onPull(r6.mRightGlow, r8 / getWidth(), r9 / getHeight());
        }
        r9 = true;
        if (r10 >= 0.0f) {
        }
    ...
    public View focusSearch(View view, int i) {
        ...
        if (z2 && (i == 2 || i == 1)) {
            if (this.mLayout.canScrollVertically()) {
                int i2 = i == 2 ? TaskManagement.restore_admin : 33;
    ...
    */
    public boolean onTouchEvent(android.view.MotionEvent r18) {
        boolean r2;
        boolean r8 = false;
        if (r17.mLayoutSuppressed || r17.mIgnoreMotionEventTillDown) {
            return false;
        }
        if (dispatchToOnItemTouchListeners(r18)) {
            cancelScroll();
            return true;
        }
        androidx.recyclerview.widget.RecyclerView.LayoutManager r0 = r17.mLayout;
        if (r0 == null) {
            return false;
        }
        boolean r10 = r0.canScrollHorizontally();
        boolean r11 = r17.mLayout.canScrollVertically();
        if (r17.mVelocityTracker == null) {
            r17.mVelocityTracker = android.view.VelocityTracker.obtain();
        }
        int r0 = r18.getActionMasked();
        int r1 = r18.getActionIndex();
        if (r0 == 0) {
            int[] r2 = r17.mNestedOffsets;
            r2[1] = 0;
            r2[0] = 0;
        }
        android.view.MotionEvent r12 = android.view.MotionEvent.obtain(r18);
        int[] r2 = r17.mNestedOffsets;
        r12.offsetLocation(r2[0], r2[1]);
        if (r0 == 0) {
            r17.mScrollPointerId = r18.getPointerId(0);
            int r0 = (int) (r18.getX() + 0.5f);
            r17.mLastTouchX = r0;
            r17.mInitialTouchX = r0;
            int r0 = (int) (r18.getY() + 0.5f);
            r17.mLastTouchY = r0;
            ...
            float r1 = r10 ? -r17.mVelocityTracker.getXVelocity(r17.mScrollPointerId) : 0.0f;
            float r2 = r11 ? -r17.mVelocityTracker.getYVelocity(r17.mScrollPointerId) : 0.0f;
            if ((r1 == 0.0f && r2 == 0.0f) || !fling((int) r1, (int) r2)) {
                setScrollState(0);
            }
            resetScroll();
            r8 = true;
        } else if (r0 == 2) {
            int r0 = r18.findPointerIndex(r17.mScrollPointerId);
            if (r0 < 0) {
                android.util.Log.e(androidx.recyclerview.widget.RecyclerView.TAG, "Error processing scroll; pointer index for id " + r17.mScrollPointerId + " not found. Did any MotionEvents get skipped?");
                return false;
            }
            int r13 = (int) (r18.getX(r0) + 0.5f);
            int r14 = (int) (r18.getY(r0) + 0.5f);
            int r0 = r17.mLastTouchX - r13;
            int r1 = r17.mLastTouchY - r14;
            if (r17.mScrollState != 1) {
                if (r10) {
                    if (r0 > 0) {
                        r0 = java.lang.Math.max(0, r0 - r17.mTouchSlop);
                    } else {
                        r0 = java.lang.Math.min(0, r0 + r17.mTouchSlop);
                    }
                    if (r0 != 0) {
                        r2 = true;
                        if (r11) {
            ...
            int r16 = r1;
            if (r17.mScrollState == 1) {
                int[] r3 = r17.mReusableIntPair;
                r3[0] = 0;
                r3[1] = 0;
                if (dispatchNestedPreScroll(r10 ? r15 : 0, r11 ? r16 : 0, r3, r17.mScrollOffset, 0)) {
                    int[] r0 = r17.mReusableIntPair;
                    r15 -= r0[0];
                    r16 -= r0[1];
                    int[] r0 = r17.mNestedOffsets;
                    int r1 = r0[0];
                    int[] r2 = r17.mScrollOffset;
                    r0[0] = r1 + r2[0];
                    r0[1] = r0[1] + r2[1];
                    getParent().requestDisallowInterceptTouchEvent(true);
                }
                int r0 = r16;
                int[] r1 = r17.mScrollOffset;
                r17.mLastTouchX = r13 - r1[0];
                r17.mLastTouchY = r14 - r1[1];
                if (scrollByInternal(r10 ? r15 : 0, r11 ? r0 : 0, r18, 0)) {
                    getParent().requestDisallowInterceptTouchEvent(true);
                }
                androidx.recyclerview.widget.GapWorker r1 = r17.mGapWorker;
                if (r1 != null && (r15 != 0 || r0 != 0)) {
                    r1.postFromTraversal(r17, r15, r0);
                }
            }
        } else if (r0 == 3) {
            cancelScroll();
        } else if (r0 == 5) {
            r17.mScrollPointerId = r18.getPointerId(r1);
            int r0 = (int) (r18.getX(r1) + 0.5f);
            r17.mLastTouchX = r0;
            r17.mInitialTouchX = r0;
            int r0 = (int) (r18.getY(r1) + 0.5f);
            r17.mLastTouchY = r0;
            r17.mInitialTouchY = r0;
        } else if (r0 == 6) {
            onPointerUp(r18);
    ...
    */
    public boolean onGenericMotionEvent(android.view.MotionEvent r6) {
        float r0;
        float r3;
        if (r5.mLayout != null && !r5.mLayoutSuppressed && r6.getAction() == 8) {
            if ((r6.getSource() & 2) != 0) {
                r0 = r5.mLayout.canScrollVertically() ? -r6.getAxisValue(9) : 0.0f;
                if (r5.mLayout.canScrollHorizontally()) {
                    r3 = r6.getAxisValue(10);
                    if (r0 == 0.0f || r3 != 0.0f) {
                        nestedScrollByInternal((int) (r3 * r5.mScaledHorizontalScrollFactor), (int) (r0 * r5.mScaledVerticalScrollFactor), r6, 1);
                    }
                }
                r3 = 0.0f;
                if (r0 == 0.0f) {
                ...
                if ((r6.getSource() & 4194304) != 0) {
                    float r0 = r6.getAxisValue(26);
                    if (!r5.mLayout.canScrollVertically()) {
                        if (r5.mLayout.canScrollHorizontally()) {
                            r3 = r0;
                            r0 = 0.0f;
                            if (r0 == 0.0f) {
    ...
    */
    public android.view.View findContainingItemView(android.view.View r3) {
        ...
        while (r0 != null && r0 != r2 && (r0 instanceof android.view.View)) {
    ...
    */
    androidx.recyclerview.widget.RecyclerView.ViewHolder findViewHolderForPosition(int r6, boolean r7) {
        int r0 = r5.mChildHelper.getUnfilteredChildCount();
        androidx.recyclerview.widget.RecyclerView.ViewHolder r1 = null;
        for (int r2 = 0; r2 < r0; r2++) {
            androidx.recyclerview.widget.RecyclerView.ViewHolder r3 = getChildViewHolderInt(r5.mChildHelper.getUnfilteredChildAt(r2));
            if (r3 != null && !r3.isRemoved()) {
                if (r7) {
                    if (r3.mPosition != r6) {
                        continue;
                    }
                    if (r5.mChildHelper.isHidden(r3.itemView)) {
                        return r3;
                    }
                    r1 = r3;
                } else {
                    if (r3.getLayoutPosition() != r6) {
                        continue;
                    }
                    if (r5.mChildHelper.isHidden(r3.itemView)) {
                    }
    ...
    public final class Recycler {
        ...
        */
        public androidx.recyclerview.widget.RecyclerView.ViewHolder tryGetViewHolderForPositionByDeadline(int r17, boolean r18, long r19) {
            ...
            boolean r4;
            androidx.recyclerview.widget.RecyclerView.ViewHolder r9;
            boolean r10;
            boolean r0;
            ...
            if (r17 < 0 || r17 >= androidx.recyclerview.widget.RecyclerView.this.mState.getItemCount()) {
                throw new java.lang.IndexOutOfBoundsException("Invalid item position " + r17 + "(" + r17 + "). Item count:" + androidx.recyclerview.widget.RecyclerView.this.mState.getItemCount() + androidx.recyclerview.widget.RecyclerView.this.exceptionLabel());
            }
            boolean r7 = true;
            if (androidx.recyclerview.widget.RecyclerView.this.mState.isPreLayout()) {
                r1 = getChangedScrapViewForPosition(r17);
                if (r1 != null) {
                    r4 = true;
                    if (r1 == null && (r1 = getScrapOrHiddenOrCachedHolderForPosition(r17, r18)) != null) {
                        if (validateViewHolderForOffsetPosition(r1)) {
                            if (!r18) {
                                r1.addFlags(4);
                                if (r1.isScrap()) {
                                    androidx.recyclerview.widget.RecyclerView.this.removeDetachedView(r1.itemView, false);
                                    r1.unScrap();
                                } else if (r1.wasReturnedFromScrap()) {
                    ...
                    if (r1 == null) {
                        int r5 = androidx.recyclerview.widget.RecyclerView.this.mAdapterHelper.findPositionOffset(r17);
                        if (r5 < 0 || r5 >= androidx.recyclerview.widget.RecyclerView.this.mAdapter.getItemCount()) {
                            throw new java.lang.IndexOutOfBoundsException("Inconsistency detected. Invalid item position " + r17 + "(offset:" + r5 + ").state:" + androidx.recyclerview.widget.RecyclerView.this.mState.getItemCount() + androidx.recyclerview.widget.RecyclerView.this.exceptionLabel());
                        }
                        int r9 = androidx.recyclerview.widget.RecyclerView.this.mAdapter.getItemViewType(r5);
                        if (androidx.recyclerview.widget.RecyclerView.this.mAdapter.hasStableIds() && (r1 = getScrapOrCachedViewForId(androidx.recyclerview.widget.RecyclerView.this.mAdapter.getItemId(r5), r9, r18)) != null) {
                            r1.mPosition = r5;
                            r4 = true;
                        }
                        if (r1 == null && (r0 = r16.mViewCacheExtension) != null && (r0 = r0.getViewForPositionAndType(r16, r17, r9)) != null) {
                            r1 = androidx.recyclerview.widget.RecyclerView.this.getChildViewHolder(r0);
                            if (r1 == null) {
                        ...
                        if (r1 == null) {
                            androidx.recyclerview.widget.RecyclerView.ViewHolder r0 = getRecycledViewPool().getRecycledView(r9);
                            if (r0 != null) {
                                r0.resetInternal();
                        ...
                        if (r1 == null) {
                            long r0 = androidx.recyclerview.widget.RecyclerView.this.getNanoTime();
                            if (r19 == Long.MAX_VALUE || r16.mRecyclerPool.willCreateInTime(r9, r0, r19)) {
                                androidx.recyclerview.widget.RecyclerView.ViewHolder r2 = androidx.recyclerview.widget.RecyclerView.this.mAdapter.createViewHolder(androidx.recyclerview.widget.RecyclerView.this, r9);
                                if (androidx.recyclerview.widget.RecyclerView.ALLOW_THREAD_GAP_WORK && (r5 = androidx.recyclerview.widget.RecyclerView.findNestedRecyclerView(r2.itemView)) != null) {
                                    r2.mNestedRecyclerView = new java.lang.ref.WeakReference<>(r5);
                                }
                                r16.mRecyclerPool.factorInCreateTime(r9, androidx.recyclerview.widget.RecyclerView.this.getNanoTime() - r0);
                                r9 = r2;
                                r10 = r4;
                                if (r10 && !androidx.recyclerview.widget.RecyclerView.this.mState.isPreLayout() && r9.hasAnyOfTheFlags(8192)) {
                                    r9.setFlags(0, 8192);
                                    if (androidx.recyclerview.widget.RecyclerView.this.mState.mRunSimpleAnimations) {
                                        androidx.recyclerview.widget.RecyclerView.this.recordAnimationInfoIfBouncedHiddenView(r9, androidx.recyclerview.widget.RecyclerView.this.mItemAnimator.recordPreLayoutInformation(androidx.recyclerview.widget.RecyclerView.this.mState, r9, androidx.recyclerview.widget.RecyclerView.ItemAnimator.buildAdapterChangeFlagsForAnimations(r9) | 4096, r9.getUnmodifiedPayloads()));
                                    }
                                }
                                if (!androidx.recyclerview.widget.RecyclerView.this.mState.isPreLayout() && r9.isBound()) {
                                    r9.mPreLayoutPosition = r17;
                                } else if (r9.isBound() || r9.needsUpdate() || r9.isInvalid()) {
                                    r0 = tryBindViewHolderByDeadline(r9, androidx.recyclerview.widget.RecyclerView.this.mAdapterHelper.findPositionOffset(r17), r17, r19);
                                    r1 = r9.itemView.getLayoutParams();
                                    if (r1 != null) {
                                        r1 = (androidx.recyclerview.widget.RecyclerView.LayoutParams) androidx.recyclerview.widget.RecyclerView.this.generateDefaultLayoutParams();
                                        r9.itemView.setLayoutParams(r1);
                                    } else if (!androidx.recyclerview.widget.RecyclerView.this.checkLayoutParams(r1)) {
                                        r1 = (androidx.recyclerview.widget.RecyclerView.LayoutParams) androidx.recyclerview.widget.RecyclerView.this.generateLayoutParams(r1);
                                        r9.itemView.setLayoutParams(r1);
                                    } else {
    ...
    public static abstract class LayoutManager {
        ...
        */
        public static int getChildMeasureSpec(int r1, int r2, int r3, boolean r4) {
            int r1 = r1 - r2;
            int r2 = 0;
            int r1 = java.lang.Math.max(0, r1);
            if (!r4) {
                if (r3 < 0) {
                    if (r3 == -1) {
                        r3 = r1;
            ...
            return android.view.View.MeasureSpec.makeMeasureSpec(r3, r2);
        }
        ...
        */
        public static int getChildMeasureSpec(int r4, int r5, int r6, int r7, boolean r8) {
            int r4 = java.lang.Math.max(0, r4 - r6);
            if (r8) {
                if (r7 < 0) {
                    if (r7 == -1) {
                ...
                if (r7 < 0) {
                    if (r7 != -1) {
                        if (r7 == -2) {
                            if (r5 == Integer.MIN_VALUE || r5 == 1073741824) {
                                r7 = r4;
            ...
            return android.view.View.MeasureSpec.makeMeasureSpec(r7, r5);
        }
