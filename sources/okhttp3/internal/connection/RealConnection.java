...
public final class RealConnection extends Http2Connection.Listener implements Connection {
    ...
    */
    public void connect(int r17, int r18, int r19, int r20, boolean r21, okhttp3.Call r22, okhttp3.EventListener r23) {
        if (r16.protocol != null) {
            throw new java.lang.IllegalStateException("already connected");
        }
        java.util.List<okhttp3.ConnectionSpec> r0 = r16.route.address().connectionSpecs();
        okhttp3.internal.connection.ConnectionSpecSelector r10 = new okhttp3.internal.connection.ConnectionSpecSelector(r0);
        if (r16.route.address().sslSocketFactory() == null) {
            if (!r0.contains(okhttp3.ConnectionSpec.CLEARTEXT)) {
            ...
            java.lang.String r0 = r16.route.address().url().host();
            if (!okhttp3.internal.platform.Platform.get().isCleartextTrafficPermitted(r0)) {
                throw new okhttp3.internal.connection.RouteException(new java.net.UnknownServiceException("CLEARTEXT communication to " + r0 + " not permitted by network security policy"));
            }
        } else if (r16.route.address().protocols().contains(okhttp3.Protocol.H2_PRIOR_KNOWLEDGE)) {
        ...
        okhttp3.internal.connection.RouteException r12 = null;
        do {
            try {
                try {
                    if (r16.route.requiresTunnel()) {
                        connectTunnel(r17, r18, r19, r22, r23);
                        if (r16.rawSocket == null) {
                            if (!r16.route.requiresTunnel() && r16.rawSocket == null) {
                                throw new okhttp3.internal.connection.RouteException(new java.net.ProtocolException("Too many tunnel connections attempted: 21"));
                            }
                            if (r16.http2Connection == null) {
                                synchronized (r16.connectionPool) {
                                    r16.allocationLimit = r16.http2Connection.maxConcurrentStreams();
                                }
                                return;
                            }
                            return;
                        ...
                        try {
                            connectSocket(r17, r18, r22, r23);
                        } catch (java.io.IOException e) {
                            r0 = e;
                            okhttp3.internal.Util.closeQuietly(r16.socket);
                            okhttp3.internal.Util.closeQuietly(r16.rawSocket);
                            r16.socket = null;
                            r16.rawSocket = null;
                            r16.source = null;
                            r16.sink = null;
                            r16.handshake = null;
                            r16.protocol = null;
                            r16.http2Connection = null;
                            r23.connectFailed(r22, r16.route.socketAddress(), r16.route.proxy(), null, r0);
                            if (r12 != null) {
                                r12 = new okhttp3.internal.connection.RouteException(r0);
                            } else {
                                r12.addConnectException(r0);
                            }
                            if (!r21 || r10.connectionFailed(r0)) {
                                throw r12;
                            }
                            do {
                                if (r16.route.requiresTunnel()) {
                                }
                                establishProtocol(r10, r20, r22, r23);
                                r23.connectEnd(r22, r16.route.socketAddress(), r16.route.proxy(), r16.protocol);
                                if (!r16.route.requiresTunnel()) {
                                }
                                if (r16.http2Connection == null) {
                                }
                            } while (r10.connectionFailed(r0));
                            throw r12;
                        }
                    }
                    establishProtocol(r10, r20, r22, r23);
