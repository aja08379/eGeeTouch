...
public final class CacheStrategy {
    ...
    */
    public static boolean isCacheable(okhttp3.Response r3, okhttp3.Request r4) {
        int r0 = r3.code();
        if (r0 != 200 && r0 != 410 && r0 != 414 && r0 != 501 && r0 != 203 && r0 != 204) {
            if (r0 != 307) {
                if (r0 != 308 && r0 != 404 && r0 != 405) {
                    switch (r0) {
                        case 300:
                        case 301:
                            break;
            ...
            if (r3.header("Expires") == null) {
                if (r3.cacheControl().maxAgeSeconds() == -1) {
                    if (!r3.cacheControl().isPublic()) {
                    }
                }
            }
        }
        return (r3.cacheControl().noStore() || r4.cacheControl().noStore()) ? false : true;
    }
