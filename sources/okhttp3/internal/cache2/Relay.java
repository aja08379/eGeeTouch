    ...
    class RelaySource implements Source {
        ...
        */
        public long read(okio.Buffer r22, long r23) throws java.io.IOException {
            boolean r0;
            if (r21.fileOperator == null) {
                throw new java.lang.IllegalStateException("closed");
            }
            synchronized (okhttp3.internal.cache2.Relay.this) {
                while (true) {
                    long r5 = r21.sourcePos;
                    long r7 = okhttp3.internal.cache2.Relay.this.upstreamPos;
                    if (r5 == r7) {
                        if (!okhttp3.internal.cache2.Relay.this.complete) {
                            if (okhttp3.internal.cache2.Relay.this.upstreamReader != null) {
                                r21.timeout.waitUntilNotified(okhttp3.internal.cache2.Relay.this);
                            } else {
                        ...
                        long r11 = r7 - okhttp3.internal.cache2.Relay.this.buffer.size();
                        long r13 = r21.sourcePos;
                        if (r13 >= r11) {
                            long r2 = java.lang.Math.min(r23, r7 - r13);
                            okhttp3.internal.cache2.Relay.this.buffer.copyTo(r22, r21.sourcePos - r11, r2);
                            r21.sourcePos += r2;
                            return r2;
                        }
                        r0 = true;
