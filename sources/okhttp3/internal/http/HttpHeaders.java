    ...
    private static void parseChallengeHeader(java.util.List<okhttp3.Challenge> r8, okio.Buffer r9) {
        ...
        while (true) {
            ...
            while (true) {
                ...
                if (r3 == null) {
                    if (r9.exhausted()) {
                        r8.add(new okhttp3.Challenge(r1, java.util.Collections.emptyMap()));
                        return;
                    }
                    return;
                }
                r5 = skipAll(r9, (byte) 61);
                boolean r6 = skipWhitespaceAndCommas(r9);
                if (r2 || (!r6 && !r9.exhausted())) {
                    r2 = new java.util.LinkedHashMap();
                    int r5 = r5 + skipAll(r9, (byte) 61);
                    while (true) {
                        if (r3 == null) {
                            r3 = readToken(r9);
                            if (skipWhitespaceAndCommas(r9)) {
                                break;
                            }
                            r5 = skipAll(r9, (byte) 61);
                        }
                        if (r5 == 0) {
                            break;
                        } else if (r5 > 1 || skipWhitespaceAndCommas(r9)) {
                            return;
                        } else {
                            if (!r9.exhausted() && r9.getByte(0L) == 34) {
                                r6 = readQuotedString(r9);
                            } else {
                                r6 = readToken(r9);
                            }
                            if (r6 == null || ((java.lang.String) r2.put(r3, r6)) != null) {
                                return;
                            }
                            if (!skipWhitespaceAndCommas(r9) && !r9.exhausted()) {
                                return;
                            }
                            r3 = null;
                        }
                ...
                r8.add(new okhttp3.Challenge(r1, r2));
                r1 = r3;
            }
            r8.add(new okhttp3.Challenge(r1, java.util.Collections.singletonMap(null, r3 + repeat('=', r5))));
        }
    }
