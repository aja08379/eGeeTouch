    ...
    static final class Writer {
        ...
        */
        public void writeHeaders(java.util.List<okhttp3.internal.http2.Header> r14) throws java.io.IOException {
            int r6;
            int r9;
            if (r13.emitDynamicTableSizeUpdate) {
                int r0 = r13.smallestHeaderTableSizeSetting;
                if (r0 < r13.maxDynamicTableByteCount) {
                    writeInt(r0, 31, 32);
                }
                r13.emitDynamicTableSizeUpdate = false;
                r13.smallestHeaderTableSizeSetting = Integer.MAX_VALUE;
                writeInt(r13.maxDynamicTableByteCount, 31, 32);
            }
            int r0 = r14.size();
            for (int r2 = 0; r2 < r0; r2++) {
                okhttp3.internal.http2.Header r3 = r14.get(r2);
                okio.ByteString r4 = r3.name.toAsciiLowercase();
                okio.ByteString r5 = r3.value;
                java.lang.Integer r6 = okhttp3.internal.http2.Hpack.NAME_TO_FIRST_INDEX.get(r4);
                if (r6 != null) {
                    r6 = r6.intValue() + 1;
                    if (r6 > 1 && r6 < 8) {
                        if (!okhttp3.internal.Util.equal(okhttp3.internal.http2.Hpack.STATIC_HEADER_TABLE[r6 - 1].value, r5)) {
                            if (okhttp3.internal.Util.equal(okhttp3.internal.http2.Hpack.STATIC_HEADER_TABLE[r6].value, r5)) {
                                r9 = r6;
                                r6++;
                                if (r6 == -1) {
                                    int r10 = r13.nextHeaderIndex + 1;
                                    int r8 = r13.dynamicTable.length;
                                    while (true) {
                                        if (r10 >= r8) {
                                            break;
                                        }
                                        if (okhttp3.internal.Util.equal(r13.dynamicTable[r10].name, r4)) {
                                            if (okhttp3.internal.Util.equal(r13.dynamicTable[r10].value, r5)) {
                                                r6 = okhttp3.internal.http2.Hpack.STATIC_HEADER_TABLE.length + (r10 - r13.nextHeaderIndex);
                                                break;
                                            } else if (r9 == -1) {
                                                r9 = (r10 - r13.nextHeaderIndex) + okhttp3.internal.http2.Hpack.STATIC_HEADER_TABLE.length;
                                            }
                                        }
                                        r10++;
                                    }
                                ...
                                if (r6 != -1) {
                                    writeInt(r6, okhttp3.internal.http2.Hpack.PREFIX_7_BITS, 128);
                                } else if (r9 == -1) {
                                    r13.out.writeByte(64);
                                    writeByteString(r4);
                                    writeByteString(r5);
                                    insertIntoDynamicTable(r3);
                                } else if (r4.startsWith(okhttp3.internal.http2.Header.PSEUDO_PREFIX) && !okhttp3.internal.http2.Header.TARGET_AUTHORITY.equals(r4)) {
                                    writeInt(r9, 15, 0);
                                    writeByteString(r5);
                                } else {
                                    writeInt(r9, 63, 64);
