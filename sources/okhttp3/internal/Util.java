    ...
    private static java.net.InetAddress decodeIpv6(java.lang.String r11, int r12, int r13) {
        ...
        while (true) {
            if (r12 < r13) {
                if (r4 != 16) {
                    int r8 = r12 + 2;
                    if (r8 <= r13 && r11.regionMatches(r12, "::", 0, 2)) {
                        if (r5 == -1) {
                            r4 += 2;
                            r5 = r4;
                            if (r8 != r13) {
                    ...
                    if (r4 != 0) {
                        if (r11.regionMatches(r12, ":", 0, 1)) {
                            r12++;
                        } else if (!r11.regionMatches(r12, ".", 0, 1) || !decodeIpv4Suffix(r11, r6, r13, r1, r4 - 2)) {
                            return null;
                        } else {
                            r4 += 2;
                        }
                    ...
                    r12 = r6;
                    while (r12 < r13) {
                        int r9 = decodeHexDigit(r11.charAt(r12));
                        if (r9 == -1) {
                            break;
                        }
                        r8 = (r8 << 4) + r9;
