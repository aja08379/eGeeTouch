...
public final class Buffer implements BufferedSource, BufferedSink, Cloneable, ByteChannel {
    ...
    */
    public long readDecimalLong() {
        long r3 = 0;
        if (r17.size != 0) {
            long r1 = -922337203685477580L;
            long r5 = -7;
            int r7 = 0;
            boolean r8 = false;
            boolean r9 = false;
            loop0: while (true) {
                okio.Segment r10 = r17.head;
                byte[] r11 = r10.data;
                int r12 = r10.pos;
                int r13 = r10.limit;
                while (r12 < r13) {
                    ...
                    if (r15 >= 48 && r15 <= 57) {
                        ...
                        throw new java.lang.NumberFormatException("Expected leading [0-9] or '-' character but was 0x" + java.lang.Integer.toHexString(r15));
                    } else {
                        r9 = true;
                        if (r12 != r13) {
                            r17.head = r10.pop();
        ...
        do {
            ...
            while (r8 < r9) {
                ...
                if (r10 < 48 || r10 > 57) {
                    if (r10 >= 97 && r10 <= 102) {
                        r11 = r10 - 97;
                    } else if (r10 >= 65 && r10 <= 70) {
                        r11 = r10 - 65;
                    } else if (r0 == 0) {
                        throw new java.lang.NumberFormatException("Expected leading [0-9a-fA-F] character but was 0x" + java.lang.Integer.toHexString(r10));
                    } else {
                        r1 = true;
                        if (r8 != r9) {
                            r14.head = r6.pop();
                ...
                if (((-1152921504606846976L) & r4) != 0) {
                    throw new java.lang.NumberFormatException("Number too large: " + new okio.Buffer().writeHexadecimalUnsignedLong(r4).writeByte((int) r10).readUtf8());
                }
                r4 = (r4 << 4) | r11;
                r8++;
                r0++;
    ...
    */
    public int selectPrefix(okio.Options r18, boolean r19) {
        ...
        if (r2 != null) {
            ...
            loop0: while (true) {
                ...
                if (r9 >= 0) {
                    int r14 = r5 + 1;
                    int r5 = r4[r5] & kotlin.UByte.MAX_VALUE;
                    int r15 = r13 + r9;
                    while (r13 != r15) {
                        if (r5 == r0[r13]) {
                            r5 = r0[r13 + r9];
                ...
                while (true) {
                    int r9 = r5 + 1;
                    int r15 = r13 + 1;
                    if ((r4[r5] & kotlin.UByte.MAX_VALUE) != r0[r13]) {
                        return r11;
                    }
                    boolean r5 = r15 == r14;
                    if (r9 == r6) {
            ...
            return r18.indexOf(okio.ByteString.EMPTY);
        }
    }
                        ...
                        if (charAt < 128) {
                            ...
                            if (charAt < 2048) {
                                ...
                                if (charAt > 56319 || charAt3 < 56320 || charAt3 > 57343) {
                                    ...
                                    writeByte((i7 >> 18) | BLEService.ReadResponse_ShackleBypass);
    ...
    public Buffer writeUtf8CodePoint(int i) {
        if (i < 128) {
            ...
            writeByte((i >> 18) | BLEService.ReadResponse_ShackleBypass);
