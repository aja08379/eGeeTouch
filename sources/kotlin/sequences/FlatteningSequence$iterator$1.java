...
public final class FlatteningSequence$iterator$1<E> implements Iterator<E>, KMappedMarker {
    ...
    */
    private final boolean ensureItemIterator() {
        ...
        if ((r0 == null || r0.hasNext()) ? false : true) {
            r5.itemIterator = null;
        }
        while (true) {
            if (r5.itemIterator == null) {
                if (!r5.iterator.hasNext()) {
                    return false;
                }
                java.lang.Object r0 = r5.iterator.next();
                r3 = ((kotlin.sequences.FlatteningSequence) r5.this$0).iterator;
                r4 = ((kotlin.sequences.FlatteningSequence) r5.this$0).transformer;
                java.util.Iterator<? extends E> r0 = (java.util.Iterator) r3.invoke(r4.invoke(r0));
                if (r0.hasNext()) {
                    r5.itemIterator = r0;
                    break;
                }
