...
public interface TimeMark {
    ...
    TimeMark mo1329minusLRDsOJo(long j);

    /* renamed from: plus-LRDsOJo */
    TimeMark mo1330plusLRDsOJo(long j);
    ...
    public static final class DefaultImpls {
        ...
        public static TimeMark m1472plusLRDsOJo(TimeMark timeMark, long j) {
            return new AdjustedTimeMark(timeMark, j, null);
        }

        /* renamed from: minus-LRDsOJo  reason: not valid java name */
        public static TimeMark m1471minusLRDsOJo(TimeMark timeMark, long j) {
            return timeMark.mo1330plusLRDsOJo(Duration.m1388unaryMinusUwyO8pc(j));
        }

        public static boolean hasPassedNow(TimeMark timeMark) {
            return !Duration.m1369isNegativeimpl(timeMark.mo1328elapsedNowUwyO8pc());
        }
