...
public abstract class Random {
    ...
    */
    public double nextDouble(double r7, double r9) {
        ...
        double r0 = r9 - r7;
        if (java.lang.Double.isInfinite(r0)) {
            boolean r3 = true;
            if ((java.lang.Double.isInfinite(r7) || java.lang.Double.isNaN(r7)) ? false : true) {
                if (java.lang.Double.isInfinite(r9) || java.lang.Double.isNaN(r9)) {
                    r3 = false;
                }
                if (r3) {
                    double r2 = 2;
                    double r0 = nextDouble() * ((r9 / r2) - (r7 / r2));
                    r7 = r7 + r0 + r0;
                    return r7 < r9 ? java.lang.Math.nextAfter(r9, Double.NEGATIVE_INFINITY) : r7;
                }
            }
        }
        r7 = r7 + (nextDouble() * r0);
