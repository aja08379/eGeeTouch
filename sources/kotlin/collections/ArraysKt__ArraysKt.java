        ...
        for (int i = 0; i < length; i++) {
            ...
            if (t != t2) {
                ...
                if ((t instanceof Object[]) && (t2 instanceof Object[])) {
                    ...
                    if (!UArraysKt.m589contentEqualskV0jMPg(((UByteArray) t).m107unboximpl(), ((UByteArray) t2).m107unboximpl())) {
                        return false;
                    }
                } else if ((t instanceof UShortArray) && (t2 instanceof UShortArray)) {
                    if (!UArraysKt.m586contentEqualsFGO6Aew(((UShortArray) t).m367unboximpl(), ((UShortArray) t2).m367unboximpl())) {
                        return false;
                    }
                } else if ((t instanceof UIntArray) && (t2 instanceof UIntArray)) {
                    if (!UArraysKt.m587contentEqualsKJPZfPQ(((UIntArray) t).m185unboximpl(), ((UIntArray) t2).m185unboximpl())) {
                        return false;
                    }
                } else if ((t instanceof ULongArray) && (t2 instanceof ULongArray)) {
                    if (!UArraysKt.m591contentEqualslec5QzE(((ULongArray) t).m263unboximpl(), ((ULongArray) t2).m263unboximpl())) {
                        return false;
                    }
    ...
    private static final <T> void contentDeepToStringInternal$ArraysKt__ArraysKt(T[] tArr, StringBuilder sb, List<Object[]> list) {
        ...
        for (int i = 0; i < length; i++) {
            ...
            if (t == null) {
                ...
                sb.append(UArraysKt.m603contentToString2csIQuQ(uByteArray != null ? uByteArray.m107unboximpl() : null));
            } else if (t instanceof UShortArray) {
                UShortArray uShortArray = (UShortArray) t;
                sb.append(UArraysKt.m607contentToStringd6D3K8(uShortArray != null ? uShortArray.m367unboximpl() : null));
            } else if (t instanceof UIntArray) {
                UIntArray uIntArray = (UIntArray) t;
                sb.append(UArraysKt.m606contentToStringXUkPCBk(uIntArray != null ? uIntArray.m185unboximpl() : null));
            } else if (t instanceof ULongArray) {
                ULongArray uLongArray = (ULongArray) t;
                sb.append(UArraysKt.m609contentToStringuLth9ew(uLongArray != null ? uLongArray.m263unboximpl() : null));
            } else {
