...
public final class Regex implements Serializable {
    ...
    */
    public Regex(java.lang.String r2) {
        this(r2);
        kotlin.jvm.internal.Intrinsics.checkNotNullParameter(r2, "pattern");
        java.util.regex.Pattern r2 = java.util.regex.Pattern.compile(r2);
        kotlin.jvm.internal.Intrinsics.checkNotNullExpressionValue(r2, "compile(pattern)");
    }
    ...
    */
    public Regex(java.lang.String r2, kotlin.text.RegexOption r3) {
        this(r2);
        kotlin.jvm.internal.Intrinsics.checkNotNullParameter(r2, "pattern");
        kotlin.jvm.internal.Intrinsics.checkNotNullParameter(r3, "option");
        java.util.regex.Pattern r2 = java.util.regex.Pattern.compile(r2, kotlin.text.Regex.Companion.ensureUnicodeCase(r3.getValue()));
        kotlin.jvm.internal.Intrinsics.checkNotNullExpressionValue(r2, "compile(pattern, ensureUnicodeCase(option.value))");
    }
    ...
    */
    public Regex(java.lang.String r2, java.util.Set<? extends kotlin.text.RegexOption> r3) {
        this(r2);
        kotlin.jvm.internal.Intrinsics.checkNotNullParameter(r2, "pattern");
        kotlin.jvm.internal.Intrinsics.checkNotNullParameter(r3, "options");
        java.util.regex.Pattern r2 = java.util.regex.Pattern.compile(r2, kotlin.text.Regex.Companion.ensureUnicodeCase(kotlin.text.RegexKt.access$toInt(r3)));
        kotlin.jvm.internal.Intrinsics.checkNotNullExpressionValue(r2, "compile(pattern, ensureU…odeCase(options.toInt()))");
    }
