        ...
        public final class TopDownDirectoryState extends DirectoryState {
            ...
            */
            public java.io.File step() {
                ...
                if (!r10.rootVisited) {
                    kotlin.jvm.functions.Function1 r0 = kotlin.io.FileTreeWalk.this.onEnter;
                    boolean r2 = false;
                    if (r0 != null && !((java.lang.Boolean) r0.invoke(getRoot())).booleanValue()) {
                        r2 = true;
                    }
                    if (r2) {
                        return null;
                    }
                    r10.rootVisited = true;
                    return getRoot();
                }
                ...
                if (r0 != null) {
                    ...
                    if (r2 >= r0.length) {
                        kotlin.jvm.functions.Function1 r0 = kotlin.io.FileTreeWalk.this.onLeave;
                        if (r0 != null) {
                            r0.invoke(getRoot());
                        }
                        return null;
                ...
                if (r10.fileList == null) {
                    java.io.File[] r0 = getRoot().listFiles();
                    r10.fileList = r0;
                    if (r0 == null && (r0 = kotlin.io.FileTreeWalk.this.onFail) != null) {
                        r0.invoke(getRoot(), new kotlin.io.AccessDeniedException(getRoot(), null, "Cannot list files in a directory", 2, null));
                    }
                    java.io.File[] r0 = r10.fileList;
                    if (r0 != null) {
                        kotlin.jvm.internal.Intrinsics.checkNotNull(r0);
