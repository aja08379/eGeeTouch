...
class FilesKt__UtilsKt extends FilesKt__FileTreeWalkKt {
    ...
    */
    public static final boolean copyRecursively(java.io.File r11, java.io.File r12, boolean r13, final kotlin.jvm.functions.Function2<? super java.io.File, ? super java.io.IOException, ? extends kotlin.io.OnErrorAction> r14) {
        ...
        kotlin.jvm.internal.Intrinsics.checkNotNullParameter(r12, "target");
        kotlin.jvm.internal.Intrinsics.checkNotNullParameter(r14, "onError");
        if (!r11.exists()) {
            return r14.invoke(r11, new kotlin.io.NoSuchFileException(r11, null, "The source file doesn't exist.", 2, null)) != kotlin.io.OnErrorAction.TERMINATE;
        }
        try {
            java.util.Iterator<java.io.File> r0 = kotlin.io.FilesKt.walkTopDown(r11).onFail(new kotlin.jvm.functions.Function2<java.io.File, java.io.IOException, kotlin.Unit>() { // from class: kotlin.io.FilesKt__UtilsKt$copyRecursively$2
                ...
                @Override // kotlin.jvm.functions.Function2
                public /* bridge */ /* synthetic */ kotlin.Unit invoke(java.io.File r1, java.io.IOException r2) {
                    invoke2(r1, r2);
                    return kotlin.Unit.INSTANCE;
                }

                /* renamed from: invoke  reason: avoid collision after fix types in other method */
                public final void invoke2(java.io.File r2, java.io.IOException r3) {
                    kotlin.jvm.internal.Intrinsics.checkNotNullParameter(r2, "f");
                    kotlin.jvm.internal.Intrinsics.checkNotNullParameter(r3, "e");
                    if (r1.invoke(r2, r3) == kotlin.io.OnErrorAction.TERMINATE) {
                        throw new kotlin.io.TerminateException(r2);
                    }
                }
            }).iterator();
            while (r0.hasNext()) {
                java.io.File r3 = r0.next();
                if (!r3.exists()) {
                    if (r14.invoke(r3, new kotlin.io.NoSuchFileException(r3, null, "The source file doesn't exist.", 2, null)) == kotlin.io.OnErrorAction.TERMINATE) {
                        return false;
                    }
                } else {
                    java.io.File r5 = new java.io.File(r12, kotlin.io.FilesKt.toRelativeString(r3, r11));
                    if (r5.exists() && (!r3.isDirectory() || !r5.isDirectory())) {
                        if (r13) {
                            if (r5.isDirectory()) {
                                if (!kotlin.io.FilesKt.deleteRecursively(r5)) {
                                }
                                r4 = false;
                            } else {
                                if (!r5.delete()) {
                            ...
                            if (!r4) {
                                if (r14.invoke(r5, new kotlin.io.FileAlreadyExistsException(r3, r5, "The destination file already exists.")) == kotlin.io.OnErrorAction.TERMINATE) {
                                    return false;
                                }
                            }
                        }
                    ...
                    if (r3.isDirectory()) {
                        r5.mkdirs();
                    } else if (kotlin.io.FilesKt.copyTo$default(r3, r5, r13, 0, 4, null).length() != r3.length() && r14.invoke(r3, new java.io.IOException("Source file wasn't copied completely, length of destination file differs.")) == kotlin.io.OnErrorAction.TERMINATE) {
                        return false;
                    }
                }
            }
