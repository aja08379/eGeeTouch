...
final class Utils {
    ...
    */
    static java.lang.reflect.Type resolve(java.lang.reflect.Type r8, java.lang.Class<?> r9, java.lang.reflect.Type r10) {
        ...
        while (r10 instanceof java.lang.reflect.TypeVariable) {
        ...
        if (r10 instanceof java.lang.Class) {
            java.lang.Class r0 = (java.lang.Class) r10;
            if (r0.isArray()) {
                java.lang.Class<?> r10 = r0.getComponentType();
                java.lang.reflect.Type r8 = resolve(r8, r9, r10);
                return r10 == r8 ? r0 : new retrofit2.Utils.GenericArrayTypeImpl(r8);
            }
        }
        if (r10 instanceof java.lang.reflect.GenericArrayType) {
            java.lang.reflect.GenericArrayType r10 = (java.lang.reflect.GenericArrayType) r10;
            java.lang.reflect.Type r0 = r10.getGenericComponentType();
            java.lang.reflect.Type r8 = resolve(r8, r9, r0);
            return r0 == r8 ? r10 : new retrofit2.Utils.GenericArrayTypeImpl(r8);
        }
        if (r10 instanceof java.lang.reflect.ParameterizedType) {
            ...
            for (int r2 = 0; r2 < r5; r2++) {
                java.lang.reflect.Type r6 = resolve(r8, r9, r4[r2]);
                if (r6 != r4[r2]) {
                    if (!r0) {
                        r4 = (java.lang.reflect.Type[]) r4.clone();
                        r0 = true;
                    }
                    r4[r2] = r6;
                }
            }
            return r0 ? new retrofit2.Utils.ParameterizedTypeImpl(r3, r10.getRawType(), r4) : r10;
        }
        boolean r0 = r10 instanceof java.lang.reflect.WildcardType;
        java.lang.reflect.WildcardType r10 = r10;
        if (r0) {
            java.lang.reflect.WildcardType r10 = (java.lang.reflect.WildcardType) r10;
            java.lang.reflect.Type[] r0 = r10.getLowerBounds();
            java.lang.reflect.Type[] r3 = r10.getUpperBounds();
            if (r0.length == 1) {
                java.lang.reflect.Type r8 = resolve(r8, r9, r0[0]);
                r10 = r10;
                if (r8 != r0[0]) {
                    return new retrofit2.Utils.WildcardTypeImpl(new java.lang.reflect.Type[]{java.lang.Object.class}, new java.lang.reflect.Type[]{r8});
                }
            } else {
                r10 = r10;
                if (r3.length == 1) {
                    java.lang.reflect.Type r8 = resolve(r8, r9, r3[0]);
                    r10 = r10;
                    if (r8 != r3[0]) {
                        return new retrofit2.Utils.WildcardTypeImpl(new java.lang.reflect.Type[]{r8}, retrofit2.Utils.EMPTY_TYPE_ARRAY);
                    }
                }
            }
        }
